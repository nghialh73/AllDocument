...
import com.example.alldocument.library.fc.poifs.filesystem.BlockStore;
...
import com.example.alldocument.library.fc.poifs.filesystem.NPOIFSMiniStore;
import com.example.alldocument.library.fc.poifs.filesystem.NPOIFSStream;
import com.example.alldocument.library.fc.poifs.filesystem.POIFSWriterListener;
import com.example.alldocument.library.fc.poifs.nio.ByteArrayBackedDataSource;
import com.example.alldocument.library.fc.poifs.nio.DataSource;
import com.example.alldocument.library.fc.poifs.nio.FileBackedDataSource;
import com.example.alldocument.library.fc.poifs.property.DirectoryProperty;
import com.example.alldocument.library.fc.poifs.property.NPropertyTable;
...
import com.example.alldocument.library.fc.poifs.storage.BATBlock.BATBlockAndIndex;
    ...
    implements Closeable
{
    ...
    private com.example.alldocument.library.fc.poifs.filesystem.NPOIFSMiniStore _mini_store;
    ...
    private NPOIFSFileSystem(boolean newFS)
    {
        ...
        _mini_store     = new com.example.alldocument.library.fc.poifs.filesystem.NPOIFSMiniStore(this, _property_table.getRoot(), new ArrayList<BATBlock>(), _header);
    ...
    private void readCoreContents() throws IOException {
       ...
       _mini_store     = new com.example.alldocument.library.fc.poifs.filesystem.NPOIFSMiniStore(this, _property_table.getRoot(), sbats, _header);
   ...
   /**
    ...
    public com.example.alldocument.library.fc.poifs.filesystem.DocumentEntry createDocument(final InputStream stream,
                                                                              final String name)
        throws IOException
    {
