...
package com.example.alldocument.library.fc.hslf.usermodel;
...
import com.example.alldocument.library.fc.hslf.exceptions.CorruptPowerPointFileException;
import com.example.alldocument.library.fc.hslf.model.HeadersFooters;
import com.example.alldocument.library.fc.hslf.model.Hyperlink;
import com.example.alldocument.library.fc.hslf.model.MovieShape;
...
import com.example.alldocument.library.fc.hslf.record.PositionDependentRecord;
...
import com.example.alldocument.library.fc.hslf.record.ExtendedPresRuleContainer.ExtendedParaAtomsSet;
import com.example.alldocument.library.fc.hslf.record.SlideListWithText.SlideAtomsSet;
import com.example.alldocument.library.fc.hslf.usermodel.ObjectData;
import com.example.alldocument.library.fc.hslf.usermodel.PictureData;
import com.example.alldocument.library.fc.hslf.usermodel.SoundData;
    ...
    private void buildSlidesAndNotes()
    {
        ...
        if (masterSLWT != null)
        {
            ...
            for (int i = 0; i < masterSets.length; i++)
            {
                ...
                if (r instanceof com.example.alldocument.library.fc.hslf.record.Slide)
                {
                    TitleMaster master = new TitleMaster((com.example.alldocument.library.fc.hslf.record.Slide)r, sheetNo);
                    master.setSlideShow(this);
                    tmr.add(master);
                }
                else if (r instanceof com.example.alldocument.library.fc.hslf.record.MainMaster)
                {
                    SlideMaster master = new SlideMaster((com.example.alldocument.library.fc.hslf.record.MainMaster)r, sheetNo);
                    master.setSlideShow(this);
                    mmr.add(master);
                }
            }
        ...
        // notesSLWT
        com.example.alldocument.library.fc.hslf.record.Notes[] notesRecords;
        SlideAtomsSet[] notesSets = new SlideAtomsSet[0];
        Hashtable<Integer, Integer> slideIdToNotes = new Hashtable<Integer, Integer>();
        if (notesSLWT == null)
        {
            // None
            notesRecords = new com.example.alldocument.library.fc.hslf.record.Notes[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            notesSets = notesSLWT.getSlideAtomsSets();
            ArrayList<com.example.alldocument.library.fc.hslf.record.Notes> notesRecordsL = new ArrayList<com.example.alldocument.library.fc.hslf.record.Notes>();
            for (int i = 0; i < notesSets.length; i++)
            {
                ...
                if (r instanceof com.example.alldocument.library.fc.hslf.record.Notes)
                {
                    com.example.alldocument.library.fc.hslf.record.Notes notesRecord = (com.example.alldocument.library.fc.hslf.record.Notes)r;
            ...
            notesRecords = new com.example.alldocument.library.fc.hslf.record.Notes[notesRecordsL.size()];
            notesRecords = notesRecordsL.toArray(notesRecords);
        }

        // Now, do the same thing for our slides
        com.example.alldocument.library.fc.hslf.record.Slide[] slidesRecords;
        SlideAtomsSet[] slidesSets = new SlideAtomsSet[0];
        if (slidesSLWT == null)
        {
            // None
            slidesRecords = new com.example.alldocument.library.fc.hslf.record.Slide[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            slidesSets = slidesSLWT.getSlideAtomsSets();
            slidesRecords = new com.example.alldocument.library.fc.hslf.record.Slide[slidesSets.length];
            for (int i = 0; i < slidesSets.length; i++)
            {
                ...
                if (r instanceof com.example.alldocument.library.fc.hslf.record.Slide)
                {
                    slidesRecords[i] = (com.example.alldocument.library.fc.hslf.record.Slide)r;
                }
                /*else
                {
