...
public final class NumberToTextConverter {
	...
	/* package */ static String rawDoubleBitsToText(long pRawBits) {
		...
		com.example.alldocument.library.fc.ss.util.ExpandedDouble ed = new com.example.alldocument.library.fc.ss.util.ExpandedDouble(rawBits);
		...
		com.example.alldocument.library.fc.ss.util.NormalisedDecimal nd = ed.normaliseBaseTen();
	...
	private static void convertToText(StringBuilder sb, com.example.alldocument.library.fc.ss.util.NormalisedDecimal pnd) {
		com.example.alldocument.library.fc.ss.util.NormalisedDecimal rnd = pnd.roundUnits();
