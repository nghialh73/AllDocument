 ...
 * 时间:               上午9:16:03
 */
package com.example.alldocument.library.officereader.database;

import java.io.File;
import java.util.List;

import com.example.alldocument.library.constant.MainConstant;
import com.example.alldocument.library.officereader.database.DBHelper;
...
{ 
    ...
    public void createDataBase(Context context)
    {
        if (dbHelper == null)
        {
            dbHelper = new com.example.alldocument.library.officereader.database.DBHelper(context);
