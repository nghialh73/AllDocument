...
import com.example.alldocument.library.thirdpart.emf.data.TextA;
...
public class ExtTextOutA extends AbstractExtTextOut implements EMFConstants {
    ...
    private com.example.alldocument.library.thirdpart.emf.data.TextA text;
    ...
    public ExtTextOutA(
        ...
        float xScale,
        float yScale,
        com.example.alldocument.library.thirdpart.emf.data.TextA text) {
