...
import com.example.alldocument.library.fc.hssf.record.BiffHeaderInput;
import com.example.alldocument.library.fc.hssf.record.crypto.Biff8EncryptionKey;
import com.example.alldocument.library.fc.hssf.record.crypto.Biff8RC4;
...
public final class Biff8DecryptingStream implements BiffHeaderInput, LittleEndianInput {
	...
	private final com.example.alldocument.library.fc.hssf.record.crypto.Biff8RC4 _rc4;

	public Biff8DecryptingStream(InputStream in, int initialOffset, Biff8EncryptionKey key) {
		_rc4 = new com.example.alldocument.library.fc.hssf.record.crypto.Biff8RC4(initialOffset, key);
