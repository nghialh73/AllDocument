...
import com.example.alldocument.library.wp.control.ControlKit;
import com.example.alldocument.library.wp.control.Word;
import com.example.alldocument.library.wp.dialog.TXTEncodingDialog;
...
public class WPControl extends AbstractControl
{
    ...
    public WPControl(IControl mainControl, IDocument doc, String filePath)
    {
        ...
        wpView = new com.example.alldocument.library.wp.control.Word(mainControl.getMainFrame().getActivity().getApplicationContext(), doc, filePath, this);
    }
    ...
    public Object getActionValue(int actionID, Object obj)
    {
        switch (actionID)
        {
            ...
            case EventConstant.WP_SELECT_TEXT_ID:
                return ((com.example.alldocument.library.wp.control.Word)wpView).getStatus().isSelectTextStatus();
