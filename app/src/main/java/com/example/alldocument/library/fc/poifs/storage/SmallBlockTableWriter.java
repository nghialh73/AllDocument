...
public class SmallBlockTableWriter
    implements com.example.alldocument.library.fc.poifs.storage.BlockWritable, BATManaged
{
                                 ...
                                 final RootProperty root)
    {
        ...
        while (iter.hasNext())
        {
            ...
            com.example.alldocument.library.fc.poifs.storage.BlockWritable[] blocks = doc.getSmallBlocks();
