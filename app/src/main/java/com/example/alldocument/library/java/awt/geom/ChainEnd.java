...
final class ChainEnd {
    ...
    public CurveLink linkTo(ChainEnd that) {
        if (etag == com.example.alldocument.library.java.awt.geom.AreaOp.ETAG_IGNORE ||
            that.etag == com.example.alldocument.library.java.awt.geom.AreaOp.ETAG_IGNORE)
        {
        ...
        if (etag == com.example.alldocument.library.java.awt.geom.AreaOp.ETAG_ENTER) {
            enter = this;
            exit = that;
        } else {
            enter = that;
        ...
        etag = com.example.alldocument.library.java.awt.geom.AreaOp.ETAG_IGNORE;
        that.etag = com.example.alldocument.library.java.awt.geom.AreaOp.ETAG_IGNORE;
