...
public final class BlockAllocationTableWriter implements BlockWritable, BATManaged {
    ...
    private com.example.alldocument.library.fc.poifs.storage.BATBlock[] _blocks;
    ...
    public BlockAllocationTableWriter(POIFSBigBlockSize bigBlockSize)
    {
       _bigBlockSize = bigBlockSize; 
        ...
        _blocks       = new com.example.alldocument.library.fc.poifs.storage.BATBlock[ 0 ];
    }
    ...
    public int createBlocks()
    {
        ...
        while (true)
        {
            int calculated_bat_blocks  =
                com.example.alldocument.library.fc.poifs.storage.BATBlock.calculateStorageRequirements(_bigBlockSize,
                                                      bat_blocks
                                                      + xbat_blocks
                                                      + _entries.size());
    ...
    {
        _blocks = com.example.alldocument.library.fc.poifs.storage.BATBlock.createBATBlocks(_bigBlockSize, _entries.toArray());
    }
