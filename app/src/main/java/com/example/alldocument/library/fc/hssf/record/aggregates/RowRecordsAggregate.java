...
import com.example.alldocument.library.fc.hssf.record.MulBlankRecord;
...
import com.example.alldocument.library.fc.hssf.record.aggregates.SharedValueManager;
import com.example.alldocument.library.fc.hssf.record.aggregates.ValueRecordsAggregate;
...
public final class RowRecordsAggregate extends RecordAggregate {
	...
	private final com.example.alldocument.library.fc.hssf.record.aggregates.SharedValueManager _sharedValueManager;
	...
	public RowRecordsAggregate() {
		this(com.example.alldocument.library.fc.hssf.record.aggregates.SharedValueManager.createEmpty());
	}
	private RowRecordsAggregate(com.example.alldocument.library.fc.hssf.record.aggregates.SharedValueManager svm) {
		if (svm == null) {
	 ...
	 * @param svm an initialised {@link com.example.alldocument.library.fc.hssf.record.aggregates.SharedValueManager} (from the shared formula, array
