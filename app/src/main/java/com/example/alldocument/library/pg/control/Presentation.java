 ...
 * 时间:              下午3:49:28
 */
package com.example.alldocument.library.pg.control;

import java.util.List;

import com.example.alldocument.library.common.IOfficeToPicture;
import com.example.alldocument.library.common.ISlideShow;
...
import com.example.alldocument.library.pg.control.PGEventManage;
import com.example.alldocument.library.pg.control.PGFind;
import com.example.alldocument.library.pg.control.PGPageListItem;
import com.example.alldocument.library.pg.control.PGPrintMode;
...
import com.example.alldocument.library.pg.view.SlideDrawKit;
import com.example.alldocument.library.pg.view.SlideShowView;
import com.example.alldocument.library.simpletext.model.IDocument;
import com.example.alldocument.library.system.IControl;
import com.example.alldocument.library.system.IFind;
import com.example.alldocument.library.system.SysKit;
import com.example.alldocument.library.system.beans.CalloutView.CalloutView;
import com.example.alldocument.library.system.beans.CalloutView.IExportListener;
...
public class Presentation extends FrameLayout implements IFind, IExportListener
{
    ...
    public Presentation(Activity activity, PGModel pgModel, IControl control)
    {
        ...
        pgFind = new com.example.alldocument.library.pg.control.PGFind(this);
        //
        editor = new com.example.alldocument.library.pg.control.PGEditor(this);
        //
        pgPrintMode = new com.example.alldocument.library.pg.control.PGPrintMode(activity, control, pgModel, editor);
        //
        addView(pgPrintMode);
    }
     ...
     */
    public com.example.alldocument.library.pg.control.PGEditor getEditor()
    {
        return editor;
    }    
...
//                                }
     ...
     * 
     */
    public com.example.alldocument.library.pg.control.PGFind getFind()
    {
        return this.pgFind;
    }
     ...
     * @return
     */
    public com.example.alldocument.library.pg.control.PGPrintMode getPrintMode()
    {
