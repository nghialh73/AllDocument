...
public class VMLPathParser 
{
	...
	public com.example.alldocument.library.fc.doc.PathWithArrow createPath(WPAutoShape autoshape, String pathContext, int lineWidth)
	{
		try
		{
			index = 0;
			...
			com.example.alldocument.library.fc.doc.PathWithArrow pathWithArrow = new PathWithArrow(pathList.toArray(new Path[pathList.size()]), startArrowPath, endArrowPath);
			startArrowPath = null;
			endArrowPath = null;
