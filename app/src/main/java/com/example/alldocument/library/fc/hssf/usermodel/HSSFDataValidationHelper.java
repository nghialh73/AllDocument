...
import com.example.alldocument.library.fc.hssf.usermodel.DVConstraint;
...
import com.example.alldocument.library.fc.ss.usermodel.DataValidationConstraint.ValidationType;
import com.example.alldocument.library.fc.ss.util.CellRangeAddressList;
...
public class HSSFDataValidationHelper implements DataValidationHelper {
	...
	private com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet sheet;
	...
	public DataValidationConstraint createDateConstraint(int operatorType, String formula1, String formula2, String dateFormat) {
		return com.example.alldocument.library.fc.hssf.usermodel.DVConstraint.createDateConstraint(operatorType, formula1, formula2, dateFormat);
	}
	...
	public DataValidationConstraint createExplicitListConstraint(String[] listOfValues) {
		return com.example.alldocument.library.fc.hssf.usermodel.DVConstraint.createExplicitListConstraint(listOfValues);
	}
	...
	public DataValidationConstraint createFormulaListConstraint(String listFormula) {
		return com.example.alldocument.library.fc.hssf.usermodel.DVConstraint.createFormulaListConstraint(listFormula);
	}
	...
	public DataValidationConstraint createNumericConstraint(int validationType,int operatorType, String formula1, String formula2) {
		return com.example.alldocument.library.fc.hssf.usermodel.DVConstraint.createNumericConstraint(validationType, operatorType, formula1, formula2);
	}

	public DataValidationConstraint createIntegerConstraint(int operatorType, String formula1, String formula2) {
		return com.example.alldocument.library.fc.hssf.usermodel.DVConstraint.createNumericConstraint(ValidationType.INTEGER, operatorType, formula1, formula2);
	}
	...
	public DataValidationConstraint createDecimalConstraint(int operatorType, String formula1, String formula2) {
		return com.example.alldocument.library.fc.hssf.usermodel.DVConstraint.createNumericConstraint(ValidationType.DECIMAL, operatorType, formula1, formula2);
	}
	...
	public DataValidationConstraint createTextLengthConstraint(int operatorType, String formula1, String formula2) {
		return com.example.alldocument.library.fc.hssf.usermodel.DVConstraint.createNumericConstraint(ValidationType.TEXT_LENGTH, operatorType, formula1, formula2);
	}
	...
	public DataValidationConstraint createTimeConstraint(int operatorType, String formula1, String formula2) {
		return com.example.alldocument.library.fc.hssf.usermodel.DVConstraint.createTimeConstraint(operatorType, formula1, formula2);
	}
