...
import com.example.alldocument.library.fc.doc.DOCReader;
...
import com.example.alldocument.library.fc.hwpf.usermodel.HWPFShapeFactory;
...
public class OfficeDrawingsImpl implements OfficeDrawings
{
     ...
     * @return
     */
    private com.example.alldocument.library.fc.hwpf.usermodel.OfficeDrawing getOfficeDrawing(final FSPA fspa)
    {
        return new OfficeDrawingImpl(fspa, this);
    }

    public com.example.alldocument.library.fc.hwpf.usermodel.OfficeDrawing getOfficeDrawingAt(int characterPosition)
    {
    ...
    public Collection<com.example.alldocument.library.fc.hwpf.usermodel.OfficeDrawing> getOfficeDrawings()
    {
        List<com.example.alldocument.library.fc.hwpf.usermodel.OfficeDrawing> result = new ArrayList<com.example.alldocument.library.fc.hwpf.usermodel.OfficeDrawing>();
    ...
    private static class OfficeDrawingImpl implements OfficeDrawing
    {
        ...
        {
            return (byte)getTertiaryPropertyValue(EscherProperties.GROUPSHAPE__POSH, com.example.alldocument.library.fc.hwpf.usermodel.HWPFShape.POSH_ABS);
        }
        ...
        {
        	return (byte) getTertiaryPropertyValue(EscherProperties.GROUPSHAPE__POSRELH, com.example.alldocument.library.fc.hwpf.usermodel.HWPFShape.POSRELH_COLUMN);
        }
        ...
        public com.example.alldocument.library.fc.hwpf.usermodel.HWPFShape getAutoShape()
        {
        ...
        {
            return (byte)getTertiaryPropertyValue(EscherProperties.GROUPSHAPE__POSV, com.example.alldocument.library.fc.hwpf.usermodel.HWPFShape.POSV_ABS);
        }
