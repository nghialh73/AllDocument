...
public final class CHPFormattedDiskPage extends FormattedDiskPage
{
    ...
    private ArrayList<com.example.alldocument.library.fc.hwpf.model.CHPX> _chpxList = new ArrayList<com.example.alldocument.library.fc.hwpf.model.CHPX>();
    private ArrayList<com.example.alldocument.library.fc.hwpf.model.CHPX> _overFlow;
     ...
     * 
     * @deprecated Use
     *             {@link #CHPFormattedDiskPage(byte[],int, com.example.alldocument.library.fc.hwpf.model.TextPieceTable)}
     *             instead
     */
     ...
     * read from a Word file).
     */
    public CHPFormattedDiskPage(byte[] documentStream, int offset, com.example.alldocument.library.fc.hwpf.model.CharIndexTranslator translator)
    {
        ...
        for (int x = 0; x < _crun; x++)
        {
            ...
            com.example.alldocument.library.fc.hwpf.model.CHPX chpx = new com.example.alldocument.library.fc.hwpf.model.CHPX(charStartAt, charEndAt, new SprmBuffer(getGrpprl(x), 0));
            _chpxList.add(chpx);
        }
        _crun = _chpxList.size();
    }

    public com.example.alldocument.library.fc.hwpf.model.CHPX getCHPX(int index)
    {
        return _chpxList.get(index);
    }

    public void fill(List<com.example.alldocument.library.fc.hwpf.model.CHPX> filler)
    {
        _chpxList.addAll(filler);
    }

    public ArrayList<com.example.alldocument.library.fc.hwpf.model.CHPX> getOverflow()
    {
        return _overFlow;
    }
    ...
    /**
     * @deprecated Use {@link #toByteArray(com.example.alldocument.library.fc.hwpf.model.CharIndexTranslator)} instead
     */
    @ Deprecated
    @ SuppressWarnings("unused")
    protected byte[] toByteArray(com.example.alldocument.library.fc.hwpf.model.CharIndexTranslator translator, int fcMin)
    {
    ...
    protected byte[] toByteArray(CharIndexTranslator translator)
    {
        ...
        if (index != size)
        {
            _overFlow = new ArrayList<com.example.alldocument.library.fc.hwpf.model.CHPX>();
