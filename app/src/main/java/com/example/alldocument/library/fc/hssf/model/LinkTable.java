...
import com.example.alldocument.library.fc.hssf.record.CRNCountRecord;
...
import com.example.alldocument.library.fc.hssf.record.ExternalNameRecord;
...
final class LinkTable {
	...
	private static final class ExternalBookBlock {
         ...
         *
         * @see com.example.alldocument.library.fc.hssf.model.LinkTable#LinkTable(int, WorkbookRecordList)
         */
         ...
         *
         * @see com.example.alldocument.library.fc.hssf.model.LinkTable#addNameXPtg(String)
         */
