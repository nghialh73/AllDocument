...
import com.example.alldocument.library.fc.hslf.model.textproperties.BitMaskTextProp;
import com.example.alldocument.library.fc.hslf.model.textproperties.CharFlagsTextProp;
import com.example.alldocument.library.fc.hslf.model.textproperties.ParagraphFlagsTextProp;
...
public final class RichTextRun
{
     ...
     */
    public void supplySlideShow(com.example.alldocument.library.fc.hslf.usermodel.SlideShow ss)
    {
        slideShow = ss;
        if (_fontname != null)
        {
