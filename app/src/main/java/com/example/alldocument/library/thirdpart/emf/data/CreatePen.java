...
public class CreatePen extends EMFTag
{
    ...
    private com.example.alldocument.library.thirdpart.emf.data.LogPen pen;
    ...
    public CreatePen(int index, com.example.alldocument.library.thirdpart.emf.data.LogPen pen)
    {
        this();
        this.index = index;
        this.pen = pen;
