...
import com.example.alldocument.library.fc.codec.Hex;
import com.example.alldocument.library.fc.codec.StringUtils;
...
public class DigestUtils
{
    ...
    {
        return com.example.alldocument.library.fc.codec.Hex.encodeHexString(md5(data));
    }
    ...
    {
        return com.example.alldocument.library.fc.codec.Hex.encodeHexString(sha256(data));
    }
    ...
    {
        return com.example.alldocument.library.fc.codec.Hex.encodeHexString(sha384(data));
    }
    ...
    {
        return com.example.alldocument.library.fc.codec.Hex.encodeHexString(sha512(data));
    }
    ...
    {
        return com.example.alldocument.library.fc.codec.Hex.encodeHexString(sha(data));
    }
