...
import com.example.alldocument.library.fc.xls.Reader.SheetReader;
    ...
    private void readSheet(IControl control, int index) throws Exception
    {
        ...
        if(sheetPart != null)
        {
            ...
            {    
                ...
                com.example.alldocument.library.fc.xls.Reader.SheetReader.instance().getSheet(control, zipPackage, book.getSheet(index), sheetPart, iReader);
            }     
