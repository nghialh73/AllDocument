 ...
 * 时间:              下午3:15:38
 */
package com.example.alldocument.library.ss.model.baseModel;
...
import com.example.alldocument.library.ss.model.interfacePart.IReaderListener;
...
public class Sheet
{
    ...
    public Sheet()
    {
       ...
       rows = new HashMap<Integer, com.example.alldocument.library.ss.model.baseModel.Row>();
     ...
     *
     */
    public void addRow(com.example.alldocument.library.ss.model.baseModel.Row row)
    {
        if(row == null)
        {
            return;
     ...
     */
    public com.example.alldocument.library.ss.model.baseModel.Row getRow(int rowIndex)
    {
     ...
     * @return
     */
    public com.example.alldocument.library.ss.model.baseModel.Row getRowByColumnsStyle(int rowIndex)
    {
        com.example.alldocument.library.ss.model.baseModel.Row row = rows.get(Integer.valueOf(rowIndex));
        if(row != null)
        {
            return row;
        }
        ...
        while(index < columnInfoList.size())
        {
            ...
            {
                row = new com.example.alldocument.library.ss.model.baseModel.Row(1);
     ...
     */
    public com.example.alldocument.library.ss.model.baseModel.Cell getActiveCell()
    {
        return activeCell;
    }
     ...
     */
    public void setActiveCell(com.example.alldocument.library.ss.model.baseModel.Cell activeCell)
    {
    ...
    public void setState(short state)
    {
        ...
        Iterator<com.example.alldocument.library.ss.model.baseModel.Row> iter = rows.values().iterator();
        while(iter.hasNext())
        {
    ...
    public void removeSTRoot()
    {
        ...
        {       
            com.example.alldocument.library.ss.model.baseModel.Row row = getRow(rowIndex++);
            ...
            Iterator<com.example.alldocument.library.ss.model.baseModel.Cell> iter = row.cellCollection().iterator();
            while(iter.hasNext())
            {
    ...
    public void dispose()
    {
        ...
        if(rows != null)
        {           
            Collection<com.example.alldocument.library.ss.model.baseModel.Row> rowCollection = rows.values();
            for(com.example.alldocument.library.ss.model.baseModel.Row row: rowCollection)
            {
                row.dispose();
            }
            rows.clear();
