...
public class IncompleteTagException extends IOException {
	...
	private com.example.alldocument.library.thirdpart.emf.io.Tag tag;
	 ...
	 *            unused bytes
	 */
	public IncompleteTagException(com.example.alldocument.library.thirdpart.emf.io.Tag tag, byte[] rest) {
