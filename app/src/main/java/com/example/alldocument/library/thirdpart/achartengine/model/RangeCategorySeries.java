...
public class RangeCategorySeries extends CategorySeries {
   ...
   */
  public com.example.alldocument.library.thirdpart.achartengine.model.XYSeries toXYSeries() {
    com.example.alldocument.library.thirdpart.achartengine.model.XYSeries xySeries = new XYSeries(getTitle());
