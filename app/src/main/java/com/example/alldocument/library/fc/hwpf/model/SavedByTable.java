...
import com.example.alldocument.library.fc.hwpf.model.SavedByEntry;
...
public final class SavedByTable
{
   ...
   * Array of entries.
   */
  private com.example.alldocument.library.fc.hwpf.model.SavedByEntry[] entries;
...
//    }
        ...
        String[] strings = com.example.alldocument.library.fc.hwpf.model.SttbfUtils.read( tableStream, offset );

        int numEntries = strings.length / 2;
        entries = new com.example.alldocument.library.fc.hwpf.model.SavedByEntry[numEntries];
        for ( int i = 0; i < numEntries; i++ )
        {
            entries[i] = new com.example.alldocument.library.fc.hwpf.model.SavedByEntry( strings[i * 2], strings[i * 2 + 1] );
        }
    }
   ...
   */
  public List<com.example.alldocument.library.fc.hwpf.model.SavedByEntry> getEntries()
  {
    ...
    public void writeTo( HWPFOutputStream tableStream ) throws IOException
    {
        ...
        com.example.alldocument.library.fc.hwpf.model.SttbfUtils.write( tableStream, toSave );
    }
