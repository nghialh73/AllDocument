...
import com.example.alldocument.library.fc.hssf.formula.FormulaCellCache;
import com.example.alldocument.library.fc.hssf.formula.FormulaCellCache.IEntryOperation;
...
import com.example.alldocument.library.fc.hssf.formula.PlainCellCache;
import com.example.alldocument.library.fc.hssf.formula.PlainCellCache.Loc;
import com.example.alldocument.library.fc.hssf.formula.PlainValueCellCacheEntry;
...
/**
 * Performance optimisation for {@link com.example.alldocument.library.fc.ss.usermodel.com.example.alldocument.library.fc.ss.usermodel.FormulaEvaluator}.
...
final class EvaluationCache {
	...
	private final com.example.alldocument.library.fc.hssf.formula.PlainCellCache _plainCellCache;
	...
	/* package */EvaluationCache(IEvaluationListener evaluationListener) {
		...
		_plainCellCache = new com.example.alldocument.library.fc.hssf.formula.PlainCellCache();
		_formulaCellCache = new FormulaCellCache();
	}

	public void notifyUpdateCell(int bookIndex, int sheetIndex, com.example.alldocument.library.fc.hssf.formula.EvaluationCell cell) {
	...
	public FormulaCellCacheEntry getOrCreateFormulaCellEntry(com.example.alldocument.library.fc.hssf.formula.EvaluationCell cell) {
