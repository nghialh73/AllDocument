...
final class FormulaCellCache {
	...
	public com.example.alldocument.library.fc.hssf.formula.CellCacheEntry[] getCacheEntries() {
	 ...
	 */
	public FormulaCellCacheEntry get(com.example.alldocument.library.fc.hssf.formula.EvaluationCell cell) {
		return _formulaEntriesByCell.get(cell.getIdentityKey());
	}

	public void put(com.example.alldocument.library.fc.hssf.formula.EvaluationCell cell, FormulaCellCacheEntry entry) {
