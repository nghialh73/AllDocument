...
public final class EvaluationException extends Exception {
	private final com.example.alldocument.library.fc.hssf.formula.eval.ErrorEval _errorEval;

	public EvaluationException(com.example.alldocument.library.fc.hssf.formula.eval.ErrorEval errorEval) {
	...
	public static EvaluationException invalidValue() {
		return new EvaluationException(com.example.alldocument.library.fc.hssf.formula.eval.ErrorEval.VALUE_INVALID);
	}
    /** <b>#REF!</b> - Illegal or deleted cell reference */
	public static EvaluationException invalidRef() {
		return new EvaluationException(com.example.alldocument.library.fc.hssf.formula.eval.ErrorEval.REF_INVALID);
	}
    /** <b>#NUM!</b> - Value range overflow */
	public static EvaluationException numberError() {
		return new EvaluationException(com.example.alldocument.library.fc.hssf.formula.eval.ErrorEval.NUM_ERROR);
	}
