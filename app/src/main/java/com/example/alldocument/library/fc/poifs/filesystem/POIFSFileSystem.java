...
package com.example.alldocument.library.fc.poifs.filesystem;
...
import com.example.alldocument.library.fc.poifs.common.POIFSBigBlockSize;
...
import com.example.alldocument.library.fc.poifs.filesystem.DirectoryEntry;
import com.example.alldocument.library.fc.poifs.filesystem.DirectoryNode;
import com.example.alldocument.library.fc.poifs.filesystem.DocumentEntry;
import com.example.alldocument.library.fc.poifs.filesystem.DocumentInputStream;
import com.example.alldocument.library.fc.poifs.filesystem.DocumentNode;
import com.example.alldocument.library.fc.poifs.filesystem.EntryNode;
import com.example.alldocument.library.fc.poifs.filesystem.POIFSDocument;
import com.example.alldocument.library.fc.poifs.filesystem.POIFSWriterListener;
...
import com.example.alldocument.library.fc.poifs.property.PropertyTable;
import com.example.alldocument.library.fc.poifs.storage.BATBlock;
import com.example.alldocument.library.fc.poifs.storage.BlockAllocationTableReader;
import com.example.alldocument.library.fc.poifs.storage.BlockAllocationTableWriter;
import com.example.alldocument.library.fc.poifs.storage.BlockList;
import com.example.alldocument.library.fc.poifs.storage.BlockWritable;
import com.example.alldocument.library.fc.poifs.storage.HeaderBlock;
import com.example.alldocument.library.fc.poifs.storage.HeaderBlockConstants;
import com.example.alldocument.library.fc.poifs.storage.HeaderBlockWriter;
import com.example.alldocument.library.fc.poifs.storage.RawDataBlockList;
import com.example.alldocument.library.fc.poifs.storage.SmallBlockTableReader;
import com.example.alldocument.library.fc.poifs.storage.SmallBlockTableWriter;
import com.example.alldocument.library.fc.util.CloseIgnoringInputStream;
import com.example.alldocument.library.fc.util.IOUtils;
import com.example.alldocument.library.fc.util.LongField;
...
public class POIFSFileSystem
{
    ...
    private com.example.alldocument.library.fc.poifs.filesystem.DirectoryNode _root;
    ...
    public com.example.alldocument.library.fc.poifs.filesystem.DocumentEntry createDocument(final InputStream stream, final String name)
        throws IOException
    {
    ...
    public void writeFilesystem(final OutputStream stream) throws IOException
    {
        ...
        while (iter.hasNext())
        {
            com.example.alldocument.library.fc.poifs.filesystem.BATManaged bmo = (BATManaged)iter.next();
    ...
    public com.example.alldocument.library.fc.poifs.filesystem.DirectoryNode getRoot()
    {
        if (_root == null)
        {
            _root = new com.example.alldocument.library.fc.poifs.filesystem.DirectoryNode(_property_table.getRoot(), this, null);
        }
        return _root;
    }
    ...
    void addDocument(final com.example.alldocument.library.fc.poifs.filesystem.POIFSDocument document)
    {
    ...
    private void processProperties(final BlockList small_blocks, final BlockList big_blocks,
                                   final Iterator properties, final com.example.alldocument.library.fc.poifs.filesystem.DirectoryNode dir, final int headerPropertiesStartAt)
        throws IOException
    {
        while (properties.hasNext())
        {
            ...
            com.example.alldocument.library.fc.poifs.filesystem.DirectoryNode parent = (dir == null) ? ((com.example.alldocument.library.fc.poifs.filesystem.DirectoryNode)getRoot()) : dir;

            if (property.isDirectory())
            {
                com.example.alldocument.library.fc.poifs.filesystem.DirectoryNode new_dir = (DirectoryNode)parent.createDirectory(name);
            ...
            else
            {
                ...
                com.example.alldocument.library.fc.poifs.filesystem.POIFSDocument document = null;

                if (property.shouldUseSmallBlocks())
                {
                    document = new com.example.alldocument.library.fc.poifs.filesystem.POIFSDocument(name, small_blocks.fetchBlocks(startBlock,
