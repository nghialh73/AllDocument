...
package com.example.alldocument.library.fc.hslf.model.textproperties;

import java.io.IOException;
import java.io.OutputStream;
import java.util.LinkedList;

import com.example.alldocument.library.fc.hslf.model.textproperties.CharFlagsTextProp;
import com.example.alldocument.library.fc.hslf.model.textproperties.TextProp;
...
public class TextPropCollection
{
    ...
    public LinkedList<com.example.alldocument.library.fc.hslf.model.textproperties.TextProp> getTextPropList()
    {
        return textPropList;
    }

    /** Fetch the TextProp with this name, or null if it isn't present */
    public com.example.alldocument.library.fc.hslf.model.textproperties.TextProp findByName(String textPropName)
    {
        for (int i = 0; i < textPropList.size(); i++)
        {
            com.example.alldocument.library.fc.hslf.model.textproperties.TextProp prop = textPropList.get(i);
    ...
    public com.example.alldocument.library.fc.hslf.model.textproperties.TextProp addWithName(String name)
    {
        // Find the base TextProp to base on
        com.example.alldocument.library.fc.hslf.model.textproperties.TextProp base = null;
        ...
        com.example.alldocument.library.fc.hslf.model.textproperties.TextProp textProp = (com.example.alldocument.library.fc.hslf.model.textproperties.TextProp)base.clone();
        int pos = 0;
        for (int i = 0; i < textPropList.size(); i++)
        {
            com.example.alldocument.library.fc.hslf.model.textproperties.TextProp curProp = textPropList.get(i);
     ...
     */
    public int buildTextPropList(int containsField, com.example.alldocument.library.fc.hslf.model.textproperties.TextProp[] potentialProperties, byte[] data,
                                 int dataOffset)
    {
        int bytesPassed = 0;
        ...
        for (int i = 0; i < potentialProperties.length; i++)
        {
            ...
            if ((containsField & potentialProperties[i].getMask()) != 0)
            {
                ...
                com.example.alldocument.library.fc.hslf.model.textproperties.TextProp prop = (com.example.alldocument.library.fc.hslf.model.textproperties.TextProp)potentialProperties[i].clone();
                int val = 0;
                if (prop.getSize() == 2)
                {
    ...
    public TextPropCollection(int charactersCovered, short reservedField)
    {
        ...
        textPropList = new LinkedList<com.example.alldocument.library.fc.hslf.model.textproperties.TextProp>();
    }
