...
public final class Comment2000 extends RecordContainer
{
    ...
    private void findInterestingChildren()
    {
        ...
        {
            if (r instanceof com.example.alldocument.library.fc.hslf.record.CString)
            {
                com.example.alldocument.library.fc.hslf.record.CString cs = (com.example.alldocument.library.fc.hslf.record.CString)r;
    ...
    public Comment2000()
    {
        ...
        com.example.alldocument.library.fc.hslf.record.CString csa = new com.example.alldocument.library.fc.hslf.record.CString();
        com.example.alldocument.library.fc.hslf.record.CString csb = new com.example.alldocument.library.fc.hslf.record.CString();
        com.example.alldocument.library.fc.hslf.record.CString csc = new com.example.alldocument.library.fc.hslf.record.CString();
        csa.setOptions(0x00);
        csb.setOptions(0x10);
        csc.setOptions(0x20);
        _children[0] = csa;
     ...
     */
    private com.example.alldocument.library.fc.hslf.record.CString authorRecord;
    /**
     * An optional string record that specifies the text of the presentation comment
     */
    private com.example.alldocument.library.fc.hslf.record.CString authorInitialsRecord;
    /**
