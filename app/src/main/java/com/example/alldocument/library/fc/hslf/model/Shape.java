...
public abstract class Shape
{
     ...
     */
    public com.example.alldocument.library.fc.hslf.model.Fill getFill()
    {
        if (_fill == null)
        {
            _fill = new com.example.alldocument.library.fc.hslf.model.Fill(this);
        }
        return _fill;
    }
     ...
     * @see com.example.alldocument.library.fc.hslf.record.RecordTypes
     */
