...
public class ActionSet {
	...
	protected com.example.alldocument.library.thirdpart.emf.io.Action defaultAction;
	...
	public ActionSet() {
		actions = new HashMap();
		defaultAction = new com.example.alldocument.library.thirdpart.emf.io.Action.Unknown();
	}
	 ...
	 *         found.
	 */
	public com.example.alldocument.library.thirdpart.emf.io.Action get(int actionCode) {
		com.example.alldocument.library.thirdpart.emf.io.Action action = (Action) actions.get(new Integer(actionCode));
		if (action == null) {
