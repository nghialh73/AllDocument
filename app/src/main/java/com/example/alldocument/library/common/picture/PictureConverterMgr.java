...
import com.example.alldocument.library.common.picture.PictureConverterThread;
import com.example.alldocument.library.common.picture.VectorgraphConverterThread;
...
import com.example.alldocument.library.thirdpart.emf.util.EMFUtil;
...
public class PictureConverterMgr
{
    ...
    public void convertWMF_EMF(byte type, String sourPath, String destPath, int picWidth, int picHeight, boolean thumbnail)
    {
         ...
         {
    		 Bitmap sBitmap = null;
             if(type == com.example.alldocument.library.common.picture.Picture.WMF)
             {
