 ...
 * @author Yegor Kozlov
 */
public class ShapeGroup extends com.example.alldocument.library.fc.hslf.model.Shape
{
    /**
    ...
    /**
      ...
      */
    protected ShapeGroup(EscherContainerRecord escherRecord, com.example.alldocument.library.fc.hslf.model.Shape parent)
    {
    ...
    public com.example.alldocument.library.fc.hslf.model.Shape[] getShapes()
    {
        ...
        List<com.example.alldocument.library.fc.hslf.model.Shape> shapeList = new ArrayList<com.example.alldocument.library.fc.hslf.model.Shape>();
        while (iter.hasNext())
        {
            EscherRecord r = iter.next();
            if (r instanceof EscherContainerRecord)
            {
                // Create the Shape for it
                EscherContainerRecord container = (EscherContainerRecord)r;
                com.example.alldocument.library.fc.hslf.model.Shape shape = ShapeFactory.createShape(container, this);
        ...
        com.example.alldocument.library.fc.hslf.model.Shape[] shapes = shapeList.toArray(new com.example.alldocument.library.fc.hslf.model.Shape[shapeList.size()]);
        return shapes;
    }
     ...
     * @return
     */
    public Rectangle2D getClientAnchor2D(com.example.alldocument.library.fc.hslf.model.Shape shape)
    {
     ...
     * In most cases shape group type is {@link com.example.alldocument.library.fc.hslf.model.ShapeTypes#NotPrimitive}
     *
     * @return type of the shape.
     */
