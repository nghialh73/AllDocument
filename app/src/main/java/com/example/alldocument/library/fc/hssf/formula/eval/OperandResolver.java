...
import com.example.alldocument.library.fc.hssf.formula.eval.NumericValueEval;
...
public final class OperandResolver {
	 ...
	 */
	public static com.example.alldocument.library.fc.hssf.formula.eval.ValueEval getSingleValue(com.example.alldocument.library.fc.hssf.formula.eval.ValueEval arg, int srcCellRow, int srcCellCol)
			throws EvaluationException {
		com.example.alldocument.library.fc.hssf.formula.eval.ValueEval result;
		if (arg instanceof com.example.alldocument.library.fc.hssf.formula.eval.RefEval)
		{
			result = ((com.example.alldocument.library.fc.hssf.formula.eval.RefEval) arg).getInnerValueEval();
		} 
		else if (arg instanceof com.example.alldocument.library.fc.hssf.formula.eval.AreaEval)
		{
			result = chooseSingleElementFromArea((com.example.alldocument.library.fc.hssf.formula.eval.AreaEval) arg, srcCellRow, srcCellCol);
		}
		else 
		{
			result = arg;
		}
		if (result instanceof com.example.alldocument.library.fc.hssf.formula.eval.ErrorEval)
		{
			throw new EvaluationException((com.example.alldocument.library.fc.hssf.formula.eval.ErrorEval) result);
		}
	 ...
	 */
	public static com.example.alldocument.library.fc.hssf.formula.eval.ValueEval chooseSingleElementFromArea(com.example.alldocument.library.fc.hssf.formula.eval.AreaEval ae,
                                                                                               int srcCellRow, int srcCellCol) throws EvaluationException {
		com.example.alldocument.library.fc.hssf.formula.eval.ValueEval result = chooseSingleElementFromAreaInternal(ae, srcCellRow, srcCellCol);
		if (result instanceof com.example.alldocument.library.fc.hssf.formula.eval.ErrorEval) {
			throw new EvaluationException((com.example.alldocument.library.fc.hssf.formula.eval.ErrorEval) result);
		}
		return result;
	 ...
	 */
	private static com.example.alldocument.library.fc.hssf.formula.eval.ValueEval chooseSingleElementFromAreaInternal(AreaEval ae,
                                                                                                        int srcCellRow, int srcCellCol) throws EvaluationException {

		if(false) {
			// this is too simplistic
			if(ae.containsRow(srcCellRow) && ae.containsColumn(srcCellCol)) {
				throw new EvaluationException(com.example.alldocument.library.fc.hssf.formula.eval.ErrorEval.CIRCULAR_REF_ERROR);
			}
		/*
	 ...
	 *
	 */
	public static int coerceValueToInt(com.example.alldocument.library.fc.hssf.formula.eval.ValueEval ev) throws EvaluationException {
		if (ev == com.example.alldocument.library.fc.hssf.formula.eval.BlankEval.instance) {
			return 0;
		}
	 ...
	 * Note - <tt>BlankEval</tt> is converted to {@link com.example.alldocument.library.fc.hssf.formula.eval.NumberEval#ZERO}.
	 * @param ev must be a {@link com.example.alldocument.library.fc.hssf.formula.eval.NumberEval}, {@link com.example.alldocument.library.fc.hssf.formula.eval.StringEval}, {@link com.example.alldocument.library.fc.hssf.formula.eval.BoolEval} or
	 * {@link com.example.alldocument.library.fc.hssf.formula.eval.BlankEval}
	 ...
	 * {@link com.example.alldocument.library.fc.hssf.formula.eval.StringEval}, {@link com.example.alldocument.library.fc.hssf.formula.eval.BoolEval} or {@link com.example.alldocument.library.fc.hssf.formula.eval.BlankEval}
	 */
	public static double coerceValueToDouble(com.example.alldocument.library.fc.hssf.formula.eval.ValueEval ev) throws EvaluationException {
		...
		if (ev instanceof com.example.alldocument.library.fc.hssf.formula.eval.StringEval) {
			Double dd = parseDouble(((com.example.alldocument.library.fc.hssf.formula.eval.StringEval) ev).getStringValue());
			if (dd == null) {
				throw EvaluationException.invalidValue();
			}
	 ...
	 */
	public static String coerceValueToString(com.example.alldocument.library.fc.hssf.formula.eval.ValueEval ve) {
		if (ve instanceof StringValueEval) {
			StringValueEval sve = (StringValueEval) ve;
			return sve.getStringValue();
		}
		if (ve == com.example.alldocument.library.fc.hssf.formula.eval.BlankEval.instance) {
			return "";
		}
	...
	public static Boolean coerceValueToBoolean(ValueEval ve, boolean stringsAreBlanks) throws EvaluationException {
		...
		if (ve == null || ve == com.example.alldocument.library.fc.hssf.formula.eval.BlankEval.instance) {
			// TODO - remove 've == null' condition once AreaEval is fixed
			return null;
		}
		if (ve instanceof com.example.alldocument.library.fc.hssf.formula.eval.BoolEval) {
		...
		if (ve instanceof com.example.alldocument.library.fc.hssf.formula.eval.StringEval) {
			if (stringsAreBlanks) {
				return null;
			}
			...
			throw new EvaluationException(com.example.alldocument.library.fc.hssf.formula.eval.ErrorEval.VALUE_INVALID);
		}
		...
		if (ve instanceof com.example.alldocument.library.fc.hssf.formula.eval.ErrorEval) {
