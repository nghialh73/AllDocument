...
final class Order1 extends com.example.alldocument.library.java.awt.geom.Curve {
    private double x0;
    private double y0;
    private double x1;
    private double y1;
    ...
    public com.example.alldocument.library.java.awt.geom.Curve getReversedCurve() {
