 ...
 * 时间:               下午4:23:51
 */
package com.example.alldocument.library.fc.ppt;
...
import com.example.alldocument.library.common.PaintKit;
import com.example.alldocument.library.common.autoshape.ExtendPath;
...
import com.example.alldocument.library.common.bg.Gradient;
import com.example.alldocument.library.common.bg.LinearGradientShader;
import com.example.alldocument.library.common.bg.RadialGradientShader;
import com.example.alldocument.library.common.bg.TileShader;
import com.example.alldocument.library.common.hyperlink.Hyperlink;
import com.example.alldocument.library.common.pictureefftect.PictureEffectInfoFactory;
import com.example.alldocument.library.common.shape.AbstractShape;
import com.example.alldocument.library.common.shape.ArbitraryPolygonShape;
import com.example.alldocument.library.common.shape.Arrow;
import com.example.alldocument.library.common.shape.AutoShape;
import com.example.alldocument.library.common.shape.GroupShape;
import com.example.alldocument.library.common.shape.IShape;
import com.example.alldocument.library.common.shape.LineShape;
import com.example.alldocument.library.common.shape.PictureShape;
import com.example.alldocument.library.common.shape.ShapeTypes;
import com.example.alldocument.library.common.shape.TableCell;
import com.example.alldocument.library.common.shape.TableShape;
import com.example.alldocument.library.common.shape.TextBox;
import com.example.alldocument.library.constant.AutoShapeConstant;
...
import com.example.alldocument.library.constant.wp.WPAttrConstant;
import com.example.alldocument.library.constant.wp.WPModelConstant;
import com.example.alldocument.library.fc.FCKit;
import com.example.alldocument.library.fc.ShapeKit;
import com.example.alldocument.library.fc.hslf.HSLFSlideShow;
import com.example.alldocument.library.fc.hslf.model.Fill;
import com.example.alldocument.library.fc.hslf.model.HeadersFooters;
import com.example.alldocument.library.fc.hslf.model.Line;
import com.example.alldocument.library.fc.hslf.model.MasterSheet;
import com.example.alldocument.library.fc.hslf.model.Notes;
import com.example.alldocument.library.fc.hslf.model.Shape;
import com.example.alldocument.library.fc.hslf.model.ShapeGroup;
import com.example.alldocument.library.fc.hslf.model.Sheet;
import com.example.alldocument.library.fc.hslf.model.SimpleShape;
import com.example.alldocument.library.fc.hslf.model.Slide;
import com.example.alldocument.library.fc.hslf.model.SlideMaster;
import com.example.alldocument.library.fc.hslf.model.TextShape;
import com.example.alldocument.library.fc.hslf.model.TitleMaster;
...
import com.example.alldocument.library.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import com.example.alldocument.library.fc.hslf.usermodel.PictureData;
import com.example.alldocument.library.fc.hslf.usermodel.RichTextRun;
import com.example.alldocument.library.fc.hslf.usermodel.SlideShow;
import com.example.alldocument.library.fc.ppt.bulletnumber.BulletNumberManage;
import com.example.alldocument.library.fc.ss.usermodel.Textbox;
import com.example.alldocument.library.java.awt.Dimension;
import com.example.alldocument.library.java.awt.Rectangle;
import com.example.alldocument.library.java.awt.Rectanglef;
import com.example.alldocument.library.java.awt.geom.Rectangle2D;
import com.example.alldocument.library.pg.animate.ShapeAnimation;
import com.example.alldocument.library.pg.model.PGModel;
import com.example.alldocument.library.pg.model.PGNotes;
import com.example.alldocument.library.pg.model.PGSlide;
import com.example.alldocument.library.simpletext.font.FontTypefaceManage;
import com.example.alldocument.library.simpletext.model.AttrManage;
import com.example.alldocument.library.simpletext.model.IAttributeSet;
import com.example.alldocument.library.simpletext.model.LeafElement;
import com.example.alldocument.library.simpletext.model.ParagraphElement;
import com.example.alldocument.library.simpletext.model.SectionElement;
import com.example.alldocument.library.ss.util.format.NumericFormatter;
import com.example.alldocument.library.system.AbstractReader;
import com.example.alldocument.library.system.BackReaderThread;
...
{   
    ...
    private com.example.alldocument.library.common.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private com.example.alldocument.library.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        com.example.alldocument.library.common.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
             ...
             com.example.alldocument.library.java.awt.Color color = ((SimpleShape)shape).getLineColor();
             
             if(color != null)
             {
            	 line = new com.example.alldocument.library.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.example.alldocument.library.java.awt.Color fillColor = fill.getForegroundColor();
            	com.example.alldocument.library.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof com.example.alldocument.library.fc.hslf.model.AutoShape  // 文本框
                    || shape instanceof com.example.alldocument.library.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof com.example.alldocument.library.fc.hslf.model.Freeform
            || shape instanceof com.example.alldocument.library.fc.hslf.model.AutoShape
            || shape instanceof com.example.alldocument.library.fc.hslf.model.TextBox
            || shape instanceof com.example.alldocument.library.fc.hslf.model.Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            else if(shape instanceof com.example.alldocument.library.fc.hslf.model.Freeform)
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((com.example.alldocument.library.fc.hslf.model.Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((com.example.alldocument.library.fc.hslf.model.Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((com.example.alldocument.library.fc.hslf.model.Freeform)shape).getFreeformPath(rect,
            ...
            else if(shape instanceof com.example.alldocument.library.fc.hslf.model.AutoShape
                    || shape instanceof com.example.alldocument.library.fc.hslf.model.TextBox)
            {
                // autoShape
            ...
            // 图片
            else if(shape instanceof com.example.alldocument.library.fc.hslf.model.Picture)
            {   
                com.example.alldocument.library.fc.hslf.model.Picture poiPic = (com.example.alldocument.library.fc.hslf.model.Picture)shape;
        ...
        else if(shape instanceof com.example.alldocument.library.fc.hslf.model.Table)
        {
            com.example.alldocument.library.fc.hslf.model.Table poiTable = (com.example.alldocument.library.fc.hslf.model.Table)shape;
            if (poiTable != null)
            {
     ...
     * @param pgSlide
     */
    private void processTable(PGSlide pgSlide, com.example.alldocument.library.fc.hslf.model.Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                com.example.alldocument.library.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	com.example.alldocument.library.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            com.example.alldocument.library.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && text.trim().length() > 0)
        {
            ...
            int len = text.length();
            com.example.alldocument.library.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != com.example.alldocument.library.fc.hslf.record.TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
        com.example.alldocument.library.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
        ...
        com.example.alldocument.library.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null)
        {
...
//      }
     ...
     * 
     */
    private int converterColor(com.example.alldocument.library.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
