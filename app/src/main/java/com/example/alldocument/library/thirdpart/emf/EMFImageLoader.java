...
import com.example.alldocument.library.thirdpart.emf.data.BitmapInfoHeader;
import com.example.alldocument.library.thirdpart.emf.data.BlendFunction;
...
public class EMFImageLoader {
    ...
    public static Bitmap readImage(
        ...
        if (bmi.getBitCount() == 1) {
            ...
            f.setSize(new com.example.alldocument.library.java.awt.Dimension(width + 20, height + 20));
            f.setVisible(true);*/

            return result;

        } else if ((bmi.getBitCount() == 4)
				&& (bmi.getCompression() == com.example.alldocument.library.thirdpart.emf.EMFConstants.BI_RGB)) {
        ...
        // BITMAPINFOHEADER is BI_RGB, the bmiColors member of BITMAPINFO is NULL.
			...
			int alphaFormat = com.example.alldocument.library.thirdpart.emf.EMFConstants.AC_SRC_OVER;
			...
			if (alphaFormat != com.example.alldocument.library.thirdpart.emf.EMFConstants.AC_SRC_ALPHA) {
