...
import com.example.alldocument.library.fc.hssf.formula.CellEvaluationFrame;
...
final class EvaluationTracker {
	...
	private final com.example.alldocument.library.fc.hssf.formula.EvaluationCache _cache;

	public EvaluationTracker(com.example.alldocument.library.fc.hssf.formula.EvaluationCache cache) {
		_cache = cache;
	 ...
	 */
	public void endEvaluate(com.example.alldocument.library.fc.hssf.formula.CellCacheEntry cce) {
	...
	public void acceptFormulaDependency(com.example.alldocument.library.fc.hssf.formula.CellCacheEntry cce) {
