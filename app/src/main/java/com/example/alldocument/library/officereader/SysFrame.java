...
import com.example.alldocument.library.officereader.FileListActivity;
import com.example.alldocument.library.officereader.beans.AImageButton;
import com.example.alldocument.library.officereader.beans.AImageTextButton;
...
public class SysFrame extends LinearLayout
{
    ...
    public SysFrame(Context context, IControl control)
    {
        ...
        setBackgroundResource(com.example.alldocument.R.drawable.sys_background);
    ...
    private void initVertical(Resources res)
    {
        ...
        // 搜索
        BitmapFactory.decodeResource(res, com.example.alldocument.R.drawable.sys_search, opts);
        AImageButton search = new AImageButton(context, control, "",  com.example.alldocument.R.drawable.sys_search, -1, EventConstant.SYS_SEARCH_ID);
        search.setPushBgResID(com.example.alldocument.R.drawable.sys_search_bg_push);
        ...
        BitmapFactory.decodeResource(context.getResources(),  com.example.alldocument.R.drawable.sys_button_normal_bg_vertical, opts);
        params = new LayoutParams(opts.outWidth, opts.outHeight);
        params.gravity = Gravity.CENTER;
        params.bottomMargin = GAP * 6;
        // 最近打开的文件
        addView(createButtonVertical(context, params, com.example.alldocument.R.drawable.sys_recent_vertical,
            com.example.alldocument.R.string.sys_button_recently_files, EventConstant.SYS_RECENTLY_FILES_ID));
        
        // 标星文件
        addView(createButtonVertical(context, params, com.example.alldocument.R.drawable.sys_mark_star_vertical,
            com.example.alldocument.R.string.sys_button_mark_files, EventConstant.SYS_MARK_FILES_ID));
        
        // sdcard文件
        params = new LayoutParams(opts.outWidth, opts.outHeight);
        params.gravity = Gravity.CENTER;
        addView(createButtonVertical(context, params , com.example.alldocument.R.drawable.sys_sacard_vertical,
            com.example.alldocument.R.string.sys_button_local_storage, EventConstant.SYS_MEMORY_CARD_ID));
        ...
        int iconID, int textID, int actionID)
    {
        ...
        tb.setNormalBgResID(com.example.alldocument.R.drawable.sys_button_normal_bg_vertical);
        tb.setPushBgResID(com.example.alldocument.R.drawable.sys_button_push_bg_vertical);
        tb.setFocusBgResID(com.example.alldocument.R.drawable.sys_button_focus_bg_vertical);
    ...
    private void initHorizontal(Resources res)
    {
        ...
        BitmapFactory.decodeResource(context.getResources(), com.example.alldocument.R.drawable.sys_button_normal_bg_horizontal, opts);
        ...
        // 最近打开的文件
        hor_2.addView(createButtonHorizontal(context, params, com.example.alldocument.R.drawable.sys_recent_horizontal,
            com.example.alldocument.R.string.sys_button_recently_files, EventConstant.SYS_RECENTLY_FILES_ID));
        
        // 标星文件
        hor_2.addView(createButtonHorizontal(context, params, com.example.alldocument.R.drawable.sys_mark_star_horizontal,
            com.example.alldocument.R.string.sys_button_mark_files, EventConstant.SYS_MARK_FILES_ID));
        
        // sdcard文件
        params = new LayoutParams(opts.outWidth, opts.outHeight);
        params.gravity = Gravity.CENTER;
        hor_2.addView(createButtonHorizontal(context, params, com.example.alldocument.R.drawable.sys_sacard_horizontal,
            com.example.alldocument.R.string.sys_button_local_storage, EventConstant.SYS_MEMORY_CARD_ID));
    ...
    {        
        ...
        tb.setLayoutParams(params);
        tb.setNormalBgResID(com.example.alldocument.R.drawable.sys_button_normal_bg_horizontal);
        tb.setPushBgResID(com.example.alldocument.R.drawable.sys_button_push_bg_horizontal);
        tb.setFocusBgResID(com.example.alldocument.R.drawable.sys_button_focus_bg_horizontal);
        tb.setOnClickListener(onClickListener);
        return tb;
    }
    /**
