...
import com.example.alldocument.library.constant.fc.ConstantValueParser;
 ...
 */
public final class ArrayPtg extends com.example.alldocument.library.fc.hssf.formula.ptg.Ptg {
	...
	public byte getDefaultOperandClass() {
		return com.example.alldocument.library.fc.hssf.formula.ptg.Ptg.CLASS_ARRAY;
	}

	/**
	 * Represents the initial plain tArray token (without the constant data that trails the whole
	 * formula).  Objects of this class are only temporary and cannot be used as {@link com.example.alldocument.library.fc.hssf.formula.ptg.Ptg}s.
