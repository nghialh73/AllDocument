...
import com.example.alldocument.library.constant.DialogConstant;
...
import com.example.alldocument.library.officereader.FileFrame;
import com.example.alldocument.library.officereader.FileListControl;
...
import com.example.alldocument.library.officereader.filelist.FileDialogAction;
import com.example.alldocument.library.officereader.filelist.FileItem;
import com.example.alldocument.library.officereader.filelist.FileItemAdapter;
import com.example.alldocument.library.officereader.filelist.FileItemView;
import com.example.alldocument.library.officereader.filelist.FileRenameDialog;
import com.example.alldocument.library.officereader.filelist.FileSort;
import com.example.alldocument.library.officereader.filelist.FileSortType;
import com.example.alldocument.library.officereader.filelist.FileToolsbar;
import com.example.alldocument.library.officereader.filelist.NewFolderDialog;
import com.example.alldocument.library.officereader.filelist.SortDialog;
import com.example.alldocument.library.officereader.search.ISearchResult;
import com.example.alldocument.library.officereader.search.Search;
import com.example.alldocument.library.system.FileKit;
import com.example.alldocument.library.system.IControl;
import com.example.alldocument.library.system.dialog.MessageDialog;
import com.example.alldocument.library.system.dialog.QuestionDialog;
...
public class FileListActivity extends Activity implements ISearchResult
{
    ...
    public void onCreate(Bundle icicle)
    {
        ...
        fileFrame = new com.example.alldocument.library.officereader.FileFrame(getApplicationContext());
        ...
        setTheme(control.getSysKit().isVertical(this) ? 
            com.example.alldocument.R.style.title_background_vertical : com.example.alldocument.R.style.title_background_horizontal);
    ...
    private void init()
    {
        ...
        emptyView.setText(com.example.alldocument.R.string.file_message_empty_directory);
    ...
    {  
        ...
        if (key.length() > 0)
        {
            ...
            setTitle(getResources().getString(com.example.alldocument.R.string.sys_button_search));
        ...
        {   
            ...
            public void run()
            {
                ...
                if (directoryEntries.size() == 0)
                {
                    ...
                    if (listType == LIST_TYPE_SEARCH)
                    {
                        emptyView.setText(com.example.alldocument.R.string.sys_no_match);
                    }
                    else
                    {
                        emptyView.setText(com.example.alldocument.R.string.file_message_empty_directory);
        ...
        switch (actionID)
        {
            ...
            case EventConstant.FILE_CREATE_FOLDER_ID:   // 新建文件夹
                ...
                new NewFolderDialog(control, this, dialogAction, vector, 
                    ...
                    com.example.alldocument.R.string.file_toolsbar_create_folder).show();
                break;               
            ...
            case EventConstant.FILE_PASTE_ID:           // 粘贴
                ...
                {
                    CharSequence message = getResources().getText(com.example.alldocument.R.string.dialog_move_file_error);
                    new MessageDialog(control, this, dialogAction, null, 
                        DialogConstant.MESSAGE_DIALOG_ID, 
                        com.example.alldocument.R.string.dialog_error_title, message.toString()).show();
                }
                break;
            ...
            case EventConstant.FILE_SORT_ID:            // 排序
                ...
                new SortDialog(control, this, dialogAction, vectorSort, 
                    ...
                    com.example.alldocument.R.string.file_toolsbar_sort, com.example.alldocument.R.array.file_sort_items).show();
                break;
            ...
            case EventConstant.SYS_HELP_ID:             // 帮助
                Intent intent = new Intent(Intent.ACTION_VIEW, 
                    Uri.parse(getResources().getString(com.example.alldocument.R.string.sys_url_wxiwei)));
            ...
            case EventConstant.FILE_CREATE_FOLDER_FAILED_ID:
                CharSequence text = getResources().getText(com.example.alldocument.R.string.file_toolsbar_create_folder);
                new MessageDialog(control, this, dialogAction, null, 
                    DialogConstant.MESSAGE_DIALOG_ID, 
                    com.example.alldocument.R.string.dialog_create_folder_error, text.toString()).show();
                break;
    ...
    public void fileRename()
    {
        ...
        new FileRenameDialog(control, this, dialogAction, renameVector, 
            ...
            com.example.alldocument.R.string.file_toolsbar_rename).show();
    }
            ...
            for (int i = 0; i < fileNameList.length; i++)
            {
                ...
                if (tempFile.exists())
                {
                    ...
                    else
                    {
                        ...
                        vector.add(tempFile);
                        vector.add(file);
                        CharSequence text = getResources().getText(com.example.alldocument.R.string.dialog_name_error);
                        String message = text.toString().replace("%s", tempFile.getName())
                            .concat(getResources().getText(com.example.alldocument.R.string.dialog_overwrite_file).toString());
                        new QuestionDialog(control, this, dialogAction, vector, 
                            DialogConstant.OVERWRITEFILE_DIALOG_ID, 
                            com.example.alldocument.R.string.dialog_error_title, message).show();
                    }
                }
            }
            browseTo(currentDirectory);
    ...
    public void fileDelete()
    {
        ...
        CharSequence message = getResources().getText(com.example.alldocument.R.string.dialog_delete_file);
        new QuestionDialog(control, this, dialogAction, vector, 
            DialogConstant.DELETEFILE_DIALOG_ID, 
            com.example.alldocument.R.string.file_toolsbar_delete, message.toString()).show();
    }
    ...
    public void fileShare()
    {
        ...
        startActivity(Intent.createChooser(intent, getResources().getText(com.example.alldocument.R.string.sys_share_title)));
    }
