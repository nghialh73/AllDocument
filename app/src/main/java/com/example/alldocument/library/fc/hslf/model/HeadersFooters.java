...
public final class HeadersFooters
{
    ...
    private com.example.alldocument.library.fc.hslf.model.Sheet _sheet;
    ...
    public HeadersFooters(HeadersFootersContainer rec, com.example.alldocument.library.fc.hslf.model.Sheet sheet, boolean newRecord,
                          boolean isPpt2007)
    {
        _container = rec;
        _newRecord = newRecord;
    ...
    private boolean isVisible(int flag, int placeholderId)
    {
        ...
        if (_ppt2007)
        {
            com.example.alldocument.library.fc.hslf.model.Sheet master = _sheet != null ? _sheet : _ppt.getSlidesMasters()[0];
            com.example.alldocument.library.fc.hslf.model.TextShape placeholder = master.getPlaceholder(placeholderId);
