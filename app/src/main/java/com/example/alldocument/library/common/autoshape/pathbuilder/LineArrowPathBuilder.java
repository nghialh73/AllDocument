 ...
 * 时间:              下午3:09:14
 */
package com.example.alldocument.library.common.autoshape.pathbuilder;
...
//            }
     ...
     * @return
     */
    public static com.example.alldocument.library.common.autoshape.pathbuilder.ArrowPathAndTail getDirectLineArrowPath(float startX, float startY, float endX, float endY, Arrow arrow, int lineWidth)
    {
        return getDirectLineArrowPath(startX, startY, endX, endY, arrow, lineWidth, 1.0f);
    }
    
    public static com.example.alldocument.library.common.autoshape.pathbuilder.ArrowPathAndTail getDirectLineArrowPath(float startX, float startY, float endX, float endY, Arrow arrow, int lineWidth, float zoom)
    {
    	com.example.alldocument.library.common.autoshape.pathbuilder.ArrowPathAndTail arrowPathAndTail = new com.example.alldocument.library.common.autoshape.pathbuilder.ArrowPathAndTail();
    ...
    public static com.example.alldocument.library.common.autoshape.pathbuilder.ArrowPathAndTail getQuadBezArrowPath(float startX, float startY,
    ...
    public static com.example.alldocument.library.common.autoshape.pathbuilder.ArrowPathAndTail getCubicBezArrowPath(float startX, float startY,
    ...
    public static com.example.alldocument.library.common.autoshape.pathbuilder.ArrowPathAndTail getCubicBezArrowPath(float startX, float startY,
                                                                                                       ...
                                                                                                       Arrow arrow, int lineWidth, float zoom)
    {
    	com.example.alldocument.library.common.autoshape.pathbuilder.ArrowPathAndTail arrowPathAndTail = new ArrowPathAndTail();
