...
import com.example.alldocument.library.fc.ss.usermodel.Picture;
import com.example.alldocument.library.fc.ss.util.ImageUtils;
...
public final class HSSFPicture extends HSSFSimpleShape implements Picture
{
     ...
     */
    public HSSFPicture(EscherContainerRecord escherContainer, com.example.alldocument.library.fc.hssf.usermodel.HSSFShape parent, com.example.alldocument.library.fc.hssf.usermodel.HSSFAnchor anchor)
    {
