...
import com.example.alldocument.library.officereader.filelist.FileCheckBox;
...
public class FileItemView extends LinearLayout
{
     ...
     * @param activity
     */
    public FileItemView(Context context, IControl control, FileItemAdapter fia, com.example.alldocument.library.officereader.filelist.FileItem fileItem)
    {
        super(context);
     ...
     * 
     */
    private void init(IControl control, com.example.alldocument.library.officereader.filelist.FileItem fileItem, FileItemAdapter fia)
    {
        ...
        {   
            checkBox = new com.example.alldocument.library.officereader.filelist.FileCheckBox(context, control, fileItem);
