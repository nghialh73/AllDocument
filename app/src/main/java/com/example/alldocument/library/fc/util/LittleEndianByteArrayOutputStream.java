...
import com.example.alldocument.library.fc.util.DelayableLittleEndianOutput;
import com.example.alldocument.library.fc.util.LittleEndianOutput;

/**
 * Adapts a plain byte array to {@link com.example.alldocument.library.fc.util.LittleEndianOutput}
 * 
 * 
 * @author Josh Micich
 */
public final class LittleEndianByteArrayOutputStream implements com.example.alldocument.library.fc.util.LittleEndianOutput,
        DelayableLittleEndianOutput
{
    ...
    public com.example.alldocument.library.fc.util.LittleEndianOutput createDelayedOutput(int size)
    {
        checkPosition(size);
