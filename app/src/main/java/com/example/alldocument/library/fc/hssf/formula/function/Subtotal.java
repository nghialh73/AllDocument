...
import static com.example.alldocument.library.fc.hssf.formula.function.AggregateFunction.subtotalInstance;
 ...
 */
public class Subtotal implements com.example.alldocument.library.fc.hssf.formula.function.Function {

	private static com.example.alldocument.library.fc.hssf.formula.function.Function findFunction(int functionCode) throws EvaluationException {
		com.example.alldocument.library.fc.hssf.formula.function.Function func;
        switch (functionCode) {
