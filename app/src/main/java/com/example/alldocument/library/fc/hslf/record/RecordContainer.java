...
import com.example.alldocument.library.fc.hslf.record.ParentAwareRecord;
import com.example.alldocument.library.fc.hslf.record.Record;
import com.example.alldocument.library.fc.hslf.util.MutableByteArrayOutputStream;
import com.example.alldocument.library.fc.util.ArrayUtil;
...
public abstract class RecordContainer extends com.example.alldocument.library.fc.hslf.record.Record
{
	protected com.example.alldocument.library.fc.hslf.record.Record[] _children;
	private Boolean changingChildRecordsLock = Boolean.TRUE;

	/**
	 * Return any children
	 */
    public com.example.alldocument.library.fc.hslf.record.Record[] getChildRecords() { return _children; }
	 ...
	 */
	private int findChildLocation(com.example.alldocument.library.fc.hslf.record.Record child) {
	 ...
	 */
	private void appendChild(com.example.alldocument.library.fc.hslf.record.Record newChild) {
		synchronized(changingChildRecordsLock) {
			// Copy over, and pop the child in at the end
			com.example.alldocument.library.fc.hslf.record.Record[] nc = new com.example.alldocument.library.fc.hslf.record.Record[(_children.length + 1)];
	 ...
	 * @param position
	 */
	private void addChildAt(com.example.alldocument.library.fc.hslf.record.Record newChild, int position) {
		synchronized(changingChildRecordsLock) {
	 ...
	 */
	public com.example.alldocument.library.fc.hslf.record.Record findFirstOfType(long type) {
		for(int i=0; i<_children.length; i++) {
     ...
     */
    public com.example.alldocument.library.fc.hslf.record.Record removeChild(com.example.alldocument.library.fc.hslf.record.Record ch) {
        com.example.alldocument.library.fc.hslf.record.Record rm = null;
        ArrayList<com.example.alldocument.library.fc.hslf.record.Record> lst = new ArrayList<com.example.alldocument.library.fc.hslf.record.Record>();
        for(com.example.alldocument.library.fc.hslf.record.Record r : _children) {
            if(r != ch) lst.add(r);
            else rm = r;
        }
        _children = lst.toArray(new com.example.alldocument.library.fc.hslf.record.Record[lst.size()]);
        return rm;
    }
	 ...
	 */
	public void appendChildRecord(com.example.alldocument.library.fc.hslf.record.Record newChild) {
		synchronized(changingChildRecordsLock) {
			appendChild(newChild);
		}
	}
	 ...
	 * @param after
	 */
	public void addChildAfter(com.example.alldocument.library.fc.hslf.record.Record newChild, com.example.alldocument.library.fc.hslf.record.Record after) {
		synchronized(changingChildRecordsLock) {
	 ...
	 * @param before
	 */
	public void addChildBefore(com.example.alldocument.library.fc.hslf.record.Record newChild, com.example.alldocument.library.fc.hslf.record.Record before) {
		synchronized(changingChildRecordsLock) {
			// Decide where we're going to put it
	 ...
	 */
	public void moveChildBefore(com.example.alldocument.library.fc.hslf.record.Record child, com.example.alldocument.library.fc.hslf.record.Record before) {
	 ...
	 */
	public void moveChildrenBefore(com.example.alldocument.library.fc.hslf.record.Record firstChild, int number, com.example.alldocument.library.fc.hslf.record.Record before) {
		if(number < 1) { return; }
	 ...
	 */
	public void moveChildrenAfter(com.example.alldocument.library.fc.hslf.record.Record firstChild, int number, com.example.alldocument.library.fc.hslf.record.Record after) {
		if(number < 1) { return; }
     ...
     */
    public void setChildRecord(com.example.alldocument.library.fc.hslf.record.Record[] records) {
    ...
    public static void handleParentAwareRecords(RecordContainer br) {
        ...
        for (com.example.alldocument.library.fc.hslf.record.Record record : br.getChildRecords()) {
