...
import com.example.alldocument.library.fc.hwpf.model.Colorref;
import com.example.alldocument.library.fc.hwpf.model.Ffn;
 ...
 * @author Ryan Ackley
 */
public final class CharacterRun extends com.example.alldocument.library.fc.hwpf.usermodel.Range implements Cloneable
{
    ...
    */
    ...
    public Object clone() throws CloneNotSupportedException
    {
        ...
        cp._props.setDttmRMark((com.example.alldocument.library.fc.hwpf.usermodel.DateAndTime)_props.getDttmRMark().clone());
        cp._props.setDttmRMarkDel((com.example.alldocument.library.fc.hwpf.usermodel.DateAndTime)_props.getDttmRMarkDel().clone());
        cp._props.setDttmPropRMark((com.example.alldocument.library.fc.hwpf.usermodel.DateAndTime)_props.getDttmPropRMark().clone());
