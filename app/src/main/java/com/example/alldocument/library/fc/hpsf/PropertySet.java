...
import com.example.alldocument.library.fc.hpsf.MarkUnsupportedException;
import com.example.alldocument.library.fc.hpsf.MissingSectionException;
import com.example.alldocument.library.fc.hpsf.NoPropertySetStreamException;
import com.example.alldocument.library.fc.hpsf.NoSingleSectionException;
import com.example.alldocument.library.fc.hpsf.Property;
import com.example.alldocument.library.fc.hpsf.PropertySetFactory;
 ...
 *
 * <p>A {@link PropertySet} has a list of {@link com.example.alldocument.library.fc.hpsf.Section}s, and each
 * {@link com.example.alldocument.library.fc.hpsf.Section} has a {@link com.example.alldocument.library.fc.hpsf.Property} array. Use {@link
 * #getSections} to retrieve the {@link com.example.alldocument.library.fc.hpsf.Section}s, then call {@link
 * com.example.alldocument.library.fc.hpsf.Section#getProperties} for each {@link com.example.alldocument.library.fc.hpsf.Section} to get hold of the
 * {@link com.example.alldocument.library.fc.hpsf.Property} arrays.</p> Since the vast majority of {@link
 * PropertySet}s contains only a single {@link com.example.alldocument.library.fc.hpsf.Section}, the
 * convenience method {@link #getProperties} returns the properties of
 * a {@link PropertySet}'s {@link com.example.alldocument.library.fc.hpsf.Section} (throwing a {@link
 * NoSingleSectionException} if the {@link PropertySet} contains more
 * (or less) than exactly one {@link com.example.alldocument.library.fc.hpsf.Section}).</p>
 *
...
public class PropertySet
{
     ...
     */
    protected com.example.alldocument.library.fc.hpsf.ClassID classID;
     ...
     */
    public com.example.alldocument.library.fc.hpsf.ClassID getClassID()
    {
        return classID;
    }
    ...
    /**
     * <p>Returns the number of {@link com.example.alldocument.library.fc.hpsf.Section}s in the property
     * set.</p>
     *
     * @return The number of {@link com.example.alldocument.library.fc.hpsf.Section}s in the property set.
     */
    ...
    /**
     * <p>Returns the {@link com.example.alldocument.library.fc.hpsf.Section}s in the property set.</p>
     *
     * @return The {@link com.example.alldocument.library.fc.hpsf.Section}s in the property set.
     */
                                              ...
                                              final int length)
    {
        ...
        if (!com.example.alldocument.library.fc.hpsf.Util.equal(temp, BYTE_ORDER_ASSERTION))
            return false;
        ...
        if (!com.example.alldocument.library.fc.hpsf.Util.equal(temp, FORMAT_ASSERTION))
            return false;
        // final long osVersion = LittleEndian.getUInt(src, offset);
        o += LittleEndian.INT_SIZE;
        // final ClassID classID = new ClassID(src, offset);
        o += com.example.alldocument.library.fc.hpsf.ClassID.LENGTH;
    ...
    throws UnsupportedEncodingException
    {
        ...
        o += LittleEndian.INT_SIZE;
        classID = new com.example.alldocument.library.fc.hpsf.ClassID(src, o);
        o += com.example.alldocument.library.fc.hpsf.ClassID.LENGTH;
        ...
        {
            final com.example.alldocument.library.fc.hpsf.Section s = new com.example.alldocument.library.fc.hpsf.Section(src, o);
            o += com.example.alldocument.library.fc.hpsf.ClassID.LENGTH + LittleEndian.INT_SIZE;
            sections.add(s);
        }
    }
    ...
    public boolean isSummaryInformation()
    {
        if (sections.size() <= 0)
            return false;
        return com.example.alldocument.library.fc.hpsf.Util.equal(((com.example.alldocument.library.fc.hpsf.Section) sections.get(0)).getFormatID().getBytes(),
    ...
    /**
     * <p>Convenience method returning the {@link com.example.alldocument.library.fc.hpsf.Property} array
     * contained in this property set. It is a shortcut for getting
     * the {@link PropertySet}'s {@link com.example.alldocument.library.fc.hpsf.Section}s list and then
     * getting the {@link com.example.alldocument.library.fc.hpsf.Property} array from the first {@link
     * com.example.alldocument.library.fc.hpsf.Section}.</p>
     *
     * @return The properties of the only {@link com.example.alldocument.library.fc.hpsf.Section} of this
     * {@link PropertySet}.
     * @throws NoSingleSectionException if the {@link PropertySet} has
     * more or less than one {@link com.example.alldocument.library.fc.hpsf.Section}.
     */
     ...
     * @throws NoSingleSectionException if the {@link PropertySet} has
     * more than one {@link com.example.alldocument.library.fc.hpsf.Section}.
     */
     ...
     */
    public com.example.alldocument.library.fc.hpsf.Section getFirstSection()
    {
        if (getSectionCount() < 1)
            throw new MissingSectionException("Property set does not contain any sections.");
        return ((com.example.alldocument.library.fc.hpsf.Section) sections.get(0));
    }
     ...
     */
    public com.example.alldocument.library.fc.hpsf.Section getSingleSection()
    {
    ...
    public boolean equals(final Object o)
    {
        ...
        com.example.alldocument.library.fc.hpsf.ClassID classID1 = ps.getClassID();
