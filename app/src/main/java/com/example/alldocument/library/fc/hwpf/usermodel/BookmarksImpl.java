...
public class BookmarksImpl implements Bookmarks
{
    ...
    private com.example.alldocument.library.fc.hwpf.usermodel.POIBookmark getBookmark(final GenericPropertyNode first)
    {
        return new BookmarkImpl(first);
    }

    public com.example.alldocument.library.fc.hwpf.usermodel.POIBookmark getBookmark(int index)
    {
        final GenericPropertyNode first = bookmarksTables.getDescriptorFirst(index);
        return getBookmark(first);
    }

    public List<com.example.alldocument.library.fc.hwpf.usermodel.POIBookmark> getBookmarksAt(int startCp)
    {
        ...
        List<com.example.alldocument.library.fc.hwpf.usermodel.POIBookmark> result = new ArrayList<com.example.alldocument.library.fc.hwpf.usermodel.POIBookmark>(nodes.size());
    ...
    public Map<Integer, List<com.example.alldocument.library.fc.hwpf.usermodel.POIBookmark>> getBookmarksStartedBetween(int startInclusive,
                                                                                                          int endExclusive)
    {
        updateSortedDescriptors();
        ...
        Map<Integer, List<com.example.alldocument.library.fc.hwpf.usermodel.POIBookmark>> result = new LinkedHashMap<Integer, List<com.example.alldocument.library.fc.hwpf.usermodel.POIBookmark>>();
        for (int lookupIndex = startLookupIndex; lookupIndex < endLookupIndex; lookupIndex++)
        {
            ...
            List<com.example.alldocument.library.fc.hwpf.usermodel.POIBookmark> startedAt = getBookmarksAt(s);
            if (startedAt != null)
