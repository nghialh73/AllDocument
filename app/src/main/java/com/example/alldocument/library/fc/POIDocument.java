...
import com.example.alldocument.library.fc.util.POIUtils;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(com.example.alldocument.library.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(com.example.alldocument.library.fc.hpsf.WritingNotSupportedException wnse)
        {
