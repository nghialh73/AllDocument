...
public class FileItemAdapter extends BaseAdapter
{
     ...
     * @param it
     */
    public void addItem(com.example.alldocument.library.officereader.filelist.FileItem it)
    {
        mItems.add(it);
    }
     ...
     * @param lit
     */
    public void setListItems(List<com.example.alldocument.library.officereader.filelist.FileItem> fileItem)
    {
        mItems = fileItem;
    }
    ...
    {
        com.example.alldocument.library.officereader.filelist.FileItem fileItem = mItems.get(position);
        if (fileItem == null)
        {
            return null;
        }
        ...
        {
            convertView = new com.example.alldocument.library.officereader.filelist.FileItemView(control.getActivity().getApplicationContext(), control, this, fileItem);
        }
        else
        {
    ...
    public void dispose()
    {
        ...
        if (mItems != null)
        {
            for (com.example.alldocument.library.officereader.filelist.FileItem item : mItems)
            {
                item.dispose();
            }
            mItems.clear();
