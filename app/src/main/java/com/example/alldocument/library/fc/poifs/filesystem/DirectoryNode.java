...
import com.example.alldocument.library.fc.poifs.filesystem.Entry;
import com.example.alldocument.library.fc.poifs.filesystem.EntryNode;
import com.example.alldocument.library.fc.poifs.filesystem.NPOIFSDocument;
import com.example.alldocument.library.fc.poifs.filesystem.NPOIFSFileSystem;
import com.example.alldocument.library.fc.poifs.filesystem.POIFSDocument;
import com.example.alldocument.library.fc.poifs.filesystem.POIFSDocumentPath;
...
import com.example.alldocument.library.fc.poifs.property.DocumentProperty;
...
public class DirectoryNode
    extends com.example.alldocument.library.fc.poifs.filesystem.EntryNode
    implements DirectoryEntry, Iterable<com.example.alldocument.library.fc.poifs.filesystem.Entry>
{

    // Map of Entry instances, keyed by their names
    private Map<String, com.example.alldocument.library.fc.poifs.filesystem.Entry> _byname;
    // Our list of entries, kept sorted to preserve order
    private ArrayList<com.example.alldocument.library.fc.poifs.filesystem.Entry> _entries;
   ...
   // Only one of these two will exist
                          ...
                          final NPOIFSFileSystem nfilesystem)
    {
        ...
        _byname     = new HashMap<String, com.example.alldocument.library.fc.poifs.filesystem.Entry>();
        _entries    = new ArrayList<com.example.alldocument.library.fc.poifs.filesystem.Entry>();
        Iterator<Property> iter = property.getChildren();

        while (iter.hasNext())
        {
            Property child     = iter.next();
            com.example.alldocument.library.fc.poifs.filesystem.Entry childNode = null;
            ...
            {
                childNode = new com.example.alldocument.library.fc.poifs.filesystem.DocumentNode((DocumentProperty) child, this);
            }
     ...
     */
    public DocumentInputStream createDocumentInputStream(
            final com.example.alldocument.library.fc.poifs.filesystem.Entry document)
        throws IOException
    {
        ...
        throws IOException
    {
        ...
        com.example.alldocument.library.fc.poifs.filesystem.DocumentNode rval     = new com.example.alldocument.library.fc.poifs.filesystem.DocumentNode(property, this);
    ...
    {
        DocumentProperty property = document.getDocumentProperty();
        com.example.alldocument.library.fc.poifs.filesystem.DocumentNode rval     = new DocumentNode(property, this);
    ...
    {
        boolean   rval  = false;
        com.example.alldocument.library.fc.poifs.filesystem.EntryNode child = (com.example.alldocument.library.fc.poifs.filesystem.EntryNode) _byname.get(oldName);
    ...
    public Iterator<com.example.alldocument.library.fc.poifs.filesystem.Entry> getEntries()
    {
    ...
    public com.example.alldocument.library.fc.poifs.filesystem.Entry getEntry(final String name)
        throws FileNotFoundException
    {
        com.example.alldocument.library.fc.poifs.filesystem.Entry rval = null;
    ...
    public Iterator getViewableIterator()
    {
        ...
        Iterator<com.example.alldocument.library.fc.poifs.filesystem.Entry> iter = _entries.iterator();
        while (iter.hasNext())
        {
