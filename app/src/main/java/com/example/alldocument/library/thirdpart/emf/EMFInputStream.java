...
import com.example.alldocument.library.thirdpart.emf.EMFTagSet;
...
import com.example.alldocument.library.thirdpart.emf.io.TaggedInputStream;
...
public class EMFInputStream extends TaggedInputStream implements EMFConstants
{
    ...
    {
        this(is, new com.example.alldocument.library.thirdpart.emf.EMFTagSet(version));
    }
    ...
    private com.example.alldocument.library.thirdpart.emf.EMFHeader header;

    public com.example.alldocument.library.thirdpart.emf.EMFHeader readHeader() throws IOException
    {
        if (header == null)
        {
