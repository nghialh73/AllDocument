...
import com.example.alldocument.library.thirdpart.emf.font.TTFVersionTable;
        ...
        public void read() throws IOException
        {
            ...
            for (int i = 0; i < numberOfPoints; i++)
            {
                ...
                else
                {
                    ...
                    if (com.example.alldocument.library.thirdpart.emf.font.TTFInput.flagBit(flags[i], REPEAT_FLAG))
                    {
                        repeatCount = ttf.readByte();
                        repeatFlag = flags[i];
                    }
                }
                com.example.alldocument.library.thirdpart.emf.font.TTFInput.checkZeroBit(flags[i], 6, "flags");
                com.example.alldocument.library.thirdpart.emf.font.TTFInput.checkZeroBit(flags[i], 7, "flags");
                onCurve[i] = com.example.alldocument.library.thirdpart.emf.font.TTFInput.flagBit(flags[i], ON_CURVE);
            }

            int last = 0;
            for (int i = 0; i < numberOfPoints; i++)
            {
                if (com.example.alldocument.library.thirdpart.emf.font.TTFInput.flagBit(flags[i], X_SHORT))
                {
                    if (com.example.alldocument.library.thirdpart.emf.font.TTFInput.flagBit(flags[i], X_POSITIVE))
                    {
                ...
                {
                    if (com.example.alldocument.library.thirdpart.emf.font.TTFInput.flagBit(flags[i], X_SAME))
                    {
            ...
            for (int i = 0; i < numberOfPoints; i++)
            {
                if (com.example.alldocument.library.thirdpart.emf.font.TTFInput.flagBit(flags[i], Y_SHORT))
                {
                    if (com.example.alldocument.library.thirdpart.emf.font.TTFInput.flagBit(flags[i], Y_POSITIVE))
                    {
