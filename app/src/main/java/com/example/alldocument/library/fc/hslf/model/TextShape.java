...
import com.example.alldocument.library.fc.hslf.record.EscherTextboxWrapper;
...
public abstract class TextShape extends SimpleShape
{
     ...
     */
    protected com.example.alldocument.library.fc.hslf.model.TextRun _txtrun;
     ...
     */
    protected TextShape(EscherContainerRecord escherRecord, com.example.alldocument.library.fc.hslf.model.Shape parent)
    {
    ...
    public com.example.alldocument.library.fc.hslf.model.TextRun createTextRun()
    {
        ...
        if (_txtrun == null)
        {
            ...
            _txtrun = new com.example.alldocument.library.fc.hslf.model.TextRun(tha, tca, sta);
     ...
     *
     */
    protected void setDefaultTextProperties(com.example.alldocument.library.fc.hslf.model.TextRun _txtrun)
    {
    ...
    {
        com.example.alldocument.library.fc.hslf.model.TextRun tx = getTextRun();
     ...
     */
    protected void afterInsert(com.example.alldocument.library.fc.hslf.model.Sheet sh)
    {
    ...
    */
    ...
    /**
      ...
      */
    public com.example.alldocument.library.fc.hslf.model.TextRun getTextRun()
    {
        if (_txtrun == null)
            initTextRun();
        return _txtrun;
    ...
    public void setSheet(com.example.alldocument.library.fc.hslf.model.Sheet sheet)
    {
        _sheet = sheet;
    ...
    protected void initTextRun()
    {
        ...
        com.example.alldocument.library.fc.hslf.model.Sheet sheet = getSheet();
     ...
     * @see com.example.alldocument.library.fc.hslf.usermodel.SlideShow#addHyperlink(Hyperlink)
     */
