...
import com.example.alldocument.library.common.autoshape.AutoShapeKit;
...
import com.example.alldocument.library.wp.view.PositionLayoutKit;
import com.example.alldocument.library.wp.view.WPSTRoot;
...
public class ShapeView extends LeafView
{
    ...
    public ShapeView(IElement paraElem, IElement elem, AutoShape shape)
    {
        ...
        roots = new Hashtable<Integer, com.example.alldocument.library.wp.view.WPSTRoot>();
    }
    ...
    private void layoutTextbox(WPAutoShape wpShape, WPGroupShape wpGroup)
    {
        ...
        {
            com.example.alldocument.library.wp.view.WPSTRoot stRoot = new com.example.alldocument.library.wp.view.WPSTRoot(getContainer(), getDocument(), wpShape.getElementIndex());
    ...
    {   
        if (isInline)
        {
            ...
            {
                com.example.alldocument.library.wp.view.WPSTRoot root = roots.get(wpShape.getElementIndex());
                if (root != null)
                {
                	canvas.save();
            ...
            if (shapes != null)
            {
                ...
                for (IShape shape : shapes)
                {
                    ...
                    else if (shape.getType() == AbstractShape.SHAPE_AUTOSHAPE)
                    {
                        ...
                        {
                            com.example.alldocument.library.wp.view.WPSTRoot root = roots.get(txShape.getElementIndex());
                            if (root != null)
                            {
    ...
    public void dispose()
    {
        ...
        if (roots != null)
        {
            ...
            {
                com.example.alldocument.library.wp.view.WPSTRoot root = roots.get(key);
                if (root != null)
                {
                    root.dispose();
                }
