...
public enum FontUnderline {
    ...
    public byte getByteValue() {
        switch (this) {
            case DOUBLE:
                return com.example.alldocument.library.fc.ss.usermodel.IFont.U_DOUBLE;
            case DOUBLE_ACCOUNTING:
                return com.example.alldocument.library.fc.ss.usermodel.IFont.U_DOUBLE_ACCOUNTING;
            case SINGLE_ACCOUNTING:
                return com.example.alldocument.library.fc.ss.usermodel.IFont.U_SINGLE_ACCOUNTING;
            case NONE:
                return com.example.alldocument.library.fc.ss.usermodel.IFont.U_NONE;
            case SINGLE:
                return com.example.alldocument.library.fc.ss.usermodel.IFont.U_SINGLE;
            default:
                return com.example.alldocument.library.fc.ss.usermodel.IFont.U_SINGLE;
        }
    }
    ...
    public static FontUnderline valueOf(byte value){
        FontUnderline val;
        switch (value) {
            case com.example.alldocument.library.fc.ss.usermodel.IFont.U_DOUBLE:
                val = FontUnderline.DOUBLE;
                break;
            case com.example.alldocument.library.fc.ss.usermodel.IFont.U_DOUBLE_ACCOUNTING:
                val = FontUnderline.DOUBLE_ACCOUNTING;
                break;
            case com.example.alldocument.library.fc.ss.usermodel.IFont.U_SINGLE_ACCOUNTING:
