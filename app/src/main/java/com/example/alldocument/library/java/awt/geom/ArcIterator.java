...
class ArcIterator implements PathIterator
{
    ...
    ArcIterator(com.example.alldocument.library.java.awt.geom.Arc2D a, AffineTransform at)
    {
        this.w = a.getWidth() / 2;
        ...
        switch (a.getArcType())
        {
            case com.example.alldocument.library.java.awt.geom.Arc2D.OPEN:
                lineSegs = 0;
                break;
            case com.example.alldocument.library.java.awt.geom.Arc2D.CHORD:
                lineSegs = 1;
                break;
            case Arc2D.PIE:
                lineSegs = 2;
