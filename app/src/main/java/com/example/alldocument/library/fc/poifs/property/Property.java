...
import com.example.alldocument.library.fc.poifs.property.Child;
import com.example.alldocument.library.fc.poifs.property.PropertyConstants;
import com.example.alldocument.library.fc.util.ByteField;
import com.example.alldocument.library.fc.util.IntegerField;
import com.example.alldocument.library.fc.util.LittleEndianConsts;
import com.example.alldocument.library.fc.util.ShortField;
...
public abstract class Property implements com.example.alldocument.library.fc.poifs.property.Child
{
    ...
    private int _index;
    private com.example.alldocument.library.fc.poifs.property.Child _next_child;
    private com.example.alldocument.library.fc.poifs.property.Child _previous_child;
     ...
     */
    public com.example.alldocument.library.fc.poifs.property.Child getNextChild()
    {
        return _next_child;
    }
     ...
     */
    public com.example.alldocument.library.fc.poifs.property.Child getPreviousChild()
    {
     ...
     */
    public void setNextChild(com.example.alldocument.library.fc.poifs.property.Child child)
    {
        _next_child = child;
