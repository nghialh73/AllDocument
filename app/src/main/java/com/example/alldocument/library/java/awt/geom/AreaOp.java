...
import com.example.alldocument.library.java.awt.geom.ChainEnd;
import com.example.alldocument.library.java.awt.geom.Curve;
import com.example.alldocument.library.java.awt.geom.CurveLink;
import com.example.alldocument.library.java.awt.geom.Edge;
...
public abstract class AreaOp {
    public static abstract class CAGOp extends AreaOp {
        ...
        public int classify(com.example.alldocument.library.java.awt.geom.Edge e) {
    ...
    public abstract int classify(com.example.alldocument.library.java.awt.geom.Edge e);
    ...
    public Vector calculate(Vector left, Vector right) {
        ...
        if (false) {
            ...
            com.example.alldocument.library.java.awt.geom.Curve[] curvelist = (com.example.alldocument.library.java.awt.geom.Curve[]) edges.toArray(new com.example.alldocument.library.java.awt.geom.Curve[numcurves]);
    ...
    private static void addEdges(Vector edges, Vector curves, int curvetag) {
        ...
        while (enum_.hasMoreElements()) {
            com.example.alldocument.library.java.awt.geom.Curve c = (com.example.alldocument.library.java.awt.geom.Curve) enum_.nextElement();
            if (c.getOrder() > 0) {
                edges.add(new com.example.alldocument.library.java.awt.geom.Edge(c, curvetag));
            }
        }
    }
    ...
    private static Comparator YXTopComparator = new Comparator() {
        public int compare(Object o1, Object o2) {
            com.example.alldocument.library.java.awt.geom.Curve c1 = ((com.example.alldocument.library.java.awt.geom.Edge) o1).getCurve();
            Curve c2 = ((com.example.alldocument.library.java.awt.geom.Edge) o2).getCurve();
            double v1, v2;
    ...
    private Vector pruneEdges(Vector edges) {
        ...
        com.example.alldocument.library.java.awt.geom.Edge[] edgelist = (com.example.alldocument.library.java.awt.geom.Edge[]) edges.toArray(new com.example.alldocument.library.java.awt.geom.Edge[numedges]);
        ...
        com.example.alldocument.library.java.awt.geom.Edge e;
        int left = 0;
        int right = 0;
        int cur = 0;
        int next = 0;
        ...
        while (left < numedges) {
            ...
            for (cur = left; cur < right; cur++) {
                ...
                for (next = cur; next > left; next--) {
                    com.example.alldocument.library.java.awt.geom.Edge prevedge = edgelist[next-1];
            ...
            for (cur = left; cur < right; cur++) {
                ...
                if (eq != 0) {
                    ...
                    etag = (origstate == AreaOp.RSTAG_INSIDE
                            ? AreaOp.ETAG_EXIT
                            : AreaOp.ETAG_ENTER);
                    com.example.alldocument.library.java.awt.geom.Edge activematch = null;
                    com.example.alldocument.library.java.awt.geom.Edge longestmatch = e;
