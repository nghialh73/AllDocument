...
import com.example.alldocument.library.fc.ss.format.CellDateFormatter;
import com.example.alldocument.library.fc.ss.format.CellElapsedFormatter;
import com.example.alldocument.library.fc.ss.format.CellFormatter;
import com.example.alldocument.library.fc.ss.format.CellGeneralFormatter;
import com.example.alldocument.library.fc.ss.format.CellNumberFormatter;
...
public enum CellFormatType {
    ...
    GENERAL {
        com.example.alldocument.library.fc.ss.format.CellFormatter formatter(String pattern) {
