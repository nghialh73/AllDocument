 ...
 * 时间:              下午1:55:20
 */
package com.example.alldocument.library.ss.model.XLSModel;
...
import com.example.alldocument.library.common.borders.Line;
import com.example.alldocument.library.common.hyperlink.Hyperlink;
import com.example.alldocument.library.common.picture.Picture;
import com.example.alldocument.library.common.pictureefftect.PictureEffectInfoFactory;
import com.example.alldocument.library.common.shape.AChart;
...
import com.example.alldocument.library.constant.SSConstant;
...
import com.example.alldocument.library.fc.hssf.record.DefaultRowHeightRecord;
...
import com.example.alldocument.library.fc.hssf.usermodel.HSSFChildAnchor;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFClientAnchor;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFFreeform;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFLine;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFPatriarch;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFPicture;
...
import com.example.alldocument.library.fc.xls.ChartConverter;
import com.example.alldocument.library.java.awt.Rectangle;
import com.example.alldocument.library.ss.model.CellRangeAddress;
import com.example.alldocument.library.ss.model.XLSModel.ACell;
import com.example.alldocument.library.ss.model.XLSModel.ARow;
...
import com.example.alldocument.library.ss.model.baseModel.Row;
import com.example.alldocument.library.ss.model.baseModel.Sheet;
import com.example.alldocument.library.ss.model.baseModel.Workbook;
import com.example.alldocument.library.ss.model.drawing.AnchorPoint;
import com.example.alldocument.library.ss.model.drawing.CellAnchor;
import com.example.alldocument.library.ss.model.sheetProperty.PaneInformation;
import com.example.alldocument.library.ss.util.ModelUtil;
import com.example.alldocument.library.ss.util.SectionElementFactory;
...
import com.example.alldocument.library.thirdpart.achartengine.chart.RoundChart;
import com.example.alldocument.library.thirdpart.achartengine.chart.XYChart;
import com.example.alldocument.library.thirdpart.achartengine.renderers.DefaultRenderer;
 ...
 * <p>
 */
public class ASheet extends Sheet implements com.example.alldocument.library.fc.ss.usermodel.Sheet
{
    ...
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<com.example.alldocument.library.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<com.example.alldocument.library.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                com.example.alldocument.library.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                com.example.alldocument.library.ss.model.sheetProperty.ColumnInfo columnInfo = new com.example.alldocument.library.ss.model.sheetProperty.ColumnInfo(
            ...
            for (Iterator<RecordBase> it = sheet.getRecords().iterator(); it.hasNext(); ) 
            {
                ...
                if (rec instanceof HyperlinkRecord)
                {
                    ...
                    if(row == null)
                    {
                        ...
                        row = new com.example.alldocument.library.ss.model.XLSModel.ARow(book, this, rowRec);
                    ...
                    if(cell == null)
                    {
                        ...
                        cell = new com.example.alldocument.library.ss.model.XLSModel.ACell(this, brec);
    ...
    private void processRowsAndCells(InternalSheet sheet, AbstractReader iAbortListener)
    {
        ...
        com.example.alldocument.library.ss.model.XLSModel.ARow lastrow = null;
        ...
        while (iter.hasNext())
        {
            ...
            com.example.alldocument.library.ss.model.XLSModel.ARow hrow = lastrow;
            if (hrow == null || hrow.getRowNumber() != cval.getRow())
            {
                ...
                hrow = (com.example.alldocument.library.ss.model.XLSModel.ARow)getRow(cval.getRow());
                lastrow = hrow;
                if (hrow == null)
                {
...
//                    sheet.addRow(rowRec);
     ...
     * @return
     */
    private com.example.alldocument.library.ss.model.XLSModel.ARow createValidateRowFromRecord(RowRecord rowRec)
    {
        Row row = getRow(rowRec.getRowNumber());
        if( row != null)
        {
            return (com.example.alldocument.library.ss.model.XLSModel.ARow)row;
        }
        
        if(isValidateRow(rowRec))
        {
            com.example.alldocument.library.ss.model.XLSModel.ARow hrow = new com.example.alldocument.library.ss.model.XLSModel.ARow(book, this, rowRec);
     ...
     */
    private com.example.alldocument.library.ss.model.XLSModel.ARow createRowFromRecord(RowRecord rowRec)
    {
        Row row = getRow(rowRec.getRowNumber());
        if( row != null)
        {
