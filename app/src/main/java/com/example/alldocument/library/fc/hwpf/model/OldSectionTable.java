...
public final class OldSectionTable extends SectionTable
{
    ...
    {
        com.example.alldocument.library.fc.hwpf.model.PlexOfCps sedPlex = new PlexOfCps(documentStream, offset, size, 12);
        ...
        for (int x = 0; x < length; x++)
        {
            ...
            com.example.alldocument.library.fc.hwpf.model.SEPX sepx;
            // check for the optimization
            if (fileOffset == 0xffffffff)
            {
                sepx = new com.example.alldocument.library.fc.hwpf.model.SEPX(sed, startAt, endAt, new byte[0]);
            }
            else
            {
