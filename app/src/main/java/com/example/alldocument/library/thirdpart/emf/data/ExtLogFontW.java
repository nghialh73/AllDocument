...
import com.example.alldocument.library.thirdpart.emf.data.Panose;
...
public class ExtLogFontW implements EMFConstants, GDIObject
{
    ...
    private com.example.alldocument.library.thirdpart.emf.data.LogFontW font;
    ...
    private com.example.alldocument.library.thirdpart.emf.data.Panose panose;

    public ExtLogFontW(com.example.alldocument.library.thirdpart.emf.data.LogFontW font, String fullName, String style, int version, int styleSize,
                       int match, byte[] vendorID, int culture, com.example.alldocument.library.thirdpart.emf.data.Panose panose)
    {
        this.font = font;
    ...
    {
        this.font = new com.example.alldocument.library.thirdpart.emf.data.LogFontW(font);
        this.fullName = "";
        this.style = "";
        this.version = 0;
        this.styleSize = 0;
        ...
        this.culture = 0;
        this.panose = new com.example.alldocument.library.thirdpart.emf.data.Panose();
    }
