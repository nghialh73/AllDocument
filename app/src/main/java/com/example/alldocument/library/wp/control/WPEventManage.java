...
{    
     ...
     * @param spreadsheet
     */
    public WPEventManage(com.example.alldocument.library.wp.control.Word word, IControl control)
    {
    ...
    public void fling(int velocityX, int velocityY)
    {
        ...
        Rectangle r = ((com.example.alldocument.library.wp.control.Word)word).getVisibleRect();
        float zoom = word.getZoom();
        // Y方向滚动
        oldY = 0;
        oldX = 0;
