...
import com.example.alldocument.library.wp.view.EncloseCharacterView;
            ...
            case WPViewConstant.LEAF_VIEW:
                ...
                if (AttrManage.instance().hasAttribute(elem.getAttribute(), AttrIDConstant.FONT_SHAPE_ID))
                {
                    ...
                    if (shape != null)
                    {
                        ...
                        {
                            view = new com.example.alldocument.library.wp.view.ObjView(paraElem, elem, (com.example.alldocument.library.common.shape.WPAutoShape)shape);
                        }
                    }
                    else
                    {
