...
import com.example.alldocument.library.fc.hssf.model.ComboboxShape;
...
import com.example.alldocument.library.fc.hssf.model.LineShape;
import com.example.alldocument.library.fc.hssf.model.PictureShape;
import com.example.alldocument.library.fc.hssf.model.PolygonShape;
import com.example.alldocument.library.fc.hssf.model.SimpleFilledShape;
...
public abstract class AbstractShape
{
    ...
    public static AbstractShape createShape( HSSFShape hssfShape, int shapeId )
    {
        ...
        {
            shape = new com.example.alldocument.library.fc.hssf.model.CommentShape( (HSSFComment)hssfShape, shapeId );
        }
