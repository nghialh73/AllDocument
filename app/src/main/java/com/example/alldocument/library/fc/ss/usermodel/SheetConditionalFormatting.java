...
package com.example.alldocument.library.fc.ss.usermodel;

import com.example.alldocument.library.fc.ss.usermodel.ComparisonOperator;
...
public interface SheetConditionalFormatting {
    ...
    int addConditionalFormatting(HSSFCellRangeAddress[] regions,
                                 com.example.alldocument.library.fc.ss.usermodel.ConditionalFormattingRule rule);
     ...
     */
    int addConditionalFormatting(HSSFCellRangeAddress[] regions,
                                 com.example.alldocument.library.fc.ss.usermodel.ConditionalFormattingRule rule1,
                                 com.example.alldocument.library.fc.ss.usermodel.ConditionalFormattingRule rule2);
     ...
     * @return index of the newly created Conditional Formatting object
     */
    int addConditionalFormatting(HSSFCellRangeAddress[] regions, com.example.alldocument.library.fc.ss.usermodel.ConditionalFormattingRule[] cfRules);
     ...
     */
    int addConditionalFormatting(com.example.alldocument.library.fc.ss.usermodel.ConditionalFormatting cf);
     ...
     * The type  of the created condition is {@link com.example.alldocument.library.fc.ss.usermodel.ConditionalFormattingRule#CONDITION_TYPE_CELL_VALUE_IS}
     * </p>
     *
     * @param comparisonOperation - MUST be a constant value from
     *		 <tt>{@link com.example.alldocument.library.fc.ss.usermodel.ComparisonOperator}</tt>: <p>
     * <ul>
     *		 <li>BETWEEN</li>
     *		 <li>NOT_BETWEEN</li>
     *		 <li>EQUAL</li>
     ...
     * {@link com.example.alldocument.library.fc.ss.usermodel.ComparisonOperator#BETWEEN}) and {@link com.example.alldocument.library.fc.ss.usermodel.ComparisonOperator#NOT_BETWEEN} operations)
     */
    com.example.alldocument.library.fc.ss.usermodel.ConditionalFormattingRule createConditionalFormattingRule(
     ...
     *
     * <p>
     *  The type of the created format condition is  {@link com.example.alldocument.library.fc.ss.usermodel.ConditionalFormattingRule#CONDITION_TYPE_FORMULA}
     * </p>
