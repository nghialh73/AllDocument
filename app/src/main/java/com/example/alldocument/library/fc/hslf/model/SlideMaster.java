...
import com.example.alldocument.library.fc.hslf.model.textproperties.TextPropCollection;
 ...
 * @author Yegor Kozlov
 */
public final class SlideMaster extends com.example.alldocument.library.fc.hslf.model.MasterSheet
{
     ...
     */
    public com.example.alldocument.library.fc.hslf.model.TextRun[] getTextRuns()
    {
        return _runs;
    }
    ...
    {
        com.example.alldocument.library.fc.hslf.model.TextRun run = shape.getTextRun();

        if (_runs == null)
            _runs = new com.example.alldocument.library.fc.hslf.model.TextRun[]{run};
        else
        {
            com.example.alldocument.library.fc.hslf.model.TextRun[] tmp = new com.example.alldocument.library.fc.hslf.model.TextRun[_runs.length + 1];
    ...
    public void dispose()
    {
        ...
        if (_runs != null)
        {
            for (com.example.alldocument.library.fc.hslf.model.TextRun tr : _runs)
            {
                tr.dispose();
            }
            _runs = null;
