...
import com.example.alldocument.library.java.awt.Image;
import com.example.alldocument.library.java.awt.Shape;
import com.example.alldocument.library.java.awt.Stroke;
import com.example.alldocument.library.java.awt.geom.AffineTransform;
import com.example.alldocument.library.java.awt.geom.Area;
import com.example.alldocument.library.java.awt.geom.GeneralPath;
import com.example.alldocument.library.java.awt.geom.IllegalPathStateException;
...
import com.example.alldocument.library.thirdpart.emf.EMFHeader;
...
import com.example.alldocument.library.thirdpart.emf.data.BasicStroke;
...
{
    private static final Logger logger = Logger.getLogger("com.example.alldocument.library.thirdpart.emf");
...
//        initialClip = g2.getClip();
        ...
        {
            tag = (Tag)tags.get(i);
            if (tag instanceof com.example.alldocument.library.thirdpart.emf.EMFTag)
            {
