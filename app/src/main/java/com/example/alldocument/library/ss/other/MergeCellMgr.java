 ...
 * 时间:              上午10:51:22
 */
package com.example.alldocument.library.ss.other;
...
public class MergeCellMgr
{
     ...
     * @return
     */
    public com.example.alldocument.library.ss.other.MergeCell getMergedCellSize(SheetView sheetView, CellRangeAddress cellRangeAddress, int row, int col)
    {
    ...
    private com.example.alldocument.library.ss.other.MergeCell mergedCell = new MergeCell();
}
