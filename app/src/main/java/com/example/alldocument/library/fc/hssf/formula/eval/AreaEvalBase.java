...
public abstract class AreaEvalBase implements AreaEval {
	...
	public final com.example.alldocument.library.fc.hssf.formula.eval.ValueEval getAbsoluteValue(int row, int col) {
	...
	public final com.example.alldocument.library.fc.hssf.formula.eval.ValueEval getValue(int row, int col) {
