...
public final class NDocumentInputStream extends DocumentInputStream {
   ...
   private int _marked_offset_count;
	...
	/** the actual Document */
	private com.example.alldocument.library.fc.poifs.filesystem.NPOIFSDocument _document;
	...
	public NDocumentInputStream(DocumentEntry document) throws IOException {
      ...
      com.example.alldocument.library.fc.poifs.filesystem.DocumentNode doc = (DocumentNode)document;
		DocumentProperty property = (DocumentProperty)doc.getProperty();
		_document = new com.example.alldocument.library.fc.poifs.filesystem.NPOIFSDocument(
		      property, 
