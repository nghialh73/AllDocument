...
package com.example.alldocument.library.fc.hssf.eventusermodel;

import java.io.IOException;
import java.io.InputStream;

import com.example.alldocument.library.fc.hssf.eventusermodel.HSSFRequest;
import com.example.alldocument.library.fc.hssf.eventusermodel.HSSFUserException;
import com.example.alldocument.library.fc.hssf.record.Record;
import com.example.alldocument.library.fc.hssf.record.RecordFactoryInputStream;
...
public class HSSFEventFactory {
	 ...
	 */
	public void processWorkbookEvents(com.example.alldocument.library.fc.hssf.eventusermodel.HSSFRequest req, POIFSFileSystem fs) throws IOException {
    ...
    */
   public void processWorkbookEvents(com.example.alldocument.library.fc.hssf.eventusermodel.HSSFRequest req, DirectoryNode dir) throws IOException {
    ...
    */
   public short abortableProcessWorkbookEvents(com.example.alldocument.library.fc.hssf.eventusermodel.HSSFRequest req, POIFSFileSystem fs)
	 ...
	 * @return    numeric user-specified result code.
	 */
	public short abortableProcessWorkbookEvents(com.example.alldocument.library.fc.hssf.eventusermodel.HSSFRequest req, DirectoryNode dir)
		throws IOException, HSSFUserException {
		InputStream in = dir.createDocumentInputStream("Workbook");
	 ...
	 */
	public void processEvents(com.example.alldocument.library.fc.hssf.eventusermodel.HSSFRequest req, InputStream in) {
		try {
	 ...
	 * @return    numeric user-specified result code.
	 */
	public short abortableProcessEvents(com.example.alldocument.library.fc.hssf.eventusermodel.HSSFRequest req, InputStream in)
