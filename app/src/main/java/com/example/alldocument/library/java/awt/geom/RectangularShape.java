...
import com.example.alldocument.library.java.awt.geom.Dimension2D;
import com.example.alldocument.library.java.awt.geom.Ellipse2D;
...
import com.example.alldocument.library.java.awt.geom.RoundRectangle2D;
...
public abstract class RectangularShape implements Shape, Cloneable {
     ...
     * @see Arc2D
     * @see Ellipse2D
     * @see com.example.alldocument.library.java.awt.geom.Rectangle2D
    ...
    /**
     * Returns the framing {@link com.example.alldocument.library.java.awt.geom.Rectangle2D}
     * that defines the overall shape of this object.
     * @return a <code>Rectangle2D</code>, specified in
     * <code>double</code> coordinates.
     * @see #setFrame(double, double, double, double)
     * @see #setFrame(com.example.alldocument.library.java.awt.geom.Point2D, com.example.alldocument.library.java.awt.geom.Dimension2D)
     * @see #setFrame(com.example.alldocument.library.java.awt.geom.Rectangle2D)
     * @since 1.2
     */
    public com.example.alldocument.library.java.awt.geom.Rectangle2D getFrame() {
	return new com.example.alldocument.library.java.awt.geom.Rectangle2D.Double(getX(), getY(), getWidth(), getHeight());
    }
    ...
    /**
     * Sets the location and size of the framing rectangle of this 
     * <code>Shape</code> to the specified {@link com.example.alldocument.library.java.awt.geom.Point2D} and
     * {@link com.example.alldocument.library.java.awt.geom.Dimension2D}, respectively.  The framing rectangle is used
     ...
     * @since 1.2
     */
    public void setFrame(com.example.alldocument.library.java.awt.geom.Point2D loc, Dimension2D size) {
     ...
     * @since 1.2
     */
    public void setFrame(com.example.alldocument.library.java.awt.geom.Rectangle2D r) {
     ...
     * @since 1.2
     */
    public void setFrameFromDiagonal(com.example.alldocument.library.java.awt.geom.Point2D p1, com.example.alldocument.library.java.awt.geom.Point2D p2) {
     ...
     * @since 1.2
     */
    public void setFrameFromCenter(com.example.alldocument.library.java.awt.geom.Point2D center, com.example.alldocument.library.java.awt.geom.Point2D corner) {
     ...
     * An optional {@link com.example.alldocument.library.java.awt.geom.AffineTransform} can
