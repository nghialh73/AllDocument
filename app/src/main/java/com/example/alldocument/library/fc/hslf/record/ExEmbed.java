...
import com.example.alldocument.library.fc.hslf.record.RecordAtom;
...
public class ExEmbed extends RecordContainer
{
    ...
    public ExEmbed()
    {
        ...
        com.example.alldocument.library.fc.hslf.record.CString cs1 = new com.example.alldocument.library.fc.hslf.record.CString();
        cs1.setOptions(0x1 << 4);
        com.example.alldocument.library.fc.hslf.record.CString cs2 = new com.example.alldocument.library.fc.hslf.record.CString();
        cs2.setOptions(0x2 << 4);
        com.example.alldocument.library.fc.hslf.record.CString cs3 = new com.example.alldocument.library.fc.hslf.record.CString();
    ...
    private void findInterestingChildren()
    {
        ...
        {
            if (_children[i] instanceof com.example.alldocument.library.fc.hslf.record.CString)
            {
    ...
    private com.example.alldocument.library.fc.hslf.record.CString menuName;
    private com.example.alldocument.library.fc.hslf.record.CString progId;
