...
import com.example.alldocument.library.thirdpart.emf.io.ActionHeader;
import com.example.alldocument.library.thirdpart.emf.io.ActionSet;
import com.example.alldocument.library.thirdpart.emf.io.ByteCountInputStream;
import com.example.alldocument.library.thirdpart.emf.io.IncompleteActionException;
import com.example.alldocument.library.thirdpart.emf.io.IncompleteTagException;
import com.example.alldocument.library.thirdpart.emf.io.Tag;
import com.example.alldocument.library.thirdpart.emf.io.TagHeader;
...
public abstract class TaggedInputStream extends ByteCountInputStream {
	 ...
	 */
	protected com.example.alldocument.library.thirdpart.emf.io.TagSet tagSet;

	/**
	 * Set of actions that can be used by this Stream
	 */
	protected com.example.alldocument.library.thirdpart.emf.io.ActionSet actionSet;

	/**
	 * Currently read tagHeader, valid during readTag call.
	 */
	private com.example.alldocument.library.thirdpart.emf.io.TagHeader tagHeader;
	 ...
	 */
	public TaggedInputStream(InputStream in, com.example.alldocument.library.thirdpart.emf.io.TagSet tagSet, com.example.alldocument.library.thirdpart.emf.io.ActionSet actionSet) {
	 ...
	 *             if read fails
	 */
	protected abstract com.example.alldocument.library.thirdpart.emf.io.TagHeader readTagHeader() throws IOException;
	 ...
	 *             if read fails
	 */
	public com.example.alldocument.library.thirdpart.emf.io.Tag readTag() throws IOException {
	 ...
	 *            new action
	 */
	public void addAction(com.example.alldocument.library.thirdpart.emf.io.Action action) {
	 ...
	 *             if read fails
	 */
	protected abstract com.example.alldocument.library.thirdpart.emf.io.ActionHeader readActionHeader() throws IOException;
	 ...
	 *             if read fails
	 */
	public com.example.alldocument.library.thirdpart.emf.io.Action readAction() throws IOException {
