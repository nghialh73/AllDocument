 ...
 */
public final class SmallDocumentBlock implements com.example.alldocument.library.fc.poifs.storage.BlockWritable, com.example.alldocument.library.fc.poifs.storage.ListManagedBlock {
    ...
    public static com.example.alldocument.library.fc.poifs.storage.DataInputBlock getDataInputBlock(SmallDocumentBlock[] blocks, int offset) {
