...
public final class Document extends PositionDependentRecordContainer
{
     ...
     * @return
     */
    public com.example.alldocument.library.fc.hslf.record.List getList()
    {
        return list;
    }
    ...
    protected Document(byte[] source, int start, int len)
    {
        ...
        for (int i = 1; i < _children.length; i++)
        {
            ...
            else if (_children[i] instanceof com.example.alldocument.library.fc.hslf.record.List)
            {
                list = (com.example.alldocument.library.fc.hslf.record.List)_children[i];
            }
        }
