...
public class HSSFCellRangeAddress extends CellRangeAddressBase {
    ...
    public String formatAsString(String sheetName, boolean useAbsoluteAddress) {
        ...
        com.example.alldocument.library.fc.ss.util.CellReference cellRefFrom = new com.example.alldocument.library.fc.ss.util.CellReference(getFirstRow(), getFirstColumn(),
                useAbsoluteAddress, useAbsoluteAddress);
        com.example.alldocument.library.fc.ss.util.CellReference cellRefTo = new com.example.alldocument.library.fc.ss.util.CellReference(getLastRow(), getLastColumn(),
                useAbsoluteAddress, useAbsoluteAddress);
    ...
    public static HSSFCellRangeAddress valueOf(String ref) {
        int sep = ref.indexOf(":");
        com.example.alldocument.library.fc.ss.util.CellReference a;
        com.example.alldocument.library.fc.ss.util.CellReference b;
        if (sep == -1) {
            a = new com.example.alldocument.library.fc.ss.util.CellReference(ref);
            b = a;
        } else {
            a = new com.example.alldocument.library.fc.ss.util.CellReference(ref.substring(0, sep));
