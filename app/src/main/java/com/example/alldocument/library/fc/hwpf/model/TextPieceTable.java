...
import com.example.alldocument.library.fc.hwpf.model.PieceDescriptor;
...
public class TextPieceTable implements CharIndexTranslator
{
    ...
    // int _multiple;
    int _cpMin;
    protected ArrayList<com.example.alldocument.library.fc.hwpf.model.TextPiece> _textPieces = new ArrayList<com.example.alldocument.library.fc.hwpf.model.TextPiece>();
    protected ArrayList<com.example.alldocument.library.fc.hwpf.model.TextPiece> _textPiecesFCOrder = new ArrayList<com.example.alldocument.library.fc.hwpf.model.TextPiece>();
            ...
            int offset, int size, int fcMin )
    {
        ...
        com.example.alldocument.library.fc.hwpf.model.PlexOfCps pieceTable = new com.example.alldocument.library.fc.hwpf.model.PlexOfCps( tableStream, offset, size,
        ...
        for ( int x = 0; x < pieces.length; x++ )
        {
            ...
            _textPieces.add( new com.example.alldocument.library.fc.hwpf.model.TextPiece( nodeStartChars, nodeEndChars, documentStream, start, textSizeBytes,
                    pieces[x] ) );
        }
        ...
        _textPiecesFCOrder = new ArrayList<com.example.alldocument.library.fc.hwpf.model.TextPiece>( _textPieces );
        Collections.sort( _textPiecesFCOrder, new FCComparator() );
    }

    public void add( com.example.alldocument.library.fc.hwpf.model.TextPiece piece )
    {
    ...
    public int adjustForInsert( int listIndex, int length )
    {
        ...
        com.example.alldocument.library.fc.hwpf.model.TextPiece tp = _textPieces.get( listIndex );
    ...
    {
        int byteCount = 0;
        for ( com.example.alldocument.library.fc.hwpf.model.TextPiece tp : _textPieces )
        {
    ...
    public StringBuilder getText()
    {
        ...
        for ( com.example.alldocument.library.fc.hwpf.model.TextPiece textPiece : _textPieces )
        {
    ...
    public List<com.example.alldocument.library.fc.hwpf.model.TextPiece> getTextPieces()
    {
        return _textPieces;
    }
    ...
    {
        for ( com.example.alldocument.library.fc.hwpf.model.TextPiece tp : _textPiecesFCOrder )
        {
            int pieceStart = tp.getPieceDescriptor().getFilePosition();
    ...
    {
        com.example.alldocument.library.fc.hwpf.model.PlexOfCps textPlex = new PlexOfCps( PieceDescriptor.getSizeInBytes() );
        // int fcMin = docStream.getOffset();

        int size = _textPieces.size();
        for ( int x = 0; x < size; x++ )
        {
            com.example.alldocument.library.fc.hwpf.model.TextPiece next = _textPieces.get( x );
    ...
    private static class FCComparator implements Comparator<com.example.alldocument.library.fc.hwpf.model.TextPiece>
    {
        public int compare(com.example.alldocument.library.fc.hwpf.model.TextPiece textPiece, TextPiece textPiece1 )
        {
