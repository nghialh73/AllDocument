...
package com.example.alldocument.library.fc.hssf.eventmodel;

import java.io.InputStream;
import java.util.Arrays;

import com.example.alldocument.library.fc.hssf.eventmodel.ERFListener;
 ...
 * this version sends {@link com.example.alldocument.library.fc.hssf.eventmodel.ERFListener#processRecord(Record) } messages to
...
public final class EventRecordFactory {
	...
	private final com.example.alldocument.library.fc.hssf.eventmodel.ERFListener _listener;
