...
package com.example.alldocument.library.system.dialog;
...
public class ColorPickerDialog extends Dialog
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.lib_pen_setting_dialog, null);

        final com.example.alldocument.library.system.dialog.ColorPickerView colorView = (ColorPickerView)view.findViewById(R.id.colorPickerView);
