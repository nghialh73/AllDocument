...
public interface Parent
    extends com.example.alldocument.library.fc.poifs.property.Child
{
    ...
    public void setPreviousChild(final com.example.alldocument.library.fc.poifs.property.Child child);
