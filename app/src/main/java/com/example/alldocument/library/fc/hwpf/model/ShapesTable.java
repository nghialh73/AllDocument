...
import com.example.alldocument.library.fc.hwpf.usermodel.Shape;
...
public final class ShapesTable
{
    ...
    {
        com.example.alldocument.library.fc.hwpf.model.PlexOfCps binTable = new PlexOfCps(tblStream, fib.getFcPlcspaMom(), fib.getLcbPlcspaMom(),
            26);
