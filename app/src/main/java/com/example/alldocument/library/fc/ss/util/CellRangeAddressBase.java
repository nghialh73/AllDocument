...
public abstract class CellRangeAddressBase {
	...
	public final String toString() {
		com.example.alldocument.library.fc.ss.util.CellReference crA = new com.example.alldocument.library.fc.ss.util.CellReference(_firstRow, _firstCol);
		com.example.alldocument.library.fc.ss.util.CellReference crB = new CellReference(_lastRow, _lastCol);
