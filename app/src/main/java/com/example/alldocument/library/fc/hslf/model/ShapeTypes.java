 ...
 * @author Yegor Kozlov
 */
public final class ShapeTypes implements com.example.alldocument.library.common.shape.ShapeTypes
{
    /**
    ...
    static
    {
        ...
        try
        {
            Field[] f = com.example.alldocument.library.common.shape.ShapeTypes.class.getFields();
