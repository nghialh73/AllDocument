...
import com.example.alldocument.library.fc.hslf.model.Background;
import com.example.alldocument.library.fc.hslf.model.Comment;
...
import com.example.alldocument.library.fc.hslf.model.Placeholder;
...
public final class Slide extends Sheet
{
     ...
     */
    public Slide(com.example.alldocument.library.fc.hslf.record.Slide slide, com.example.alldocument.library.fc.hslf.model.Notes notes, SlideAtomsSet atomSet,
    ...
    */
    ...
    {
        super(new com.example.alldocument.library.fc.hslf.record.Slide(), sheetNumber);
        _slideNo = slideNumber;
     ...
     */
    public void setNotes(com.example.alldocument.library.fc.hslf.model.Notes notes)
    {
        _notes = notes;
    ...
    * @see com.example.alldocument.library.fc.hslf.usermodel.SlideShow#reorderSlide(int, int)
    */
     ...
     */
    public com.example.alldocument.library.fc.hslf.record.Slide getSlideRecord()
    {
        return (com.example.alldocument.library.fc.hslf.record.Slide)getSheetContainer();
    }

    /**
     * Returns the Notes Sheet for this slide, or null if there isn't one
     */
    public com.example.alldocument.library.fc.hslf.model.Notes getNotesSheet()
    {
        return _notes;
    }
