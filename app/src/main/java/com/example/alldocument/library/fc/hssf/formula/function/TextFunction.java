...
import com.example.alldocument.library.fc.hssf.formula.function.Var2or3ArgFunction;
 ...
 */
public abstract class TextFunction implements com.example.alldocument.library.fc.hssf.formula.function.Function {
     ...
     */
    public static final com.example.alldocument.library.fc.hssf.formula.function.Function CHAR = new Fixed1ArgFunction() {
        public ValueEval evaluate(int srcRowIndex, int srcColumnIndex, ValueEval arg0) {
            int arg;
            try {
    ...
    public static final com.example.alldocument.library.fc.hssf.formula.function.Function CODE = new SingleArgTextFunc() {
        protected ValueEval evaluate(String arg) {
            return new NumberEval(arg.codePointAt(0));
        }
    };
    
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function LEN = new SingleArgTextFunc() {
		protected ValueEval evaluate(String arg) {
			return new NumberEval(arg.length());
		}
	};
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function LOWER = new SingleArgTextFunc() {
		protected ValueEval evaluate(String arg) {
			return new StringEval(arg.toLowerCase());
		}
	};
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function UPPER = new SingleArgTextFunc() {
		protected ValueEval evaluate(String arg) {
	 ...
	 */
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function TRIM = new SingleArgTextFunc() {
		protected ValueEval evaluate(String arg) {
	 ...
	 */
    public static final com.example.alldocument.library.fc.hssf.formula.function.Function CLEAN = new SingleArgTextFunc() {
        protected ValueEval evaluate(String arg) {
	 ...
	 * Author: Manda Wilson &lt; wilson at c bio dot msk cc dot org &gt;
	 */
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function MID = new Fixed3ArgFunction() {
	...
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function LEFT = new LeftRight(true);
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function RIGHT = new LeftRight(false);

	public static final com.example.alldocument.library.fc.hssf.formula.function.Function CONCATENATE = new com.example.alldocument.library.fc.hssf.formula.function.Function() {
	...
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function EXACT = new Fixed2ArgFunction() {
	 ...
	 *
	 */
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function TEXT = new Fixed2ArgFunction() {
	 ...
	 */
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function FIND = new SearchFind(true);
	/**
	 * Implementation of the FIND() function.<p/>
	 *
	 * <b>Syntax</b>:<br/>
