...
{
    private com.example.alldocument.library.fc.hwpf.usermodel.Range headerStories;
    ...
    public com.example.alldocument.library.fc.hwpf.usermodel.Range getFootnoteSeparatorSubrange()
    {
        return getSubrangeAt(0);
    }

    public com.example.alldocument.library.fc.hwpf.usermodel.Range getFootnoteContSeparatorSubrange()
    {
        return getSubrangeAt(1);
    }

    public com.example.alldocument.library.fc.hwpf.usermodel.Range getFootnoteContNoteSubrange()
    {
        return getSubrangeAt(2);
    }

    public com.example.alldocument.library.fc.hwpf.usermodel.Range getEndnoteSeparatorSubrange()
    {
        return getSubrangeAt(3);
    }

    public com.example.alldocument.library.fc.hwpf.usermodel.Range getEndnoteContSeparatorSubrange()
    {
        return getSubrangeAt(4);
    }

    public com.example.alldocument.library.fc.hwpf.usermodel.Range getEndnoteContNoteSubrange()
    {
    ...
    public com.example.alldocument.library.fc.hwpf.usermodel.Range getEvenHeaderSubrange()
    {
        return getSubrangeAt(6 + 0);
    }

    public com.example.alldocument.library.fc.hwpf.usermodel.Range getOddHeaderSubrange()
    {
        return getSubrangeAt(6 + 1);
    }

    public com.example.alldocument.library.fc.hwpf.usermodel.Range getFirstHeaderSubrange()
    {
    ...
    public com.example.alldocument.library.fc.hwpf.usermodel.Range getEvenFooterSubrange()
    {
        return getSubrangeAt(6 + 2);
    }

    public com.example.alldocument.library.fc.hwpf.usermodel.Range getOddFooterSubrange()
    {
        return getSubrangeAt(6 + 3);
    }

    public com.example.alldocument.library.fc.hwpf.usermodel.Range getFirstFooterSubrange()
    {
    ...
    private String getAt(int plcfHddIndex)
    {
        ...
        if (stripFields)
        {
            return com.example.alldocument.library.fc.hwpf.usermodel.Range.stripFields(text);
        }
    ...
    private com.example.alldocument.library.fc.hwpf.usermodel.Range getSubrangeAt(int plcfHddIndex)
    {
        if (plcfHdd == null)
            return null;
        ...
        return new com.example.alldocument.library.fc.hwpf.usermodel.Range((int)headerStories.getStartOffset() + start, (int)headerStories.getStartOffset()
            + end, headerStories);
    }
