 ...
 */
package com.example.alldocument.library.thirdpart.achartengine.renderers;
...
public class XYMultipleSeriesRenderer extends DefaultRenderer {
  ...
  public void setDisplayChartValues(boolean display) {
    com.example.alldocument.library.thirdpart.achartengine.renderers.SimpleSeriesRenderer[] renderers = getSeriesRenderers();
    for (com.example.alldocument.library.thirdpart.achartengine.renderers.SimpleSeriesRenderer renderer : renderers) {
