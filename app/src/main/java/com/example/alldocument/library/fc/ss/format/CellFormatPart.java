...
import static com.example.alldocument.library.fc.ss.format.CellFormatter.logger;
import static com.example.alldocument.library.fc.ss.format.CellFormatter.quote;
...
import com.example.alldocument.library.fc.ss.format.CellFormatCondition;
import com.example.alldocument.library.fc.ss.format.CellFormatResult;
...
public class CellFormatPart
{
    ...
    private final com.example.alldocument.library.fc.ss.format.CellFormatter format;
