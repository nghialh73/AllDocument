...
import com.example.alldocument.library.fc.hssf.usermodel.HSSFDataFormatter;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFDateUtil;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFErrorConstants;
...
import com.example.alldocument.library.fc.ss.usermodel.Comment;
import com.example.alldocument.library.fc.ss.usermodel.FormulaError;
...
import com.example.alldocument.library.fc.ss.usermodel.IHyperlink;
import com.example.alldocument.library.fc.ss.usermodel.RichTextString;
...
import com.example.alldocument.library.fc.ss.util.NumberToTextConverter;
...
public class HSSFCell implements ICell {
     ...
     *
     * @see com.example.alldocument.library.fc.hssf.usermodel.HSSFRow#createCell(short)
     */
     ...
     */
    public com.example.alldocument.library.fc.hssf.usermodel.HSSFRow getRow() {
     ...
     *                Type of cell
     * @see com.example.alldocument.library.fc.hssf.usermodel.HSSFRow#createCell(short,int)
     */
     ...
     * @deprecated (Jan 2008) Doesn't update the row's idea of what cell this is, use {@link com.example.alldocument.library.fc.hssf.usermodel.HSSFRow#moveCell(HSSFCell, short)} instead
     */
...
//        agg.setParsedExpression(ptgs);
     ...
     * @see HSSFRow#removeCell(com.com.example.alldocument.library.fc.ss.usermodel.ICell)
