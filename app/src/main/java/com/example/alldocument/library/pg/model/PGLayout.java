...
public class PGLayout
{
     ...
     * set style by type
     */
    public void setStyleByType(String type, com.example.alldocument.library.pg.model.PGStyle style)
    {
     ...
     * set style by index
     */
    public void setStyleByIdx(int idx, com.example.alldocument.library.pg.model.PGStyle style)
    {
