 ...
 * <p>
 */
public class HWPFShapeGroup extends com.example.alldocument.library.fc.hwpf.usermodel.HWPFShape
{
    public HWPFShapeGroup(EscherContainerRecord escherRecord, com.example.alldocument.library.fc.hwpf.usermodel.HWPFShape parent)
    {
     ...
     */
    public com.example.alldocument.library.fc.hwpf.usermodel.HWPFShape[] getShapes()
    {
        ...
        List<com.example.alldocument.library.fc.hwpf.usermodel.HWPFShape> shapeList = new ArrayList<com.example.alldocument.library.fc.hwpf.usermodel.HWPFShape>();
        while (iter.hasNext())
        {
            ...
            if (r instanceof EscherContainerRecord)
            {
                ...
                com.example.alldocument.library.fc.hwpf.usermodel.HWPFShape shape = HWPFShapeFactory.createShape(container, this);
                shapeList.add(shape);
            }
        }

        com.example.alldocument.library.fc.hwpf.usermodel.HWPFShape[] shapes = shapeList.toArray(new HWPFShape[shapeList.size()]);
        return shapes;
    }
