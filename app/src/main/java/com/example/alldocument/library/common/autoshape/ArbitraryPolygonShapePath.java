...
public class ArbitraryPolygonShapePath
{
        ...
        Element sp, BackgroundAndFill fill, boolean border, BackgroundAndFill lineFill, Element ln, Rectangle rect) throws Exception
    {
        ...
        com.example.alldocument.library.common.autoshape.ExtendPath pathExtend_Header = null;
        com.example.alldocument.library.common.autoshape.ExtendPath pathExtend_Tail = null;
        // arrow
            ...
            if (temp != null && temp.attribute("type") != null)
            {
                if (!"none".equals(temp.attributeValue("type")))
                {
                    ...
                    if(arrowPathAndTail != null)
                    {
                        ...
                        {
                            // extendPath
                            pathExtend_Header = new com.example.alldocument.library.common.autoshape.ExtendPath();
            ...
            if (temp != null && temp.attribute("type") != null)
            {
                ...
                { 
                    ...
                    if(arrowPathAndTail != null)
                    {
                        ...
                        {
                            // extendPath
                            pathExtend_Tail = new com.example.alldocument.library.common.autoshape.ExtendPath();
        ...
        {
            com.example.alldocument.library.common.autoshape.ExtendPath pathExtend = new ExtendPath();
