...
import com.example.alldocument.library.thirdpart.emf.io.ASCII85;
...
public class ASCII85InputStream extends DecodingInputStream implements ASCII85 {
	...
	private int readTuple() throws IOException, com.example.alldocument.library.thirdpart.emf.io.EncodingException {
		int cIndex = 0;
		int ch = -1;
		while ((!endReached) && (cIndex < 5)) {
			...
			switch (ch) {
			case -1:
				throw new com.example.alldocument.library.thirdpart.emf.io.EncodingException(
