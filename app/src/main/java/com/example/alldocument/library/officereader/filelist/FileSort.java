 ...
 * 时间:               下午4:54:20
 */
package com.example.alldocument.library.officereader.filelist;
 ...
 * <p>
 */
public class FileSort implements Comparator<com.example.alldocument.library.officereader.filelist.FileItem>
{ 
    // 不改变排列顺序
     ...
     *
     */
    public int compare(com.example.alldocument.library.officereader.filelist.FileItem object1, com.example.alldocument.library.officereader.filelist.FileItem object2)
    {
        int result = 0;
        switch(sortType)
        {
     ...
     * @return
     */
    private int comparaByNameDown(com.example.alldocument.library.officereader.filelist.FileItem object1, com.example.alldocument.library.officereader.filelist.FileItem object2)
    {
     ...
     * @return
     */
    private int comparaByNameUp(com.example.alldocument.library.officereader.filelist.FileItem object1, com.example.alldocument.library.officereader.filelist.FileItem object2)
    {
        File file1 = object1.getFile();
        File file2 = object2.getFile();
        if (file1.isDirectory() && file2.isFile()) 
     ...
     * @return
     */
    private int compareByModifiedDateDown(com.example.alldocument.library.officereader.filelist.FileItem object1, com.example.alldocument.library.officereader.filelist.FileItem object2)
    {
        File file1 = object1.getFile();
        File file2 = object2.getFile();
        if (file1.isDirectory() && file2.isFile()) 
     ...
     * @return
     */
    private int compareByModifiedDateUp(com.example.alldocument.library.officereader.filelist.FileItem object1, com.example.alldocument.library.officereader.filelist.FileItem object2)
    {
        File file1 = object1.getFile();
        File file2 = object2.getFile();
        if (file1.isDirectory() && file2.isFile()) 
     ...
     * @return
     */
    private int compareBySizeDown(com.example.alldocument.library.officereader.filelist.FileItem object1, com.example.alldocument.library.officereader.filelist.FileItem object2)
    { 
        File file1 = object1.getFile();
        File file2 = object2.getFile();
        if (file1.isDirectory() && file2.isFile()) 
     ...
     * @return
     */
    private int compareBySizeUp(com.example.alldocument.library.officereader.filelist.FileItem object1, com.example.alldocument.library.officereader.filelist.FileItem object2)
    { 
        File file1 = object1.getFile();
        File file2 = object2.getFile();
        if (file1.isDirectory() && file2.isFile()) 
     ...
     * @return
     */
    private int compareByDirDown(com.example.alldocument.library.officereader.filelist.FileItem object1, com.example.alldocument.library.officereader.filelist.FileItem object2)
    {
        File file1 = object1.getFile();
        File file2 = object2.getFile();
        if (file1.isDirectory() && file2.isFile()) 
     ...
     * @return
     */
    private int compareByDirUp(com.example.alldocument.library.officereader.filelist.FileItem object1, FileItem object2)
    {
        File file1 = object1.getFile();
        File file2 = object2.getFile();
        if (file1.isDirectory() && file2.isFile()) 
