...
import com.example.alldocument.library.fc.hssf.usermodel.DVConstraint.FormulaPair;
...
public final class HSSFDataValidation implements DataValidation {
	...
	private com.example.alldocument.library.fc.hssf.usermodel.DVConstraint _constraint;
	...
	public HSSFDataValidation(CellRangeAddressList regions, DataValidationConstraint constraint) {
		...
		_constraint = (com.example.alldocument.library.fc.hssf.usermodel.DVConstraint)constraint;
	}
