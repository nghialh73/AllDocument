...
import com.example.alldocument.library.fc.ddf.*;
...
public final class Placeholder extends TextBox
{
    ...
    protected Placeholder(EscherContainerRecord escherRecord, com.example.alldocument.library.fc.hslf.model.Shape parent)
    {
