 ...
 * 时间:              下午1:49:11
 */
package com.example.alldocument.library.system.beans.pagelist;
...
import com.example.alldocument.library.system.beans.pagelist.APageListAdapter;
import com.example.alldocument.library.system.beans.pagelist.APageListEventManage;
...
public class APageListView extends AdapterView<Adapter>
{
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            if (view instanceof com.example.alldocument.library.system.beans.pagelist.APageListItem)
            {   
                com.example.alldocument.library.system.beans.pagelist.APageListItem pv = (com.example.alldocument.library.system.beans.pagelist.APageListItem)view;
    ...
    {
    	com.example.alldocument.library.system.beans.pagelist.APageListItem pageView = getCurrentPageView();
    	if (pageView != null)
    	{
    ...
    {
    	com.example.alldocument.library.system.beans.pagelist.APageListItem currentView = childViewsCache.get(currentIndex);
        Point cvOffset;
        if (!isResetLayout)
        {
            ...
            for (int i = 0; i < numChildren; i++)
            {
                ...
                {
                    com.example.alldocument.library.system.beans.pagelist.APageListItem pv = childViewsCache.get( pIndexs[i]);
                    pv.releaseResources();
    ...
    public void nextPageView()
    {
        ...
        com.example.alldocument.library.system.beans.pagelist.APageListItem pageView = childViewsCache.get(currentIndex + 1);
        if (pageView != null)
        {
            currentIndex++;
     ...
     *
     */
    public void exportImage(final com.example.alldocument.library.system.beans.pagelist.APageListItem view, final Bitmap srcBitmap)
    {
    ...
    public boolean isPointVisibleOnScreen(int x, int y)
    {
        x = (int)(x * zoom);
        y = (int)(y * zoom);
        com.example.alldocument.library.system.beans.pagelist.APageListItem item = getCurrentPageView();
        if (item == null)
        {
            return false;
        }
    ...
    public void setZoom(float zoomValue, int pointX, int pointY, final boolean isRepaint)
    {
        ...
        if (isRepaint)
        {
            com.example.alldocument.library.system.beans.pagelist.APageListItem v = getCurrentPageView();
            int left = 0;
            int top = 0;
            if (v != null)
            {
     ...
     * @param v
     */
    protected void postUnRepaint(final com.example.alldocument.library.system.beans.pagelist.APageListItem view)
    {
        if (view == null)
        {
            return;
     ...
     * @param v
     */
    public void postRepaint(final com.example.alldocument.library.system.beans.pagelist.APageListItem view)
    {
        if (view == null)
        {
            return;
     ...
     * @return
     */
    public com.example.alldocument.library.system.beans.pagelist.APageListItem getCurrentPageView()
    {
     ...
     * @return
     */
    private com.example.alldocument.library.system.beans.pagelist.APageListItem createPageView(int pageIndex)
    {
        com.example.alldocument.library.system.beans.pagelist.APageListItem pageView = childViewsCache.get(pageIndex);
        if (pageView == null)
        {
            pageView = (com.example.alldocument.library.system.beans.pagelist.APageListItem)pageAdapter.getView(pageIndex,
     ...
     * 
     */
    protected com.example.alldocument.library.system.beans.pagelist.APageListItem getPageListItem(int position, View convertView, ViewGroup parent)
    {
    ...
    public void dispose()
    {
        ...
        {
            for (com.example.alldocument.library.system.beans.pagelist.APageListItem page : pageViewCache)
            {
                page.dispose();
            }
            pageViewCache.clear();
    ...
    //
    private SparseArray<com.example.alldocument.library.system.beans.pagelist.APageListItem> childViewsCache = new SparseArray<com.example.alldocument.library.system.beans.pagelist.APageListItem>(3);
    // Shadows the children of the adapter view
    // but with more sensible indexing
    private LinkedList<com.example.alldocument.library.system.beans.pagelist.APageListItem> pageViewCache = new LinkedList<APageListItem>();
