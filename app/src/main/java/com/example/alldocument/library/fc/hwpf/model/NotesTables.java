...
import com.example.alldocument.library.fc.hwpf.model.FootnoteReferenceDescriptor;
...
{
    private com.example.alldocument.library.fc.hwpf.model.PlexOfCps descriptors = new com.example.alldocument.library.fc.hwpf.model.PlexOfCps(FootnoteReferenceDescriptor.getSize());

    private final com.example.alldocument.library.fc.hwpf.model.NoteType noteType;

    private com.example.alldocument.library.fc.hwpf.model.PlexOfCps textPositions = new com.example.alldocument.library.fc.hwpf.model.PlexOfCps(0);

    public NotesTables(final com.example.alldocument.library.fc.hwpf.model.NoteType noteType)
    {
    ...
    private void read(byte[] tableStream, FileInformationBlock fib)
    {
        ...
        if (referencesStart != 0 && referencesLength != 0)
            this.descriptors = new com.example.alldocument.library.fc.hwpf.model.PlexOfCps(tableStream, referencesStart, referencesLength,
