...
public class STDocument implements IDocument
{
     ...
     * 得到章节元素
     */
    public com.example.alldocument.library.simpletext.model.IElement getSection(long offset)
    {
        return section;
    }
     ...
     * 
     */
    public void appendSection(com.example.alldocument.library.simpletext.model.IElement elem)
    {
     ...
     * 
     */
    public void appendElement(com.example.alldocument.library.simpletext.model.IElement elem, long offset)
    {
     ...
     */    
    public com.example.alldocument.library.simpletext.model.IElement getHFElement(long area, byte type)
    {
        return null;
    }
     ...
     * @param area 区域
     */
    public com.example.alldocument.library.simpletext.model.IElement getFEElement(long offset)
    {
        return null;
    }
     ...
     * 得到段落元素 
     */
    public com.example.alldocument.library.simpletext.model.IElement getParagraph(long offset)
    {
     ...
     * 
     */
    public com.example.alldocument.library.simpletext.model.IElement getParagraphForIndex(int index, long area)
    {
     ...
     *
     */
    public com.example.alldocument.library.simpletext.model.IElement getLeaf(long offset)
    {
        com.example.alldocument.library.simpletext.model.IElement para = getParagraph(offset);
        if (para != null)
        {
    ...
    public void setParagraphAttr(long start, int len, IAttributeSet attr)
    {
        ...
        while (start < end)
        {
            com.example.alldocument.library.simpletext.model.IElement para = section.getParaCollection().getElement(start);
    ...
    public void setLeafAttr(long start, int len, IAttributeSet attr)
    {
        ...
        while (start < end)
        {
            com.example.alldocument.library.simpletext.model.IElement leaf = getLeaf(start);
