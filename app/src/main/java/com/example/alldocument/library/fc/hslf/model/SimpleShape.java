...
import com.example.alldocument.library.fc.hslf.exceptions.HSLFException;
 ...
 *  @author Yegor Kozlov
 */
public abstract class SimpleShape extends com.example.alldocument.library.fc.hslf.model.Shape
{
    /**
    ...
    public Rectangle2D getLogicalAnchor2D()
    {
        ...
        if (_parent != null)
        {
            ...
            Rectangle2D clientAnchor = ((com.example.alldocument.library.fc.hslf.model.ShapeGroup)_parent).getClientAnchor2D(_parent);
...
//            double height = anchor.getHeight() / scale;
    ...
    public void setHyperlink(com.example.alldocument.library.fc.hslf.model.Hyperlink link)
    {
        if (link.getId() == -1)
        {
        ...
        switch (link.getType())
        {
            case com.example.alldocument.library.fc.hslf.model.Hyperlink.LINK_FIRSTSLIDE:
                ...
                break;
            case com.example.alldocument.library.fc.hslf.model.Hyperlink.LINK_LASTSLIDE:
                infoAtom.setAction(InteractiveInfoAtom.ACTION_JUMP);
                infoAtom.setJump(InteractiveInfoAtom.JUMP_LASTSLIDE);
                infoAtom.setHyperlinkType(InteractiveInfoAtom.LINK_LastSlide);
                break;
            case com.example.alldocument.library.fc.hslf.model.Hyperlink.LINK_NEXTSLIDE:
                infoAtom.setAction(InteractiveInfoAtom.ACTION_JUMP);
                infoAtom.setJump(InteractiveInfoAtom.JUMP_NEXTSLIDE);
                infoAtom.setHyperlinkType(InteractiveInfoAtom.LINK_NextSlide);
                break;
            case com.example.alldocument.library.fc.hslf.model.Hyperlink.LINK_PREVIOUSSLIDE:
                infoAtom.setAction(InteractiveInfoAtom.ACTION_JUMP);
