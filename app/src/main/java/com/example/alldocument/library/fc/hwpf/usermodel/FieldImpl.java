...
class FieldImpl implements Field
{
    ...
    public com.example.alldocument.library.fc.hwpf.usermodel.Range firstSubrange(com.example.alldocument.library.fc.hwpf.usermodel.Range parent)
    {
        if (hasSeparator())
        {
            ...
            return new com.example.alldocument.library.fc.hwpf.usermodel.Range(getMarkStartOffset() + 1, getMarkSeparatorOffset(), parent)
            {
                @ Override
        ...
        return new com.example.alldocument.library.fc.hwpf.usermodel.Range(getMarkStartOffset() + 1, getMarkEndOffset(), parent)
        {
            @ Override
            public String toString()
            {
    ...
    public CharacterRun getMarkEndCharacterRun(com.example.alldocument.library.fc.hwpf.usermodel.Range parent)
    {
        return new com.example.alldocument.library.fc.hwpf.usermodel.Range(getMarkEndOffset(), getMarkEndOffset() + 1, parent).getCharacterRun(0);
    }
    ...
    public CharacterRun getMarkSeparatorCharacterRun(com.example.alldocument.library.fc.hwpf.usermodel.Range parent)
    {
        if (!hasSeparator())
            return null;

        return new com.example.alldocument.library.fc.hwpf.usermodel.Range(getMarkSeparatorOffset(), getMarkSeparatorOffset() + 1, parent)
            .getCharacterRun(0);
    }
    ...
    public CharacterRun getMarkStartCharacterRun(com.example.alldocument.library.fc.hwpf.usermodel.Range parent)
    {
        return new com.example.alldocument.library.fc.hwpf.usermodel.Range(getMarkStartOffset(), getMarkStartOffset() + 1, parent).getCharacterRun(0);
    }
    ...
    public com.example.alldocument.library.fc.hwpf.usermodel.Range secondSubrange(com.example.alldocument.library.fc.hwpf.usermodel.Range parent)
    {
