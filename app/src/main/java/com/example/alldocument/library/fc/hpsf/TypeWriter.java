...
public class TypeWriter
{
    ...
    /**
     * <p>Writes a 16-byte {@link com.example.alldocument.library.fc.hpsf.ClassID} to an output stream.</p>
     *
     * @param out The stream to write to
     * @param n The value to write
    ...
    /**
     * <p>Writes an array of {@link com.example.alldocument.library.fc.hpsf.Property} instances to an output stream
    ...
    public static void writeToStream(final OutputStream out,
                                     final com.example.alldocument.library.fc.hpsf.Property[] properties,
                                     final int codepage)
