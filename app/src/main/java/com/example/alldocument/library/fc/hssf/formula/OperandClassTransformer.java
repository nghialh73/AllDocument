...
final class OperandClassTransformer {
	 ...
	 */
	public void transformFormula(com.example.alldocument.library.fc.hssf.formula.ParseNode rootNode) {
		byte rootNodeOperandClass;
		switch (_formulaType) {
			case com.example.alldocument.library.fc.hssf.formula.FormulaType.CELL:
				rootNodeOperandClass = Ptg.CLASS_VALUE;
				break;
			case com.example.alldocument.library.fc.hssf.formula.FormulaType.ARRAY:
				rootNodeOperandClass = Ptg.CLASS_ARRAY;
				break;
			case com.example.alldocument.library.fc.hssf.formula.FormulaType.NAMEDRANGE:
	 ...
	 */
	private void transformNode(com.example.alldocument.library.fc.hssf.formula.ParseNode node, byte desiredOperandClass,
                               boolean callerForceArrayFlag) {
		Ptg token = node.getToken();
		com.example.alldocument.library.fc.hssf.formula.ParseNode[] children = node.getChildren();
	...
	private void transformFunctionNode(AbstractFunctionPtg afp, com.example.alldocument.library.fc.hssf.formula.ParseNode[] children,
...
//								afp.setClass(Ptg.CLASS_ARRAY);
		...
		for (int i = 0; i < children.length; i++) {
			com.example.alldocument.library.fc.hssf.formula.ParseNode child = children[i];
