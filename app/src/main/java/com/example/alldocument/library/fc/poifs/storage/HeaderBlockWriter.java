...
{
   private final com.example.alldocument.library.fc.poifs.storage.HeaderBlock _header_block;
    ...
    {
       _header_block = new com.example.alldocument.library.fc.poifs.storage.HeaderBlock(bigBlockSize);
    }
    ...
    public com.example.alldocument.library.fc.poifs.storage.BATBlock[] setBATBlocks(final int blockCount,
                                                                      final int startBlock)
    {
        com.example.alldocument.library.fc.poifs.storage.BATBlock[] rvalue;
        ...
        if (blockCount > _max_bats_in_header)
        {
            ...
            rvalue = com.example.alldocument.library.fc.poifs.storage.BATBlock.createXBATBlocks(bigBlockSize, excess_block_array,
                                               startBlock + blockCount);
            _header_block.setXBATStart(startBlock + blockCount);
        }
        else
        {
            rvalue = com.example.alldocument.library.fc.poifs.storage.BATBlock.createXBATBlocks(bigBlockSize, new int[ 0 ], 0);
