...
import com.example.alldocument.library.fc.hssf.formula.CollaboratingWorkbooksEnvironment;
import com.example.alldocument.library.fc.hssf.formula.CollaboratingWorkbooksEnvironment.WorkbookNotFoundException;
import com.example.alldocument.library.fc.hssf.formula.EvaluationCache;
import com.example.alldocument.library.fc.hssf.formula.EvaluationCell;
import com.example.alldocument.library.fc.hssf.formula.EvaluationName;
import com.example.alldocument.library.fc.hssf.formula.EvaluationSheet;
import com.example.alldocument.library.fc.hssf.formula.EvaluationTracker;
import com.example.alldocument.library.fc.hssf.formula.EvaluationWorkbook;
import com.example.alldocument.library.fc.hssf.formula.FormulaCellCacheEntry;
import com.example.alldocument.library.fc.hssf.formula.IEvaluationListener;
import com.example.alldocument.library.fc.hssf.formula.IStabilityClassifier;
import com.example.alldocument.library.fc.hssf.formula.OperationEvaluationContext;
import com.example.alldocument.library.fc.hssf.formula.OperationEvaluatorFactory;
...
import com.example.alldocument.library.fc.hssf.formula.eval.MissingArgEval;
import com.example.alldocument.library.fc.hssf.formula.eval.NameEval;
import com.example.alldocument.library.fc.hssf.formula.eval.NotImplementedException;
...
import com.example.alldocument.library.fc.hssf.formula.function.Choose;
import com.example.alldocument.library.fc.hssf.formula.function.FreeRefFunction;
import com.example.alldocument.library.fc.hssf.formula.function.IfFunc;
import com.example.alldocument.library.fc.hssf.formula.ptg.Area3DPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.AreaErrPtg;
...
import com.example.alldocument.library.fc.hssf.formula.ptg.ControlPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.DeletedArea3DPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.DeletedRef3DPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.ErrPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.ExpPtg;
...
import com.example.alldocument.library.fc.hssf.formula.ptg.MemErrPtg;
...
import com.example.alldocument.library.fc.hssf.formula.ptg.RefErrorPtg;
...
import com.example.alldocument.library.fc.hssf.formula.ptg.UnknownPtg;
...
import com.example.alldocument.library.fc.hssf.usermodel.HSSFEvaluationWorkbook;
...
import com.example.alldocument.library.ss.model.XLSModel.ACell;
import com.example.alldocument.library.ss.model.baseModel.Cell;
...
public final class WorkbookEvaluator {
	...
	private com.example.alldocument.library.fc.hssf.formula.EvaluationCache _cache;
	/** part of cache entry key (useful when evaluating multiple workbooks) */
	private int _workbookIx;

	private final IEvaluationListener _evaluationListener;
	private final Map<com.example.alldocument.library.fc.hssf.formula.EvaluationSheet, Integer> _sheetIndexesBySheet;
	...
	private com.example.alldocument.library.fc.hssf.formula.EvaluationTracker tracker ;
	...
	/* package */ WorkbookEvaluator(EvaluationWorkbook workbook, IEvaluationListener evaluationListener,
		...
		_cache = new com.example.alldocument.library.fc.hssf.formula.EvaluationCache(evaluationListener);
		_sheetIndexesBySheet = new IdentityHashMap<com.example.alldocument.library.fc.hssf.formula.EvaluationSheet, Integer>();
	...
	/* package */ com.example.alldocument.library.fc.hssf.formula.EvaluationSheet getSheet(int sheetIndex)
	{
	    Iterator<com.example.alldocument.library.fc.hssf.formula.EvaluationSheet> iter = _sheetIndexesBySheet.keySet().iterator();
	    while(iter.hasNext())
	    {
	        com.example.alldocument.library.fc.hssf.formula.EvaluationSheet sheet = (com.example.alldocument.library.fc.hssf.formula.EvaluationSheet)iter.next();
	        if(_sheetIndexesBySheet.get(sheet) == sheetIndex)
	        {
	            return sheet;
	        }
	    }
	    com.example.alldocument.library.fc.hssf.formula.EvaluationSheet sheet = _workbook.getSheet(sheetIndex);
	...
	/* package */ com.example.alldocument.library.fc.hssf.formula.EvaluationName getName(String name, int sheetIndex) {
	...
	/* package */ void attachToEnvironment(CollaboratingWorkbooksEnvironment collaboratingWorkbooksEnvironment, com.example.alldocument.library.fc.hssf.formula.EvaluationCache cache, int workbookIx) {
	...
	/* package */ void detachFromEnvironment() {
		_collaboratingWorkbookEnvironment = CollaboratingWorkbooksEnvironment.EMPTY;
		_cache = new com.example.alldocument.library.fc.hssf.formula.EvaluationCache(_evaluationListener);
		_workbookIx = 0;
	}
	/**
	 ...
	 * has changed.
	 */
	public void notifyUpdateCell(com.example.alldocument.library.fc.hssf.formula.EvaluationCell cell) {
	 ...
	 * deleted.
	 */
	public void notifyDeleteCell(com.example.alldocument.library.fc.hssf.formula.EvaluationCell cell) {
		int sheetIndex = getSheetIndex(cell.getSheet());
		_cache.notifyDeleteCell(_workbookIx, sheetIndex, cell);
	}
	
	private int getSheetIndex(com.example.alldocument.library.fc.hssf.formula.EvaluationSheet sheet) {
	...
	public ValueEval evaluate(com.example.alldocument.library.fc.hssf.formula.EvaluationCell srcCell) {
		int sheetIndex = getSheetIndex(srcCell.getSheet());
		if(tracker == null)
		{
		    tracker = new com.example.alldocument.library.fc.hssf.formula.EvaluationTracker(_cache);
		}
	 ...
	 */
	private ValueEval evaluateAny(com.example.alldocument.library.fc.hssf.formula.EvaluationCell srcCell, int sheetIndex,
                                  int rowIndex, int columnIndex, com.example.alldocument.library.fc.hssf.formula.EvaluationTracker tracker)
	{
	 ...
	 */
	/* package */ static ValueEval getValueFromNonFormulaCell(com.example.alldocument.library.fc.hssf.formula.EvaluationCell cell) {
		if (cell == null) {
...
//			logDebug("push " + opResult);
	...
	private ValueEval getEvalForPtg(Ptg ptg, OperationEvaluationContext ec) {
		...
		if (ptg instanceof NamePtg) {
			...
			com.example.alldocument.library.fc.hssf.formula.EvaluationName nameRecord = _workbook.getName(namePtg);
...
//		return getEvalForPtg(ptgs[0], ec);
	...
	/* package */ ValueEval evaluateReference(EvaluationSheet sheet, int sheetIndex, int rowIndex,
                                              int columnIndex, com.example.alldocument.library.fc.hssf.formula.EvaluationTracker tracker) {
