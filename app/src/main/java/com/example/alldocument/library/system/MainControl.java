 ...
 * 时间:              下午7:17:16
 */
package com.example.alldocument.library.system;
...
import com.example.alldocument.library.fc.doc.TXTKit;
import com.example.alldocument.library.fc.pdf.PDFLib;
import com.example.alldocument.library.pdf.PDFControl;
import com.example.alldocument.library.pg.control.PGControl;
import com.example.alldocument.library.pg.model.PGModel;
import com.example.alldocument.library.simpletext.model.IDocument;
import com.example.alldocument.library.ss.control.SSControl;
import com.example.alldocument.library.ss.model.baseModel.Workbook;
import com.example.alldocument.library.system.AUncaughtExceptionHandler;
import com.example.alldocument.library.system.AbstractControl;
import com.example.alldocument.library.system.FileKit;
import com.example.alldocument.library.system.FileReaderThread;
...
import com.example.alldocument.library.wp.control.WPControl;
...
public class MainControl extends AbstractControl
{
     ...
     * 
     */
    public MainControl(com.example.alldocument.library.system.IMainFrame frame)
    {
        this.frame = frame;
        uncaught = new AUncaughtExceptionHandler(this);
        Thread.setDefaultUncaughtExceptionHandler(uncaught);
        sysKit = new com.example.alldocument.library.system.SysKit(this);
        init();
    }
            ...
            public void handleMessage(Message msg)
            {
                ...
                switch (msg.what)
                {
                    ...
                    case MainConstant.HANDLER_MESSAGE_SEND_READER_INSTANCE:
                        reader = (com.example.alldocument.library.system.IReader)msg.obj;
                        break;
                }
            }
        };
...
//                                frame.getActivity().setProgressBarIndeterminateVisibility(false);
     ...
     * 
     */
    public com.example.alldocument.library.system.IMainFrame getMainFrame()
    {
        return frame;
    }
     ...
     * 
     */
    public com.example.alldocument.library.system.IReader getReader()
    {
        return reader;
    }
     ...
     * 
     */
    public com.example.alldocument.library.system.SysKit getSysKit()
    {
        return this.sysKit;
    }
