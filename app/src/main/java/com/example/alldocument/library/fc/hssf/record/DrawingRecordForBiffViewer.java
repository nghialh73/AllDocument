...
public final class DrawingRecordForBiffViewer extends AbstractEscherHolderRecord {
    ...
    public DrawingRecordForBiffViewer( com.example.alldocument.library.fc.hssf.record.RecordInputStream in)
    {
        super(in);
    }

    public DrawingRecordForBiffViewer(com.example.alldocument.library.fc.hssf.record.DrawingRecord r)
    {
    	super(convertToInputStream(r));
    	convertRawBytesToEscherRecords();
    }
    private static com.example.alldocument.library.fc.hssf.record.RecordInputStream convertToInputStream(DrawingRecord r)
    {
    	byte[] data = r.serialize();
    	com.example.alldocument.library.fc.hssf.record.RecordInputStream rinp = new RecordInputStream(
