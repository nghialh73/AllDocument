...
import com.example.alldocument.library.macro.TouchEventListener;
...
import com.example.alldocument.library.wp.control.WPFind;
import com.example.alldocument.library.wp.control.WPPageListItem;
...
public class PrintWord extends FrameLayout implements IPageListViewListener
{
    ...
    {
        if (getControl() == null || !(getParent() instanceof com.example.alldocument.library.wp.control.Word))
        {
            return;
        }
        
        com.example.alldocument.library.wp.control.WPFind find = (WPFind)control.getFind();
        if (find.isSetPointToVisible())
        {
            ...
            Rectangle rect = modelToView(((com.example.alldocument.library.wp.control.Word)getParent()).getHighlight().getSelectStart(), new Rectangle(), false);
            rect.x -= pv.getX();
            rect.y -= pv.getY();
            ...
            public void run()
            {
                ...
                {               
                    ...
                    { 
                        ...
                        if (getParent() instanceof com.example.alldocument.library.wp.control.Word)
                        {
                            ((com.example.alldocument.library.wp.control.Word)getParent()).getHighlight().setPaintHighlight(false);
                        }
                        // don't zoom
                        ...
                        if (getParent() instanceof com.example.alldocument.library.wp.control.Word)
                        {
                            ((com.example.alldocument.library.wp.control.Word)getParent()).getHighlight().setPaintHighlight(true);
                        }
    ...
    public void resetSearchResult(APageListItem pageItem)
    {
        if (getParent() instanceof com.example.alldocument.library.wp.control.Word)
        {
            com.example.alldocument.library.wp.control.Word word = (Word)getParent();
