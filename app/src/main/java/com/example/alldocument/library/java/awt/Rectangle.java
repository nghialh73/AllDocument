...
package com.example.alldocument.library.java.awt;
    ...
    implements Shape, java.io.Serializable
{
     ...
     * {@link com.example.alldocument.library.java.awt.Dimension} argument.
     ...
     */
    public Rectangle(Point p, com.example.alldocument.library.java.awt.Dimension d) {
     ...
     */
    public Rectangle(com.example.alldocument.library.java.awt.Dimension d) {
     ...
     * @see       #getBounds
     * @see	  java.awt.Component#setBounds(com.example.alldocument.library.java.awt.Rectangle)
     * @since     1.1
     */
     ...
     *                 along the Y axis
     * @see       com.example.alldocument.library.java.awt.Rectangle#setLocation(int, int)
     * @see       com.example.alldocument.library.java.awt.Rectangle#setLocation(java.awt.Point)
     */
     ...
     * @see       #setSize(com.example.alldocument.library.java.awt.Dimension)
     * @see       #setSize(int, int)
     * @since     1.1
     */
    public com.example.alldocument.library.java.awt.Dimension getSize() {
	return new com.example.alldocument.library.java.awt.Dimension(width, height);
    }	
     ...
     * @see       java.awt.Component#setSize(com.example.alldocument.library.java.awt.Dimension)
     * @see       #getSize
     * @since     1.1
     */
