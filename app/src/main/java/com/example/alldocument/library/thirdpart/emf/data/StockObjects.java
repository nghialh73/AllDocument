...
import com.example.alldocument.library.thirdpart.emf.data.LogFontW;
import com.example.alldocument.library.thirdpart.emf.data.LogPen;
...
public class StockObjects {
    ...
    private static final com.example.alldocument.library.thirdpart.emf.data.GDIObject[] objects = new com.example.alldocument.library.thirdpart.emf.data.GDIObject[20];
    static {
        Color nullColor = new Color(0, 0, 0, 0);

        objects[WHITE_BRUSH] = new com.example.alldocument.library.thirdpart.emf.data.LogBrush32(EMFConstants.BS_SOLID, Color.WHITE, 0);
        objects[LTGRAY_BRUSH] = new com.example.alldocument.library.thirdpart.emf.data.LogBrush32(EMFConstants.BS_SOLID, Color.LIGHT_GRAY, 0);
        objects[GRAY_BRUSH] = new com.example.alldocument.library.thirdpart.emf.data.LogBrush32(EMFConstants.BS_SOLID, Color.GRAY, 0);
        objects[DKGRAY_BRUSH] = new com.example.alldocument.library.thirdpart.emf.data.LogBrush32(EMFConstants.BS_SOLID, Color.DARK_GRAY, 0);
        objects[BLACK_BRUSH] = new com.example.alldocument.library.thirdpart.emf.data.LogBrush32(EMFConstants.BS_SOLID, Color.BLACK, 0);
        objects[NULL_BRUSH] = new LogBrush32(EMFConstants.BS_NULL, nullColor, 0);

        objects[WHITE_PEN] = new com.example.alldocument.library.thirdpart.emf.data.LogPen(EMFConstants.PS_SOLID, 1, Color.WHITE);
        objects[BLACK_PEN] = new com.example.alldocument.library.thirdpart.emf.data.LogPen(EMFConstants.PS_SOLID, 1, Color.BLACK);
        objects[NULL_PEN] = new LogPen(EMFConstants.PS_NULL, 1, nullColor);

        // XXX: Should these depend on the look and feel?
        objects[OEM_FIXED_FONT] = new com.example.alldocument.library.thirdpart.emf.data.LogFontW(new Font("Monospaced", Font.PLAIN, 12));
        objects[ANSI_FIXED_FONT] = objects[OEM_FIXED_FONT];
        objects[ANSI_VAR_FONT] = new com.example.alldocument.library.thirdpart.emf.data.LogFontW(new Font("SansSerif", Font.PLAIN, 12));
     ...
     */
    public static com.example.alldocument.library.thirdpart.emf.data.GDIObject getStockObject(int value) {
        if (value >= 0) {
