...
{    
    public static com.example.alldocument.library.fc.hssf.usermodel.HSSFShape createShape(AWorkbook workbook, Map<EscherRecord, Record> shapeToObj,
                                                                            EscherContainerRecord spContainer, com.example.alldocument.library.fc.hssf.usermodel.HSSFShape parent)
    {
    ...
    public static com.example.alldocument.library.fc.hssf.usermodel.HSSFShapeGroup createShapeGroup(AWorkbook workbook, Map<EscherRecord, Record> shapeToObj,
                                                                                      EscherContainerRecord spContainer, com.example.alldocument.library.fc.hssf.usermodel.HSSFShape parent)
    {
        com.example.alldocument.library.fc.hssf.usermodel.HSSFShapeGroup group = null;
        ...
        if (childRecords.size() > 0)
        {
            ...
            com.example.alldocument.library.fc.hssf.usermodel.HSSFAnchor anchor = null;
            if(parent == null)
            {
                ...
                {
                    anchor = com.example.alldocument.library.fc.hssf.usermodel.HSSFShape.toClientAnchor(anchorRecord);
                }
            }
            else
            {
                ...
                if(childRecord != null)
                {
                    anchor = com.example.alldocument.library.fc.hssf.usermodel.HSSFShape.toChildAnchor(childRecord);
                }
            }
            if(anchor == null)
            {
            ...
            if (opt != null)
            {
                ...
                {
                    group = new com.example.alldocument.library.fc.hssf.usermodel.HSSFShapeGroup(groupContainer, parent, anchor);
                }
            }
            else
            {
            ...
            {
                com.example.alldocument.library.fc.hssf.usermodel.HSSFShape shape = createShape(workbook, shapeToObj, (EscherContainerRecord)childRecords.get(i), group);
    ...
    public static com.example.alldocument.library.fc.hssf.usermodel.HSSFShape createSimpeShape(AWorkbook workbook, Map<EscherRecord, Record> shapeToObj,
                                                                                 EscherContainerRecord spContainer, com.example.alldocument.library.fc.hssf.usermodel.HSSFShape parent)
    {
        com.example.alldocument.library.fc.hssf.usermodel.HSSFShape shape = null;
        ...
        switch (type)
        {
            case ShapeTypes.TextBox:
                if (shapeToObj != null && shapeToObj.size() > 0)
                {
                    ...
                    if(record instanceof ObjRecord && ((ObjRecord)record).getSubRecords().get(0) instanceof CommonObjectDataSubRecord)
                    {
                        ...
                        {
                            //except comment
                            shape = new com.example.alldocument.library.fc.hssf.usermodel.HSSFAutoShape(workbook, spContainer, parent, anchor, type);
                        }
                    }
                    break;
                }
            ...
            case ShapeTypes.PictureFrame:
                ...
                shape = new com.example.alldocument.library.fc.hssf.usermodel.HSSFPicture(workbook, spContainer, parent, anchor , opt);
                if (prop != null)
                {                    
