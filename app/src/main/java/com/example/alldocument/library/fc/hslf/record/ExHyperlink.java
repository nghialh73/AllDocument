...
public class ExHyperlink extends RecordContainer {
	...
	private void findInterestingChildren() {
        ...
        for (int i = 1; i < _children.length; i++) {
            if (_children[i] instanceof com.example.alldocument.library.fc.hslf.record.CString){
                if ( linkDetailsA == null) linkDetailsA = (com.example.alldocument.library.fc.hslf.record.CString)_children[i];
                else linkDetailsB = (com.example.alldocument.library.fc.hslf.record.CString)_children[i];
            } else {
   ...
   private com.example.alldocument.library.fc.hslf.record.CString linkDetailsA;
