...
import com.example.alldocument.library.simpletext.view.ViewContainer;
 ...
 * <p>
 */
public class STRoot extends AbstractView implements com.example.alldocument.library.simpletext.view.IRoot
{
    /**
     * 
     * @param doc
    ...
    private void paraAlign(int maxParaWidth)
    {
       ...
       com.example.alldocument.library.simpletext.view.IView paraView = getChildView();
       while (paraView != null)
       {
           paraAttr.horizontalAlignment = (byte)AttrManage.instance().getParaHorizontalAlign(paraView.getElement().getAttribute());
           com.example.alldocument.library.simpletext.view.IView line = paraView.getChildView();
           while (line != null)
           {
    ...
    private void layoutPageAlign(int contentHeight, int maxParaWidth)
    {
        ...
        if (pageAttr.horizontalAlign == WPAttrConstant.PAGE_H_CENTER)
        {
            ...
            while (view != null)
            {
                ...
                com.example.alldocument.library.simpletext.view.IView line = view.getChildView();
    ...
    {
        com.example.alldocument.library.simpletext.view.IView view = getView(offset, WPViewConstant.PARAGRAPH_VIEW, isBack);
        if (view != null)
        {
