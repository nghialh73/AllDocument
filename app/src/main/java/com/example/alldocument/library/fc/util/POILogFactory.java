...
package com.example.alldocument.library.fc.util;

import com.example.alldocument.library.fc.util.NullLogger;
...
public class POILogFactory
{
     ...
     */
    private static Map<String, com.example.alldocument.library.fc.util.POILogger> _loggers = new HashMap<String, com.example.alldocument.library.fc.util.POILogger>();;

    /**
     * A common instance of NullLogger, as it does nothing
     *  we only need the one
     */
    private static com.example.alldocument.library.fc.util.POILogger _nullLogger = new NullLogger();
    /**
    ...
    public static com.example.alldocument.library.fc.util.POILogger getLogger(final Class theclass)
    {
    ...
    public static com.example.alldocument.library.fc.util.POILogger getLogger(final String cat)
    {
        com.example.alldocument.library.fc.util.POILogger logger = null;
        ...
        if (_loggers.containsKey(cat)) {
            ...
            try {
              Class<? extends com.example.alldocument.library.fc.util.POILogger> loggerClass =
