...
import com.example.alldocument.library.fc.hssf.record.BottomMarginRecord;
...
import com.example.alldocument.library.fc.hssf.record.HorizontalPageBreakRecord;
import com.example.alldocument.library.fc.hssf.record.LeftMarginRecord;
import com.example.alldocument.library.fc.hssf.record.Margin;
import com.example.alldocument.library.fc.hssf.record.PageBreakRecord;
...
import com.example.alldocument.library.fc.hssf.record.RightMarginRecord;
import com.example.alldocument.library.fc.hssf.record.TopMarginRecord;
import com.example.alldocument.library.fc.hssf.record.UnknownRecord;
import com.example.alldocument.library.fc.hssf.record.UserSViewBegin;
import com.example.alldocument.library.fc.hssf.record.VCenterRecord;
import com.example.alldocument.library.fc.hssf.record.VerticalPageBreakRecord;
 ...
 * @author Josh Micich
 */
public final class PageSettingsBlock extends com.example.alldocument.library.fc.hssf.record.aggregates.RecordAggregate {

	/**
	 * PLS is potentially a <i>continued</i> record, but is currently uninterpreted by POI
	 */
	private static final class PLSAggregate extends com.example.alldocument.library.fc.hssf.record.aggregates.RecordAggregate {
