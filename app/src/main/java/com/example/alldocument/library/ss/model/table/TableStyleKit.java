 ...
 * 时间:              下午2:06:58
 */
package com.example.alldocument.library.ss.model.table;

import java.util.Map;

import com.example.alldocument.library.constant.SchemeClrConstant;
import com.example.alldocument.library.ss.model.table.SSTableCellStyle;
import com.example.alldocument.library.ss.model.table.SSTableStyle;
import com.example.alldocument.library.ss.util.ColorUtil;
...
{/**
    ...
    public com.example.alldocument.library.ss.model.table.SSTableStyle getTableStyle(String tableName, Map<String, Integer> schemeColor)
    {
    	try
    	{
...
//          tableName = m.replaceAll("").trim();
     ...
     * @return
     */
    private com.example.alldocument.library.ss.model.table.SSTableStyle getTableStyleLight1_7(int schemeColor)
    {
        if(tableStyleLight1_7 == null)
        {
            tableStyleLight1_7 = new com.example.alldocument.library.ss.model.table.SSTableStyle();
            //first row, last row
     ...
     * @return
     */
    private com.example.alldocument.library.ss.model.table.SSTableStyle getTableStyleLight8_14(int schemeColor)
    {
        if(tableStyleLight8_14 == null)
        {
            tableStyleLight8_14 = new com.example.alldocument.library.ss.model.table.SSTableStyle();
            //first row
     ...
     * @return
     */
    private com.example.alldocument.library.ss.model.table.SSTableStyle getTableStyleLight15_21(int schemeColor)
    {
        if(tableStyleLight15_21 == null)
        {
            tableStyleLight15_21 = new com.example.alldocument.library.ss.model.table.SSTableStyle();
            //first row, last row
            SSTableCellStyle cellstyle = new SSTableCellStyle(0xFFFFFFFF);
            cellstyle.setBorderColor(schemeColor);
     ...
     * @return
     */
    private com.example.alldocument.library.ss.model.table.SSTableStyle getTableStyleMedium1_7(int schemeColor)
    {
        if(tableStyleMedium1_7 == null)
        {
            tableStyleMedium1_7 = new com.example.alldocument.library.ss.model.table.SSTableStyle();
            //header row
            SSTableCellStyle cellstyle = new SSTableCellStyle(schemeColor);
            cellstyle.setFontColor(0xFFFFFFFF);
            cellstyle.setBorderColor(schemeColor);
     ...
     * @return
     */
    private com.example.alldocument.library.ss.model.table.SSTableStyle getTableStyleMedium8_14(int schemeColor)
    {
        if(tableStyleMedium8_14 == null)
        {
            tableStyleMedium8_14 = new com.example.alldocument.library.ss.model.table.SSTableStyle();
     ...
     * @return
     */
    private com.example.alldocument.library.ss.model.table.SSTableStyle getTableStyleMedium15_21(int schemeColor)
    {
        if(tableStyleMedium15_21 == null)
        {
            tableStyleMedium15_21 = new com.example.alldocument.library.ss.model.table.SSTableStyle();
    ...
    private com.example.alldocument.library.ss.model.table.SSTableStyle getTableStyleMedium22_28(int schemeColor)
    {
        if(tableStyleMedium22_28 == null)
        {
            tableStyleMedium22_28 = new com.example.alldocument.library.ss.model.table.SSTableStyle();
    ...
    private com.example.alldocument.library.ss.model.table.SSTableStyle getTableStyleDark1_7(int schemeColor)
    {
        if(tableStyleDark1_7 == null)
        {
            tableStyleDark1_7 = new com.example.alldocument.library.ss.model.table.SSTableStyle();
            //first row
     ...
     * @return
     */
    private com.example.alldocument.library.ss.model.table.SSTableStyle getTableStyleDark8()
    {
        if(tableStyleDark8 == null)
        {
            tableStyleDark8 = new com.example.alldocument.library.ss.model.table.SSTableStyle();
            //first row
            SSTableCellStyle cellstyle = new SSTableCellStyle(0xFF000000);
            cellstyle.setFontColor(0xFFFFFFFF);
     ...
     * @return
     */
    private com.example.alldocument.library.ss.model.table.SSTableStyle getTableStyleDark9_11(int headerColor, int bodyColor)
    {
        if(tableStyleDark9_11 == null)
        {
            tableStyleDark9_11 = new com.example.alldocument.library.ss.model.table.SSTableStyle();
            //first row
     ...
     * light table style
     */
    private com.example.alldocument.library.ss.model.table.SSTableStyle tableStyleLight1_7;
    private com.example.alldocument.library.ss.model.table.SSTableStyle tableStyleLight8_14;
    private com.example.alldocument.library.ss.model.table.SSTableStyle tableStyleLight15_21;
    /**
     * medium table style
     */
    private com.example.alldocument.library.ss.model.table.SSTableStyle tableStyleMedium1_7;
    private com.example.alldocument.library.ss.model.table.SSTableStyle tableStyleMedium8_14;
    private com.example.alldocument.library.ss.model.table.SSTableStyle tableStyleMedium15_21;
    private com.example.alldocument.library.ss.model.table.SSTableStyle tableStyleMedium22_28;
    /**
     * dark table style
     */
    private com.example.alldocument.library.ss.model.table.SSTableStyle tableStyleDark1_7;
    private com.example.alldocument.library.ss.model.table.SSTableStyle tableStyleDark8;
