...
public final class NPOIFSDocument{
   ...
   private com.example.alldocument.library.fc.poifs.filesystem.NPOIFSStream _stream;
      ...
      throws IOException
   {
      ...
      if(property.getSize() < POIFSConstants.BIG_BLOCK_MINIMUM_DOCUMENT_SIZE) {
         _stream = new com.example.alldocument.library.fc.poifs.filesystem.NPOIFSStream(_filesystem.getMiniStore(), property.getStartBlock());
         _block_size = _filesystem.getMiniStore().getBlockStoreBlockSize();
      } else {
         _stream = new com.example.alldocument.library.fc.poifs.filesystem.NPOIFSStream(_filesystem, property.getStartBlock());
      ...
      throws IOException 
   {
      ...
      if(contents.length <= POIFSConstants.BIG_BLOCK_MINIMUM_DOCUMENT_SIZE) {
         _stream = new com.example.alldocument.library.fc.poifs.filesystem.NPOIFSStream(filesystem.getMiniStore());
         _block_size = _filesystem.getMiniStore().getBlockStoreBlockSize();
      } else {
