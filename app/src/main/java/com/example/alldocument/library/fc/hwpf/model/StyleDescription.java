...
import com.example.alldocument.library.fc.hwpf.model.HDFType;
import com.example.alldocument.library.fc.hwpf.model.UPX;
...
public final class StyleDescription implements HDFType
{
  ...
  com.example.alldocument.library.fc.hwpf.model.UPX[] _upxs;
  String _name;
...
//      _chp = new CharacterProperties();
  ...
  public StyleDescription(byte[] std, int baseLength, int offset, boolean word9)
  {
     ...
     int nameStart = offset + baseLength;
      ...
      _upxs = new com.example.alldocument.library.fc.hwpf.model.UPX[numUPX];
