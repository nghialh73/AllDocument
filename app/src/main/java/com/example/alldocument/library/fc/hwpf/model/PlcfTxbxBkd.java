...
import com.example.alldocument.library.fc.hwpf.model.Tbkd;
...
public class PlcfTxbxBkd 
{
	...
	{
		int tbkdSize = com.example.alldocument.library.fc.hwpf.model.Tbkd.getSize();
		
		int tbkdCnt = (length - 4) / (tbkdSize + 4);
		int CPCnt = (length - tbkdCnt * tbkdSize) / 4;
		
		CPs = new int[CPCnt];		
		tbkds = new com.example.alldocument.library.fc.hwpf.model.Tbkd[tbkdCnt];
		...
		{			
			tbkds[i] = new com.example.alldocument.library.fc.hwpf.model.Tbkd(data, offset);
			offset += tbkdSize;
		}
	}
	...
	public com.example.alldocument.library.fc.hwpf.model.Tbkd[] getTbkds()
	{
		return tbkds;
	}
