...
package com.example.alldocument.library.fc.ss.usermodel.charts;

import com.example.alldocument.library.fc.ss.usermodel.charts.LayoutMode;
import com.example.alldocument.library.fc.ss.usermodel.charts.LayoutTarget;
...
public interface ManualLayout {
	 ...
	 */
	public void setTarget(com.example.alldocument.library.fc.ss.usermodel.charts.LayoutTarget target);
	 ...
	 */
	public void setXMode(com.example.alldocument.library.fc.ss.usermodel.charts.LayoutMode mode);

	/**
	 * Returns current x-coordinnate layout mode.
	 * @return current x-coordinate layout mode.
	 */
	public com.example.alldocument.library.fc.ss.usermodel.charts.LayoutMode getXMode();

	/**
	 * Sets the y-coordinate layout mode.
	 * @param mode new y-coordinate layout mode.
	 */
	public void setYMode(com.example.alldocument.library.fc.ss.usermodel.charts.LayoutMode mode);

	/**
	 * Returns current y-coordinate layout mode.
	 * @return current y-coordinate layout mode.
	 */
	public com.example.alldocument.library.fc.ss.usermodel.charts.LayoutMode getYMode();
	 ...
	 */
	public void setWidthMode(com.example.alldocument.library.fc.ss.usermodel.charts.LayoutMode mode);
	 ...
	 */
	public com.example.alldocument.library.fc.ss.usermodel.charts.LayoutMode getWidthMode();
	 ...
	 */
	public void setHeightMode(com.example.alldocument.library.fc.ss.usermodel.charts.LayoutMode mode);
