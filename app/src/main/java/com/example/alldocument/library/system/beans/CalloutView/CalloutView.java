package com.example.alldocument.library.system.beans.CalloutView;

import java.util.List;

import com.example.alldocument.library.constant.MainConstant;
import com.example.alldocument.library.system.IControl;
import com.example.alldocument.library.system.beans.CalloutView.CalloutManager;
import com.example.alldocument.library.system.beans.CalloutView.IExportListener;
import com.example.alldocument.library.system.beans.CalloutView.MyPaint;
import com.example.alldocument.library.system.beans.CalloutView.PathInfo;
...
public class CalloutView extends View {
	...
	private List<com.example.alldocument.library.system.beans.CalloutView.PathInfo> mPathList = null;
	private com.example.alldocument.library.system.beans.CalloutView.PathInfo mPathInfo = null;
	...
	public void onDraw(Canvas canvas) {
		...
		if (mPathList != null) {
			for (int i = 0; i < mPathList.size(); i++) {
				com.example.alldocument.library.system.beans.CalloutView.PathInfo pathInfo = mPathList.get(i);
				com.example.alldocument.library.system.beans.CalloutView.MyPaint paint = new com.example.alldocument.library.system.beans.CalloutView.MyPaint();
	...
	private void touch_start(float x, float y) {
		...
		if (calloutMgr.getDrawingMode() == MainConstant.DRAWMODE_CALLOUTDRAW) {
			mPathInfo = new com.example.alldocument.library.system.beans.CalloutView.PathInfo();
