...
public class TableView extends ParagraphView
{
    ...
    public void draw(Canvas canvas, int originX, int originY, float zoom)
    {
        ...
        com.example.alldocument.library.wp.view.RowView row  = (com.example.alldocument.library.wp.view.RowView)getChildView();
        ...
        while (row != null)
        {
            ...
            if (row.intersection(clip, (int)tX, (int)tY, zoom))
            {
                ...
                com.example.alldocument.library.wp.view.CellView cell = (com.example.alldocument.library.wp.view.CellView)row.getChildView();
                float cX = 0;
                float cY = 0;
                float cW = 0;
                float cH = 0;
                ...
                while (cell != null)
                {
                    ...
                    {                        
                        ...
                        {
                            cell = (com.example.alldocument.library.wp.view.CellView)cell.getNextView();
                            isFirstCell = true;
                            continue;
                        }                         
