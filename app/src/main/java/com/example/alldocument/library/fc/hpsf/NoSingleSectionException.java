...
/**
 * <p>This exception is thrown if one of the {@link com.example.alldocument.library.fc.hpsf.PropertySet}'s
 * convenience methods that require a single {@link com.example.alldocument.library.fc.hpsf.Section} is called
