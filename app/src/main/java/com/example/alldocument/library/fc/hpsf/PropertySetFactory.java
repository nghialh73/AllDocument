 ...
 * {@link DocumentSummaryInformation} and {@link com.example.alldocument.library.fc.hpsf.PropertySet}.</p>
 *
...
public class PropertySetFactory
{
    ...
    /**
     * <p>Creates the most specific {@link com.example.alldocument.library.fc.hpsf.PropertySet} from an {@link
     ...
     * @return The created {@link com.example.alldocument.library.fc.hpsf.PropertySet}.
     ...
     * supported.
     */
    public static com.example.alldocument.library.fc.hpsf.PropertySet create(final InputStream stream)
        throws NoPropertySetStreamException, MarkUnsupportedException,
               UnsupportedEncodingException, IOException
    {
        final com.example.alldocument.library.fc.hpsf.PropertySet ps = new PropertySet(stream);
        try
        {
    ...
    {
        final com.example.alldocument.library.fc.hpsf.MutablePropertySet ps = new com.example.alldocument.library.fc.hpsf.MutablePropertySet();
        final com.example.alldocument.library.fc.hpsf.MutableSection s = (com.example.alldocument.library.fc.hpsf.MutableSection) ps.getFirstSection();
        s.setFormatID(com.example.alldocument.library.fc.hpsf.SectionIDMap.SUMMARY_INFORMATION_ID);
        try
        {
            return new SummaryInformation(ps);
        }
    ...
    {
        final com.example.alldocument.library.fc.hpsf.MutablePropertySet ps = new MutablePropertySet();
        final com.example.alldocument.library.fc.hpsf.MutableSection s = (MutableSection) ps.getFirstSection();
