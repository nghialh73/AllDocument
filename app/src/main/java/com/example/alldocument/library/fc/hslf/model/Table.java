...
import com.example.alldocument.library.fc.hslf.model.TableCell;
...
public final class Table extends ShapeGroup
{
    ...
    protected com.example.alldocument.library.fc.hslf.model.Line[] borders;
    /**
     ...
     */
    public Table(EscherContainerRecord escherRecord, com.example.alldocument.library.fc.hslf.model.Shape parent)
    {
    ...
    protected void afterInsert(com.example.alldocument.library.fc.hslf.model.Sheet sh)
    {
        ...
        for (int i = 0; i < cells.length; i++)
        {
            ...
            for (int j = 0; j < cells[i].length; j++)
            {
                ...
                com.example.alldocument.library.fc.hslf.model.Line bt = c.getBorderTop();
                if (bt != null)
                    addShape(bt);

                com.example.alldocument.library.fc.hslf.model.Line br = c.getBorderRight();
                if (br != null)
                    addShape(br);

                com.example.alldocument.library.fc.hslf.model.Line bb = c.getBorderBottom();
                if (bb != null)
                    addShape(bb);

                com.example.alldocument.library.fc.hslf.model.Line bl = c.getBorderLeft();
                if (bl != null)
                    addShape(bl);
    ...
    {
        com.example.alldocument.library.fc.hslf.model.Shape[] sh = getShapes();
        Arrays.sort(sh, new Comparator()
        {
            public int compare(Object o1, Object o2)
            {
                Rectangle anchor1 = ((com.example.alldocument.library.fc.hslf.model.Shape)o1).getAnchor();
        ...
        for (int i = 0; i < sh.length; i++)
        {
            ...
            else if(sh[i] instanceof com.example.alldocument.library.fc.hslf.model.Line)
            {
                lineList.add(sh[i]);
            }
        }
        ...
        //table borders
        borders = new com.example.alldocument.library.fc.hslf.model.Line[lineList.size()];
        for(int i = 0; i < lineList.size(); i++)
        {
            borders[i] = (com.example.alldocument.library.fc.hslf.model.Line)lineList.get(i);
        }
    }
     ...
     * @return
     */
    public com.example.alldocument.library.fc.hslf.model.Line[] getTableBorders()
    {
        return borders;
    }
     ...
     */
    public void setAllBorders(com.example.alldocument.library.fc.hslf.model.Line line)
    {
        for (int i = 0; i < cells.length; i++)
        {
            for (int j = 0; j < cells[i].length; j++)
     ...
     * @param line the border line
     */
    public void setOutsideBorders(com.example.alldocument.library.fc.hslf.model.Line line)
    {
        for (int i = 0; i < cells.length; i++)
        {
            for (int j = 0; j < cells[i].length; j++)
     ...
     * @param line the border line
     */
    public void setInsideBorders(com.example.alldocument.library.fc.hslf.model.Line line)
    {
        for (int i = 0; i < cells.length; i++)
        {
            for (int j = 0; j < cells[i].length; j++)
    ...
    private com.example.alldocument.library.fc.hslf.model.Line cloneBorder(com.example.alldocument.library.fc.hslf.model.Line line)
    {
        com.example.alldocument.library.fc.hslf.model.Line border = createBorder();
     ...
     */
    public com.example.alldocument.library.fc.hslf.model.Line createBorder()
    {
        com.example.alldocument.library.fc.hslf.model.Line line = new Line(this);
