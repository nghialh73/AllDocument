...
import com.example.alldocument.library.java.awt.geom.CubicCurve2D;
 ...
 * another {@link com.example.alldocument.library.java.awt.geom.PathIterator} object.  Other {@link com.example.alldocument.library.fc.hwpf.usermodel.Shape Shape}
 ...
 * @author Jim Graham
 */
public class FlatteningPathIterator implements com.example.alldocument.library.java.awt.geom.PathIterator
{
    static final int GROW_SIZE = 24; // Multiple of cubic & quad curve size

    com.example.alldocument.library.java.awt.geom.PathIterator src; // The source iterator
     ...
     */
    public FlatteningPathIterator(com.example.alldocument.library.java.awt.geom.PathIterator src, double flatness)
    {
     ...
     *		is less than zero
     */
    public FlatteningPathIterator(com.example.alldocument.library.java.awt.geom.PathIterator src, double flatness, int limit)
    {
        if (flatness < 0.0)
        {
     ...
     * iterated over.
     * @see com.example.alldocument.library.java.awt.geom.PathIterator#WIND_EVEN_ODD
     * @see com.example.alldocument.library.java.awt.geom.PathIterator#WIND_NON_ZERO
     */
    ...
    private void next(boolean doNext)
    {
        ...
        switch (holdType)
        {
            ...
            case SEG_QUADTO:
                ...
                while (level < limit)
                {
                    if (com.example.alldocument.library.java.awt.geom.QuadCurve2D.getFlatnessSq(hold, holdIndex) < squareflat)
                    {
                        break;
                    }
            ...
            case SEG_CUBICTO:
                ...
                while (level < limit)
                {
                    if (com.example.alldocument.library.java.awt.geom.CubicCurve2D.getFlatnessSq(hold, holdIndex) < squareflat)
                    {
                        break;
                    }
     ...
     *		returned.
     * @see com.example.alldocument.library.java.awt.geom.PathIterator#SEG_MOVETO
     * @see com.example.alldocument.library.java.awt.geom.PathIterator#SEG_LINETO
     * @see com.example.alldocument.library.java.awt.geom.PathIterator#SEG_CLOSE
     */
