...
public final class MainMaster extends SheetContainer
{
     ...
     */
    public com.example.alldocument.library.fc.hslf.record.SlideAtom getSlideAtom()
    {
        return slideAtom;
    }
     ...
     */
    public com.example.alldocument.library.fc.hslf.record.PPDrawing getPPDrawing()
    {
        return ppDrawing;
    }
    ...
    protected MainMaster(byte[] source, int start, int len)
    {
        ...
        {
            if (_children[i] instanceof com.example.alldocument.library.fc.hslf.record.SlideAtom)
            {
                slideAtom = (com.example.alldocument.library.fc.hslf.record.SlideAtom)_children[i];
            }
            else if (_children[i] instanceof com.example.alldocument.library.fc.hslf.record.PPDrawing)
            {
                ppDrawing = (com.example.alldocument.library.fc.hslf.record.PPDrawing)_children[i];
            }
