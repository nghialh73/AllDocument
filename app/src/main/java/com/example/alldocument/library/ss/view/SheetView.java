...
import com.example.alldocument.library.common.picture.PictureKit;
...
import com.example.alldocument.library.ss.control.Spreadsheet;
...
import com.example.alldocument.library.ss.model.sheetProperty.ColumnInfo;
...
import com.example.alldocument.library.ss.other.ExpandedCellRangeAddress;
import com.example.alldocument.library.ss.other.FindingMgr;
import com.example.alldocument.library.ss.other.FocusCell;
import com.example.alldocument.library.ss.other.SheetScroller;
import com.example.alldocument.library.ss.util.ModelUtil;
import com.example.alldocument.library.ss.view.CellView;
import com.example.alldocument.library.ss.view.ColumnHeader;
import com.example.alldocument.library.ss.view.RowHeader;
import com.example.alldocument.library.ss.view.ShapeView;
import com.example.alldocument.library.ss.view.TableFormatView;
...
{   
    ...
    public SheetView(Spreadsheet spreadsheet, Sheet sheet)
    {
        ...
        this.sheet = sheet;
        rowHeader = new com.example.alldocument.library.ss.view.RowHeader(this);
        columnHeader = new ColumnHeader(this);
        
       
        shapeView = new com.example.alldocument.library.ss.view.ShapeView(this);
        tableFormatView = new TableFormatView(this);
        cellView = new com.example.alldocument.library.ss.view.CellView(this);
    ...
    private void initRowExtendedRangeAddress(Row row)
    {
        ...
        for(Cell cell : cells)
        {
            ...
            if(com.example.alldocument.library.ss.view.CellView.isComplexText(cell))
            {
...
//                }
     ...
     */
    public com.example.alldocument.library.ss.view.RowHeader getRowHeader()
    {
        return rowHeader;
    }
