...
import com.example.alldocument.library.simpletext.view.AbstractView;
import com.example.alldocument.library.simpletext.view.CharAttr;
...
import com.example.alldocument.library.wp.control.WPShapeManage;
...
public class LineView extends AbstractView/* implements IMemObj*/
{
     ...
     * @param span
     */
    public void layoutAlignment(DocAttr docAttr, PageAttr pageAttr, ParaAttr paraAttr, com.example.alldocument.library.wp.view.BNView bnView, int span, int flag)
    {
     ...
     * @param span
     */
    public void layoutAlignment(DocAttr docAttr, PageAttr pageAttr, ParaAttr paraAttr, com.example.alldocument.library.wp.view.BNView bnView, int span, int flag, boolean isLayoutVertical)
    {
        // 水平
     ...
     * @param flag      布局标记
     */
    public void layoutHorizontal(DocAttr docAttr, PageAttr pageAttr, ParaAttr paraAttr, com.example.alldocument.library.wp.view.BNView bnView, int span, int flag)
    {
        // 水平对齐
    ...
    {
        com.example.alldocument.library.wp.view.LeafView leaf = (com.example.alldocument.library.wp.view.LeafView)getChildView();
        if (leaf == null)
        {
            return;
        }
        ...
        while (leaf != null)
        {
            ...
            leaf = (com.example.alldocument.library.wp.view.LeafView)leaf.getNextView();
        }
        // 基线对齐
        leaf = (com.example.alldocument.library.wp.view.LeafView)getChildView();
        while (leaf != null)
        {
