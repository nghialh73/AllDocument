...
import com.example.alldocument.library.common.pictureefftect.PictureStretchInfo;
import com.example.alldocument.library.fc.ShaderKit;
...
public class BackgroundReader
{
        ...
        PackagePart packagePart, PGMaster master, Element bg) throws Exception
    {
        if (bg != null)
        {
            ...
            { 
                ...
                bgFill.setForegroundColor(com.example.alldocument.library.fc.ppt.reader.ReaderKit.instance().getColor(master, bgRef));
                return bgFill;
            }
            else
            {
        ...
        PGMaster master, Element bgPr, boolean isTableStyle) throws Exception
    {
        if (bgPr != null)
        {
            ...
            {
                bgFill.setFillType(BackgroundAndFill.FILL_SOLID);
                bgFill.setForegroundColor(com.example.alldocument.library.fc.ppt.reader.ReaderKit.instance().getColor(master, fill, isTableStyle));
                return bgFill;
            }
            // picture
            ...
            {
                bgFill.setFillType(BackgroundAndFill.FILL_SOLID);
                bgFill.setForegroundColor(com.example.alldocument.library.fc.ppt.reader.ReaderKit.instance().getColor(master, fill));
                return bgFill;
            }
            else if ((fill = bgPr.element("pattFill")) != null)
            {
                ...
                {
                    bgFill.setFillType(BackgroundAndFill.FILL_SOLID);
                    bgFill.setForegroundColor(com.example.alldocument.library.fc.ppt.reader.ReaderKit.instance().getColor(master, bgClr));
                    return bgFill;
                }
            }
        }
        ...
        PGMaster master, Element bgPr, boolean isTableStyle) throws Exception
    {
        if (bgPr != null)
        {
            ...
            if (fill != null)
            {
                return com.example.alldocument.library.fc.ppt.reader.ReaderKit.instance().getColor(master, fill, isTableStyle);
            }
            else if ((fill = bgPr.element("gradFill")) != null)
            {
                Element gsLst = fill.element("gsLst");
                if (gsLst != null)
                {
                    return com.example.alldocument.library.fc.ppt.reader.ReaderKit.instance().getColor(master, gsLst.element("gs"));
                }
            }
            else if ((fill = bgPr.element("fillRef")) != null)
            {
                return com.example.alldocument.library.fc.ppt.reader.ReaderKit.instance().getColor(master, fill);
            }
            else if ((fill = bgPr.element("pattFill")) != null)
            {
                Element bgClr = fill.element("bgClr");
