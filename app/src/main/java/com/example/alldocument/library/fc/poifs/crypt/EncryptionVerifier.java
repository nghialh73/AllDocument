...
==================================================================== */
package com.example.alldocument.library.fc.poifs.crypt;
...
import com.example.alldocument.library.fc.codec.Base64;
import com.example.alldocument.library.fc.poifs.crypt.EncryptionHeader;
...
public class EncryptionVerifier {
    ...
    public EncryptionVerifier(String descriptor) {
        ...
        if ("AES".equals(alg)) {
            if (blockSize == 16)
                algorithm = com.example.alldocument.library.fc.poifs.crypt.EncryptionHeader.ALGORITHM_AES_128;
            else if (blockSize == 24)
                algorithm = com.example.alldocument.library.fc.poifs.crypt.EncryptionHeader.ALGORITHM_AES_192;
            else if (blockSize == 32)
                algorithm = com.example.alldocument.library.fc.poifs.crypt.EncryptionHeader.ALGORITHM_AES_256;
            else
        ...
        if ("ChainingModeCBC".equals(chain))
            cipherMode = com.example.alldocument.library.fc.poifs.crypt.EncryptionHeader.MODE_CBC;
        else if ("ChainingModeCFB".equals(chain))
            cipherMode = com.example.alldocument.library.fc.poifs.crypt.EncryptionHeader.MODE_CFB;
        else
