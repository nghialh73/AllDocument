...
public class APageListAdapter extends BaseAdapter
{
     ...
     * @param pdfListView
     */
    public APageListAdapter(com.example.alldocument.library.system.beans.pagelist.APageListView view)
    {
        this.listView = view;
    }
    ...
    {
        com.example.alldocument.library.system.beans.pagelist.APageListItem pageItem = (com.example.alldocument.library.system.beans.pagelist.APageListItem)convertView;
