...
import com.example.alldocument.library.fc.hssf.formula.function.FinanceLib;
import com.example.alldocument.library.fc.hssf.formula.function.Function;
import com.example.alldocument.library.fc.hssf.formula.function.Function3Arg;
import com.example.alldocument.library.fc.hssf.formula.function.Function4Arg;
...
public abstract class FinanceFunction implements Function3Arg, Function4Arg {
	...
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function FV = new FinanceFunction() {
		protected double evaluate(double rate, double arg1, double arg2, double arg3, boolean type) {
			return com.example.alldocument.library.fc.hssf.formula.function.FinanceLib.fv(rate, arg1, arg2, arg3, type);
		}
	};
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function NPER = new FinanceFunction() {
		protected double evaluate(double rate, double arg1, double arg2, double arg3, boolean type) {
			return com.example.alldocument.library.fc.hssf.formula.function.FinanceLib.nper(rate, arg1, arg2, arg3, type);
		}
	};
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function PMT = new FinanceFunction() {
		protected double evaluate(double rate, double arg1, double arg2, double arg3, boolean type) {
			return com.example.alldocument.library.fc.hssf.formula.function.FinanceLib.pmt(rate, arg1, arg2, arg3, type);
		}
	};
