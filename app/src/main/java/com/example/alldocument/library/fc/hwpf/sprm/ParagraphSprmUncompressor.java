...
public final class ParagraphSprmUncompressor extends SprmUncompressor
{
        ...
        int offset)
    {
        ...
        com.example.alldocument.library.fc.hwpf.sprm.SprmIterator sprmIt = new SprmIterator(grpprl, offset);
        ...
        while (sprmIt.hasNext())
        {
            ...
            // table row
            if (sprm.getType() == com.example.alldocument.library.fc.hwpf.sprm.SprmOperation.TYPE_PAP)
            {
                try
                {
     ...
     */
    static void unCompressPAPOperation(ParagraphProperties newPAP, com.example.alldocument.library.fc.hwpf.sprm.SprmOperation sprm)
    {
