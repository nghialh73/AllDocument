 ...
 * <p>
 */
public class FadeAnimation extends com.example.alldocument.library.pg.animate.Animation
{
    ...
    private void fadeIn(int time)
    {
        ...
        {
            status = com.example.alldocument.library.pg.animate.Animation.AnimStatus_End;
            current.setProgress(1f);
            current.setAlpha(255);
