 ...
 * 时间:              下午3:38:25
 */
package com.example.alldocument.library.common.autoshape.pathbuilder.starAndBanner.star;
...
public class LaterStarPathBuilder
{
    ...
    private static Path getStar4Path(AutoShape shape, Rect rect)
    {
        ...
        Path path = com.example.alldocument.library.common.autoshape.pathbuilder.starAndBanner.star.StarPathBuilder.getStarPath((int)outA, (int)outB, (int)a, (int)b, 4);
    ...
    private static Path getStar5Path(AutoShape shape, Rect rect)
    {
        ...
        Path path = com.example.alldocument.library.common.autoshape.pathbuilder.starAndBanner.star.StarPathBuilder.getStarPath((int)outA, (int)outB, (int)a, (int)b, 5);
    ...
    private static Path getStar6Path(AutoShape shape, Rect rect)
    {
        ...
        Path path = com.example.alldocument.library.common.autoshape.pathbuilder.starAndBanner.star.StarPathBuilder.getStarPath((int)outA, (int)outB, (int)a, (int)b, 6);
    ...
    private static Path getStar7Path(AutoShape shape, Rect rect)
    {
        ...
        Path path = com.example.alldocument.library.common.autoshape.pathbuilder.starAndBanner.star.StarPathBuilder.getStarPath((int)outA, (int)outB, (int)a, (int)b, 7);
    ...
    private static Path getStar8Path(AutoShape shape, Rect rect)
    {
        ...
        Path path = com.example.alldocument.library.common.autoshape.pathbuilder.starAndBanner.star.StarPathBuilder.getStarPath((int)outA, (int)outB, (int)a, (int)b, 8);
    ...
    private static Path getStar10Path(AutoShape shape, Rect rect)
    {
        ...
        Path path = com.example.alldocument.library.common.autoshape.pathbuilder.starAndBanner.star.StarPathBuilder.getStarPath((int)width / 2, (int)height / 2, (int)a, (int)b, 10);
    ...
    private static Path getStar12Path(AutoShape shape, Rect rect)
    {
        ...
        Path path = com.example.alldocument.library.common.autoshape.pathbuilder.starAndBanner.star.StarPathBuilder.getStarPath((int)width / 2, (int)height / 2, (int)a, (int)b, 12);
    ...
    private static Path getStar16Path(AutoShape shape, Rect rect)
    {
        ...
        Path path = com.example.alldocument.library.common.autoshape.pathbuilder.starAndBanner.star.StarPathBuilder.getStarPath((int)width / 2, (int)height / 2, (int)a, (int)b, 16);
    ...
    private static Path getStar24Path(AutoShape shape, Rect rect)
    {
        ...
        Path path = com.example.alldocument.library.common.autoshape.pathbuilder.starAndBanner.star.StarPathBuilder.getStarPath((int)width / 2, (int)height / 2, (int)a, (int)b, 24);
