...
public final class PercentEval extends Fixed1ArgFunction {
	...
	public com.example.alldocument.library.fc.hssf.formula.eval.ValueEval evaluate(int srcRowIndex, int srcColumnIndex, com.example.alldocument.library.fc.hssf.formula.eval.ValueEval arg0) {
		double d;
		try {
