 ...
 */
package com.example.alldocument.library.thirdpart.achartengine.chart;

import java.util.List;

import com.example.alldocument.library.thirdpart.achartengine.chart.BubbleChart;
import com.example.alldocument.library.thirdpart.achartengine.chart.ColumnBarChart;
import com.example.alldocument.library.thirdpart.achartengine.chart.LineChart;
import com.example.alldocument.library.thirdpart.achartengine.chart.RangeBarChart;
import com.example.alldocument.library.thirdpart.achartengine.chart.ScatterChart;
import com.example.alldocument.library.thirdpart.achartengine.chart.TimeChart;
...
import com.example.alldocument.library.thirdpart.achartengine.renderers.XYMultipleSeriesRenderer.Orientation;
 ...
 */
public class CombinedXYChart extends com.example.alldocument.library.thirdpart.achartengine.chart.XYChart {
  /** The embedded XY charts. */
  private com.example.alldocument.library.thirdpart.achartengine.chart.XYChart[] mCharts;
  /** The supported charts for being combined. */
  private Class[] xyChartTypes = new Class[] { TimeChart.class, com.example.alldocument.library.thirdpart.achartengine.chart.LineChart.class, ColumnBarChart.class,
  ...
  public CombinedXYChart(XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer,
    ...
    mCharts = new com.example.alldocument.library.thirdpart.achartengine.chart.XYChart[length];
  ...
  private com.example.alldocument.library.thirdpart.achartengine.chart.XYChart getXYChart(String type) throws IllegalAccessException, InstantiationException {
    com.example.alldocument.library.thirdpart.achartengine.chart.XYChart chart = null;
    int length = xyChartTypes.length;
    for (int i = 0; i < length && chart == null; i++) {
      com.example.alldocument.library.thirdpart.achartengine.chart.XYChart newChart = (XYChart) xyChartTypes[i].newInstance();
