...
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.Big5Statistics;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.EUCJPStatistics;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.EUCKRStatistics;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.EUCTWStatistics;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.GB2312Statistics;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsBIG5Verifier;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsCP1252Verifier;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsEUCJPVerifier;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsEUCKRVerifier;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsEUCSampler;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsEUCStatistics;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsEUCTWVerifier;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsGB18030Verifier;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsGB2312Verifier;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsHZVerifier;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsISO2022CNVerifier;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsISO2022JPVerifier;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsISO2022KRVerifier;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsSJISVerifier;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsUCS2BEVerifier;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsUCS2LEVerifier;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsUTF8Verifier;
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsVerifier;
...
public abstract class nsPSMDetector
{
    ...
    com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsVerifier[] mVerifier;
    nsEUCStatistics[] mStatisticsData;

    com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsEUCSampler mSampler = new nsEUCSampler();
    ...
    public nsPSMDetector(int aItems, com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsVerifier[] aVerifierSet, nsEUCStatistics[] aStatisticsSet)
    {
    ...
    protected void initVerifiers(int currVerSet)
    {
        ...
        if (currVerifierSet == nsPSMDetector.TRADITIONAL_CHINESE)
        {
            ...
            mVerifier = new com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsVerifier[]{new nsUTF8Verifier(), new nsBIG5Verifier(),
        ...
        else if (currVerifierSet == nsPSMDetector.KOREAN)
        {
            ...
            mVerifier = new com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsVerifier[]{new nsUTF8Verifier(), new nsEUCKRVerifier(),
        ...
        else if (currVerifierSet == nsPSMDetector.SIMPLIFIED_CHINESE)
        {
            ...
            mVerifier = new com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsVerifier[]{new nsUTF8Verifier(), new nsGB2312Verifier(),
                new nsGB18030Verifier(), new nsISO2022CNVerifier(), new com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsHZVerifier(),
        ...
        {
            mVerifier = new com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsVerifier[]{new nsUTF8Verifier(), new nsSJISVerifier(),
        ...
        else if (currVerifierSet == nsPSMDetector.CHINESE)
        {
            ...
            mVerifier = new com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsVerifier[]{new nsUTF8Verifier(), new nsGB2312Verifier(),
                ...
                new com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsHZVerifier(), new nsEUCTWVerifier(), new nsCP1252Verifier(),
                new nsUCS2BEVerifier(), new nsUCS2LEVerifier()};
    ...
    public boolean HandleData(byte[] aBuf, int len)
    {
        ...
        for (i = 0; i < len; i++)
        {
            ...
            for (j = 0; j < mItems;)
            {
                st = com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsVerifier.getNextState(mVerifier[mItemIdx[j]], b, mState[j]);
                if (st == com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsVerifier.eItsMe)
                {
