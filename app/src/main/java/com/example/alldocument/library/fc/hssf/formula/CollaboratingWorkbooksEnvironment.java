...
/**
 * Manages a collection of {@link com.example.alldocument.library.fc.hssf.formula.WorkbookEvaluator}s, in order to support evaluation of formulas
...
public final class CollaboratingWorkbooksEnvironment {
	...
	private final Map<String, com.example.alldocument.library.fc.hssf.formula.WorkbookEvaluator> _evaluatorsByName;
	private final com.example.alldocument.library.fc.hssf.formula.WorkbookEvaluator[] _evaluators;

	private boolean _unhooked;
	private CollaboratingWorkbooksEnvironment() {
		_evaluatorsByName = Collections.emptyMap();
		_evaluators = new com.example.alldocument.library.fc.hssf.formula.WorkbookEvaluator[0];
	}
	public static void setup(String[] workbookNames, com.example.alldocument.library.fc.hssf.formula.WorkbookEvaluator[] evaluators) {
	...
	private CollaboratingWorkbooksEnvironment(String[] workbookNames, com.example.alldocument.library.fc.hssf.formula.WorkbookEvaluator[] evaluators, int nItems) {
		Map<String, com.example.alldocument.library.fc.hssf.formula.WorkbookEvaluator> m = new HashMap<String, com.example.alldocument.library.fc.hssf.formula.WorkbookEvaluator>(nItems * 3 / 2);
		IdentityHashMap<com.example.alldocument.library.fc.hssf.formula.WorkbookEvaluator, String> uniqueEvals = new IdentityHashMap<com.example.alldocument.library.fc.hssf.formula.WorkbookEvaluator, String>(nItems * 3 / 2);
		for(int i=0; i<nItems; i++) {
			String wbName = workbookNames[i];
			com.example.alldocument.library.fc.hssf.formula.WorkbookEvaluator wbEval = evaluators[i];
	...
	private static void hookNewEnvironment(com.example.alldocument.library.fc.hssf.formula.WorkbookEvaluator[] evaluators, CollaboratingWorkbooksEnvironment env) {
		...
		com.example.alldocument.library.fc.hssf.formula.IEvaluationListener evalListener = evaluators[0].getEvaluationListener();
		...
		com.example.alldocument.library.fc.hssf.formula.EvaluationCache cache = new com.example.alldocument.library.fc.hssf.formula.EvaluationCache(evalListener);
	 ...
	 */
	private void unhookOldEnvironments(com.example.alldocument.library.fc.hssf.formula.WorkbookEvaluator[] evaluators) {
	...
	public com.example.alldocument.library.fc.hssf.formula.WorkbookEvaluator getWorkbookEvaluator(String workbookName) throws WorkbookNotFoundException {
		if (_unhooked) {
