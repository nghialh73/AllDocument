...
package com.example.alldocument.library.fc.doc;
...
import com.example.alldocument.library.common.bulletnumber.ListLevel;
...
import com.example.alldocument.library.common.shape.WPAbstractShape;
import com.example.alldocument.library.common.shape.WPAutoShape;
import com.example.alldocument.library.common.shape.WPGroupShape;
import com.example.alldocument.library.common.shape.WPPictureShape;
...
import com.example.alldocument.library.fc.hwpf.HWPFDocument;
import com.example.alldocument.library.fc.hwpf.model.FieldsDocumentPart;
import com.example.alldocument.library.fc.hwpf.model.ListFormatOverride;
import com.example.alldocument.library.fc.hwpf.model.ListTables;
import com.example.alldocument.library.fc.hwpf.model.POIListData;
import com.example.alldocument.library.fc.hwpf.model.POIListLevel;
import com.example.alldocument.library.fc.hwpf.model.PicturesTable;
import com.example.alldocument.library.fc.hwpf.usermodel.Bookmarks;
import com.example.alldocument.library.fc.hwpf.usermodel.BorderCode;
import com.example.alldocument.library.fc.hwpf.usermodel.CharacterRun;
import com.example.alldocument.library.fc.hwpf.usermodel.Field;
import com.example.alldocument.library.fc.hwpf.usermodel.HWPFAutoShape;
import com.example.alldocument.library.fc.hwpf.usermodel.HWPFShape;
import com.example.alldocument.library.fc.hwpf.usermodel.HWPFShapeGroup;
import com.example.alldocument.library.fc.hwpf.usermodel.HeaderStories;
import com.example.alldocument.library.fc.hwpf.usermodel.InlineWordArt;
import com.example.alldocument.library.fc.hwpf.usermodel.LineSpacingDescriptor;
import com.example.alldocument.library.fc.hwpf.usermodel.OfficeDrawing;
import com.example.alldocument.library.fc.hwpf.usermodel.OfficeDrawings;
import com.example.alldocument.library.fc.hwpf.usermodel.POIBookmark;
import com.example.alldocument.library.fc.hwpf.usermodel.Paragraph;
import com.example.alldocument.library.fc.hwpf.usermodel.PictureType;
import com.example.alldocument.library.fc.hwpf.usermodel.Range;
import com.example.alldocument.library.fc.hwpf.usermodel.Section;
import com.example.alldocument.library.fc.hwpf.usermodel.Table;
import com.example.alldocument.library.fc.hwpf.usermodel.TableCell;
import com.example.alldocument.library.fc.hwpf.usermodel.TableRow;
import com.example.alldocument.library.fc.util.LittleEndian;
import com.example.alldocument.library.java.awt.Rectangle;
import com.example.alldocument.library.java.util.Arrays;
...
import com.example.alldocument.library.simpletext.view.PageAttr;
...
import com.example.alldocument.library.wp.model.CellElement;
import com.example.alldocument.library.wp.model.HFElement;
import com.example.alldocument.library.wp.model.RowElement;
import com.example.alldocument.library.wp.model.TableElement;
import com.example.alldocument.library.wp.model.WPDocument;
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.example.alldocument.library.java.awt.Color fillColor = shape.getForegroundColor();
            	com.example.alldocument.library.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            // 字符颜色
            com.example.alldocument.library.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            com.example.alldocument.library.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
