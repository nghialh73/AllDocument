...
import com.example.alldocument.library.fc.hslf.model.ShapeFactory;
...
import com.example.alldocument.library.fc.hslf.record.SheetContainer;
...
public abstract class Sheet
{
     ...
     */
    public com.example.alldocument.library.fc.hslf.model.Shape[] getShapes()
    {
        if (_shapes != null)
        {
            return _shapes;
        ...
        List<com.example.alldocument.library.fc.hslf.model.Shape> shapes = new ArrayList<com.example.alldocument.library.fc.hslf.model.Shape>();
        ...
        for (; it.hasNext();)
        {
            ...
            com.example.alldocument.library.fc.hslf.model.Shape sh = ShapeFactory.createShape(sp, null);
            sh.setSheet(this);
            shapes.add(sh);
        }
        _shapes = new com.example.alldocument.library.fc.hslf.model.Shape[shapes.size()];
     ...
     */
    public void addShape(com.example.alldocument.library.fc.hslf.model.Shape shape)
    {
        PPDrawing ppdrawing = getPPDrawing();
     ...
     */
    public boolean removeShape(com.example.alldocument.library.fc.hslf.model.Shape shape)
    {
        PPDrawing ppdrawing = getPPDrawing();
    ...
    {
        com.example.alldocument.library.fc.hslf.model.Shape[] shape = getShapes();
    ...
    public void dispose()
    {
        ...
        if (_shapes != null)
        {
            for (com.example.alldocument.library.fc.hslf.model.Shape sp : _shapes)
            {
                sp.dispose();
            }
            _shapes = null;
