...
import com.example.alldocument.library.fc.poifs.property.Parent;
import com.example.alldocument.library.fc.poifs.property.Property;
import com.example.alldocument.library.fc.poifs.property.PropertyConstants;
 ...
 */
public class DirectoryProperty extends com.example.alldocument.library.fc.poifs.property.Property implements Parent { // TODO - fix instantiable superclass

    /** List of Property instances */
    private List<com.example.alldocument.library.fc.poifs.property.Property> _children;
    ...
    {
        super();
        _children       = new ArrayList<com.example.alldocument.library.fc.poifs.property.Property>();
     ...
     */
    public boolean changeName(com.example.alldocument.library.fc.poifs.property.Property property, String newName)
    {
        boolean result;
     ...
     */
    public boolean deleteChild(com.example.alldocument.library.fc.poifs.property.Property property)
    {
    ...
    public static class PropertyComparator implements Comparator<com.example.alldocument.library.fc.poifs.property.Property> {
         ...
         */
        public int compare(com.example.alldocument.library.fc.poifs.property.Property o1, com.example.alldocument.library.fc.poifs.property.Property o2)
        {
    ...
    protected void preWrite()
    {
        if (_children.size() > 0)
        {
            com.example.alldocument.library.fc.poifs.property.Property[] children = _children.toArray(new com.example.alldocument.library.fc.poifs.property.Property[ 0 ]);
     ...
     */
    public Iterator<com.example.alldocument.library.fc.poifs.property.Property> getChildren()
    {
