...
import com.example.alldocument.library.system.ITimerListener;
import com.example.alldocument.library.system.beans.AEventManage;
import com.example.alldocument.library.system.beans.ATimer;
...
{ 
     ...
     * @param spreadsheet
     */
    public SSEventManage(com.example.alldocument.library.ss.control.Spreadsheet spreadsheet, IControl control)
    {
