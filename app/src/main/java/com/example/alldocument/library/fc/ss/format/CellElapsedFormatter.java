...
public class CellElapsedFormatter extends CellFormatter {
    ...
    private class ElapsedPartHandler implements com.example.alldocument.library.fc.ss.format.CellFormatPart.PartHandler {
        ...
        public String handlePart(Matcher m, String part, com.example.alldocument.library.fc.ss.format.CellFormatType type,
            ...
            case '*':
                if (part.length() > 1)
                    part = com.example.alldocument.library.fc.ss.format.CellFormatPart.expandChar(part);
                break;
