...
public class AnimationManager implements ITimerListener
{
    ...
    public void setAnimation(com.example.alldocument.library.pg.animate.IAnimation animation)
    {
        //stop last animation
    ...
    {
        if(animation != null && animation.getAnimationStatus() != com.example.alldocument.library.pg.animate.Animation.AnimStatus_End)
        {
