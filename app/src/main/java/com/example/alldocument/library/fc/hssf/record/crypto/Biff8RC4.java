 ...
 * {@link com.example.alldocument.library.fc.hssf.record.crypto.RC4} instance is renewed (re-keyed) every 1024 bytes.
 *
 * @author Josh Micich
 */
final class Biff8RC4 {
	...
	private com.example.alldocument.library.fc.hssf.record.crypto.RC4 _rc4;
	/**
	 * This field is used to keep track of when to change the {@link com.example.alldocument.library.fc.hssf.record.crypto.RC4}
	 ...
	 * {@link com.example.alldocument.library.fc.hssf.record.crypto.RC4} instance must step even when unencrypted bytes are read
	 */
