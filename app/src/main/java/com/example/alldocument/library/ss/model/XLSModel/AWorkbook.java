...
import com.example.alldocument.library.fc.xls.SSReader;
...
import com.example.alldocument.library.system.ReaderHandler;
 ...
 * <p>
 */
public class AWorkbook extends Workbook implements com.example.alldocument.library.fc.ss.usermodel.Workbook
{
    ...
    static class ShapesThread extends Thread
    {
        ...
        public void run()
        {
            try
            {
                if(sheetIndex >= 0 && iAbortListener != null)
                {
                    ...
                    ((com.example.alldocument.library.ss.model.XLSModel.ASheet)book.getSheet(sheetIndex)).processSheet(iAbortListener);
        ...
        private void processOtherSheets()
        {
            ...
            while(iter.hasNext())
            {
                ((com.example.alldocument.library.ss.model.XLSModel.ASheet)book.getSheet(iter.next())).processSheet(iAbortListener);
            }
    ...
    public AWorkbook(InputStream s, SSReader iAbortListener) throws IOException
    {
        ...
        {            
            ...
            com.example.alldocument.library.ss.model.XLSModel.ASheet sheet = new com.example.alldocument.library.ss.model.XLSModel.ASheet(this, internalSheet);
    ...
    {        
        com.example.alldocument.library.ss.model.XLSModel.ASheet sheet = (com.example.alldocument.library.ss.model.XLSModel.ASheet)sheets.get(sheetIndex);
        try
        {   
     ...
     * @see LabelRecord
     * @see com.example.alldocument.library.fc.hssf.record.LabelSSTRecord
     * @see com.example.alldocument.library.fc.hssf.record.SSTRecord
     */
  ...
  public UDFFinder getUDFFinder()
  {
    ...
    */
   public com.example.alldocument.library.ss.model.XLSModel.ASheet getSheetAt(int index)
   {
