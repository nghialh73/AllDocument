...
import com.example.alldocument.library.fc.hslf.model.ShapeOutline;
...
public final class AutoShapes
{
     ...
     *
    */
    public static com.example.alldocument.library.java.awt.Shape transform(com.example.alldocument.library.java.awt.Shape outline, Rectangle2D anchor)
    {
    ...
    static
    {
        ...
        {
            public com.example.alldocument.library.java.awt.Shape getOutline(com.example.alldocument.library.fc.hslf.model.Shape shape)
            {
        ...
        {
            public com.example.alldocument.library.java.awt.Shape getOutline(Shape shape)
            {
