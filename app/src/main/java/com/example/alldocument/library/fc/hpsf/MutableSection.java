...
import com.example.alldocument.library.fc.hpsf.ClassID;
...
import com.example.alldocument.library.fc.hpsf.IllegalPropertySetDataException;
import com.example.alldocument.library.fc.hpsf.MutableProperty;
...
import com.example.alldocument.library.fc.hpsf.VariantSupport;
...
/**
 * <p>Adds writing capability to the {@link com.example.alldocument.library.fc.hpsf.Section} class.</p>
 *
 * <p>Please be aware that this class' functionality will be merged into the
 * {@link com.example.alldocument.library.fc.hpsf.Section} class at a later time, so the API will change.</p>
 */
public class MutableSection extends com.example.alldocument.library.fc.hpsf.Section
{
    /**
     ...
     */
    private List<com.example.alldocument.library.fc.hpsf.Property> preprops;
    ...
    public MutableSection()
    {
        ...
        formatID = null;
        offset = -1;
        preprops = new LinkedList<com.example.alldocument.library.fc.hpsf.Property>();
    }
     ...
     */
    public MutableSection(final com.example.alldocument.library.fc.hpsf.Section s)
    {
        setFormatID(s.getFormatID());
        final com.example.alldocument.library.fc.hpsf.Property[] pa = s.getProperties();
     ...
     * @see com.example.alldocument.library.fc.hpsf.Section#getFormatID
     */
    public void setFormatID(final com.example.alldocument.library.fc.hpsf.ClassID formatID)
    {
     ...
     *
     * @see #setFormatID(com.example.alldocument.library.fc.hpsf.ClassID)
     * @see com.example.alldocument.library.fc.hpsf.Section#getFormatID
     */
    public void setFormatID(final byte[] formatID)
    {
        com.example.alldocument.library.fc.hpsf.ClassID fid = getFormatID();
        if (fid == null)
        {
            fid = new ClassID();
            setFormatID(fid);
     ...
     */
    public void setProperties(final com.example.alldocument.library.fc.hpsf.Property[] properties)
    {
    ...
    {
        setProperty(id, com.example.alldocument.library.fc.hpsf.Variant.VT_LPWSTR, value);
        dirty = true;
    }
    ...
    {
        setProperty(id, com.example.alldocument.library.fc.hpsf.Variant.VT_I4, Integer.valueOf(value));
        dirty = true;
    }
    ...
    {
        setProperty(id, com.example.alldocument.library.fc.hpsf.Variant.VT_I8, Long.valueOf(value));
        dirty = true;
    }
    ...
    {
        setProperty(id, com.example.alldocument.library.fc.hpsf.Variant.VT_BOOL, Boolean.valueOf(value));
        dirty = true;
    }
     ...
     * @see com.example.alldocument.library.fc.hpsf.Variant
     */
    public void setProperty(final com.example.alldocument.library.fc.hpsf.Property p)
    {
    ...
    {
        for (final Iterator<com.example.alldocument.library.fc.hpsf.Property> i = preprops.iterator(); i.hasNext();)
            if (i.next().getID() == id)
            {
                i.remove();
                break;
        ...
        throws WritingNotSupportedException, IOException
    {
        ...
        int codepage = -1;
        if (getProperty(com.example.alldocument.library.fc.hpsf.PropertyIDMap.PID_DICTIONARY) != null)
        {
            final Object p1 = getProperty(com.example.alldocument.library.fc.hpsf.PropertyIDMap.PID_CODEPAGE);
            if (p1 != null)
            {
                ...
                setProperty(com.example.alldocument.library.fc.hpsf.PropertyIDMap.PID_CODEPAGE, com.example.alldocument.library.fc.hpsf.Variant.VT_I2,
                            Integer.valueOf(com.example.alldocument.library.fc.hpsf.Constants.CP_UNICODE));
            codepage = getCodepage();
        }

        /* Sort the property list by their property IDs: */
        Collections.sort(preprops, new Comparator<com.example.alldocument.library.fc.hpsf.Property>()
            {
                public int compare(final com.example.alldocument.library.fc.hpsf.Property p1, final com.example.alldocument.library.fc.hpsf.Property p2)
                {
         ...
         * streams: */
        for (final ListIterator<com.example.alldocument.library.fc.hpsf.Property> i = preprops.listIterator(); i.hasNext();)
        {
            final MutableProperty p = (MutableProperty) i.next();
            final long id = p.getID();

            /* Write the property list entry. */
            com.example.alldocument.library.fc.hpsf.TypeWriter.writeUIntToStream(propertyListStream, p.getID());
            com.example.alldocument.library.fc.hpsf.TypeWriter.writeUIntToStream(propertyListStream, position);
        ...
        com.example.alldocument.library.fc.hpsf.TypeWriter.writeToStream(out, LittleEndian.INT_SIZE * 2 +
                                      pb1.length + pb2.length);

        /* Write the section's number of properties: */
        com.example.alldocument.library.fc.hpsf.TypeWriter.writeToStream(out, getPropertyCount());
    ...
    private static int writeDictionary(final OutputStream out,
        ...
        throws IOException
    {
        int length = com.example.alldocument.library.fc.hpsf.TypeWriter.writeUIntToStream(out, dictionary.size());
        for (final Iterator<Long> i = dictionary.keySet().iterator(); i.hasNext();)
        {
            final Long key = i.next();
            final String value = dictionary.get(key);

            if (codepage == com.example.alldocument.library.fc.hpsf.Constants.CP_UNICODE)
            {
                /* Write the dictionary item in Unicode. */
                int sLength = value.length() + 1;
                if (sLength % 2 == 1)
                    sLength++;
                length += com.example.alldocument.library.fc.hpsf.TypeWriter.writeUIntToStream(out, key.longValue());
                length += com.example.alldocument.library.fc.hpsf.TypeWriter.writeUIntToStream(out, sLength);
                final byte[] ca =
     ...
     */
    public com.example.alldocument.library.fc.hpsf.Property[] getProperties()
    {
        properties = (com.example.alldocument.library.fc.hpsf.Property[]) preprops.toArray(new com.example.alldocument.library.fc.hpsf.Property[0]);
        return properties;
    }
        ...
        throws IllegalPropertySetDataException
    {
        if (dictionary != null)
        {
             ...
             * don't have a type. */
            setProperty(com.example.alldocument.library.fc.hpsf.PropertyIDMap.PID_DICTIONARY, -1, dictionary);
            ...
            final Integer codepage =
                (Integer) getProperty(com.example.alldocument.library.fc.hpsf.PropertyIDMap.PID_CODEPAGE);
            if (codepage == null)
                setProperty(com.example.alldocument.library.fc.hpsf.PropertyIDMap.PID_CODEPAGE, com.example.alldocument.library.fc.hpsf.Variant.VT_I2,
            ...
            removeProperty(com.example.alldocument.library.fc.hpsf.PropertyIDMap.PID_DICTIONARY);
    }
    ...
    public void setProperty(final int id, final Object value)
    {
        if (value instanceof String)
            ...
            setProperty(id, com.example.alldocument.library.fc.hpsf.Variant.VT_FILETIME, value);
        else
    ...
    public void clear()
    {
        final com.example.alldocument.library.fc.hpsf.Property[] properties = getProperties();
        for (int i = 0; i < properties.length; i++)
        {
