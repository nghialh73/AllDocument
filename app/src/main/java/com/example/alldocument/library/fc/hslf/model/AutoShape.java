...
import com.example.alldocument.library.fc.hslf.model.AutoShapes;
...
{
    protected AutoShape(EscherContainerRecord escherRecord, com.example.alldocument.library.fc.hslf.model.Shape parent)
    {
    ...
    {
        setVerticalAlignment(com.example.alldocument.library.fc.hslf.model.TextBox.AnchorMiddle);
        setHorizontalAlignment(com.example.alldocument.library.fc.hslf.model.TextBox.AlignCenter);
    ...
    public com.example.alldocument.library.java.awt.Shape getOutline()
    {
        ...
        com.example.alldocument.library.java.awt.Shape shape = outline.getOutline(this);
