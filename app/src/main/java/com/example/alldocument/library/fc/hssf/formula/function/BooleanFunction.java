...
import com.example.alldocument.library.fc.hssf.formula.TwoDEval;
 ...
 */
public abstract class BooleanFunction implements com.example.alldocument.library.fc.hssf.formula.function.Function {
	...
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function AND = new BooleanFunction() {
	...
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function OR = new BooleanFunction() {
		protected boolean getInitialResultValue() {
			return false;
		}
		protected boolean partialEvaluate(boolean cumulativeResult, boolean currentValue) {
	...
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function FALSE = new Fixed0ArgFunction() {
		public ValueEval evaluate(int srcRowIndex, int srcColumnIndex) {
			return BoolEval.FALSE;
		}
	};
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function TRUE = new Fixed0ArgFunction() {
		public ValueEval evaluate(int srcRowIndex, int srcColumnIndex) {
