...
import com.example.alldocument.library.common.pictureefftect.PictureCroppedInfo;
import com.example.alldocument.library.common.pictureefftect.PictureEffectInfo;
import com.example.alldocument.library.common.pictureefftect.PictureEffectUtil;
import com.example.alldocument.library.constant.EventConstant;
import com.example.alldocument.library.fc.hslf.blip.JPEG;
...
public class PictureKit
{
     ...
     */
    public synchronized void drawPicture(Canvas canvas, IControl control, int viewIndex, com.example.alldocument.library.common.picture.Picture pic, float x, float y,
                                        ...
                                        float zoom, float destWidth, float destHeight, PictureEffectInfo effectInfor, IAnimation animation) throws OutOfMemoryError
   {
       if (pic != null && pic.getTempFilePath() != null)
       {
           ...
           if(ret != null)
           {
               ...
               {
                   //wmf image to jpg
                   pic.setPictureType(com.example.alldocument.library.common.picture.Picture.PNG);
       ...
       float destHeight, PictureEffectInfo effectInfor, IAnimation animation)
   {
       try
       {
           ...
           if (sBitmap == null)
           {
               ...
               if( imageType == com.example.alldocument.library.common.picture.Picture.WMF || imageType == com.example.alldocument.library.common.picture.Picture.EMF)
               {
               ...
               else
               {
            	   try
            	   {
                       ...
                       if(sBitmap == null)
                       {
                    	   ...
                    	   String dst = null;
                    	   if(imageType == com.example.alldocument.library.common.picture.Picture.JPEG)
                    	   {
                    		   ...
                    		   dst = control.getSysKit().getPictureManage().convertToPng(viewIndex, path, com.example.alldocument.library.common.picture.Picture.JPEG_TYPE, control.isSlideShow());
                    	   }
                    	   else if(imageType == com.example.alldocument.library.common.picture.Picture.PNG)
                    	   {
                    		   dst = control.getSysKit().getPictureManage().convertToPng(viewIndex, path, com.example.alldocument.library.common.picture.Picture.PNG_TYPE, control.isSlideShow());
                    	   }
   ...
   public Bitmap createTransparentBitmapFromBitmap(Bitmap bitmap, int replaceThisColor)
   {
     ...
     * @return
     */
    public boolean isVectorPicture(com.example.alldocument.library.common.picture.Picture pic)
    {
    	if (pic != null)
        {
    		byte imageType = pic.getPictureType();
    		if(imageType == com.example.alldocument.library.common.picture.Picture.WMF || imageType == Picture.EMF)
            {
    			return true;
            }
        }
