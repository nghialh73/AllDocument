...
import com.example.alldocument.library.fc.hssf.model.InternalSheet;
import com.example.alldocument.library.fc.hssf.model.InternalWorkbook;
import com.example.alldocument.library.fc.hssf.record.AutoFilterInfoRecord;
import com.example.alldocument.library.fc.hssf.record.CellValueRecordInterface;
import com.example.alldocument.library.fc.hssf.record.DVRecord;
import com.example.alldocument.library.fc.hssf.record.DimensionsRecord;
import com.example.alldocument.library.fc.hssf.record.EscherAggregate;
import com.example.alldocument.library.fc.hssf.record.ExtendedFormatRecord;
...
import com.example.alldocument.library.fc.hssf.record.SCLRecord;
import com.example.alldocument.library.fc.hssf.record.WSBoolRecord;
import com.example.alldocument.library.fc.hssf.record.WindowTwoRecord;
import com.example.alldocument.library.fc.hssf.record.aggregates.DataValidityTable;
import com.example.alldocument.library.fc.hssf.record.aggregates.FormulaRecordAggregate;
import com.example.alldocument.library.fc.hssf.record.aggregates.WorksheetProtectionBlock;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFAutoFilter;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFCell;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFCellStyle;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFClientAnchor;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFComment;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFDataValidation;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFDataValidationHelper;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFFooter;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFHeader;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFHyperlink;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFPatriarch;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFPrintSetup;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFRow;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFSheetConditionalFormatting;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFWorkbook;
import com.example.alldocument.library.fc.hssf.util.ColumnInfo;
import com.example.alldocument.library.fc.hssf.util.HSSFPaneInformation;
import com.example.alldocument.library.fc.hssf.util.Region;
import com.example.alldocument.library.fc.ss.SpreadsheetVersion;
import com.example.alldocument.library.fc.ss.usermodel.CellRange;
import com.example.alldocument.library.fc.ss.usermodel.DataValidation;
import com.example.alldocument.library.fc.ss.usermodel.DataValidationHelper;
import com.example.alldocument.library.fc.ss.usermodel.ICell;
import com.example.alldocument.library.fc.ss.usermodel.ICellStyle;
import com.example.alldocument.library.fc.ss.usermodel.IRow;
import com.example.alldocument.library.fc.ss.util.CellReference;
import com.example.alldocument.library.fc.ss.util.HSSFCellRangeAddress;
import com.example.alldocument.library.fc.ss.util.SSCellRange;
import com.example.alldocument.library.fc.ss.util.SheetUtil;
 ...
 */
public final class HSSFSheet implements com.example.alldocument.library.fc.ss.usermodel.Sheet
{
    ...
    private final TreeMap<Integer, com.example.alldocument.library.fc.hssf.usermodel.HSSFRow> _rows;
    ...
    protected HSSFSheet(HSSFWorkbook workbook)
    {
        ...
        _rows = new TreeMap<Integer, com.example.alldocument.library.fc.hssf.usermodel.HSSFRow>();
    ...
    private void setPropertiesFromSheet(InternalSheet sheet)
    {
        ...
        com.example.alldocument.library.fc.hssf.usermodel.HSSFRow lastrow = null;
        ...
        while (iter.hasNext())
        {
            ...
            com.example.alldocument.library.fc.hssf.usermodel.HSSFRow hrow = lastrow;
     ...
     * @see com.example.alldocument.library.fc.hssf.usermodel.HSSFRow
     * @see #removeRow(com.com.example.alldocument.library.fc.ss.usermodel.IRow)
     */
    public com.example.alldocument.library.fc.hssf.usermodel.HSSFRow createRow(int rownum)
    {
        com.example.alldocument.library.fc.hssf.usermodel.HSSFRow row = new com.example.alldocument.library.fc.hssf.usermodel.HSSFRow(_workbook, this, rownum);
    ...
    private com.example.alldocument.library.fc.hssf.usermodel.HSSFRow createRowFromRecord(RowRecord row)
    {
        com.example.alldocument.library.fc.hssf.usermodel.HSSFRow hrow = new com.example.alldocument.library.fc.hssf.usermodel.HSSFRow(_workbook, this, row);
    ...
    {
        com.example.alldocument.library.fc.hssf.usermodel.HSSFRow hrow = (com.example.alldocument.library.fc.hssf.usermodel.HSSFRow)row;
        ...
        for (ICell cell : row)
        {
            com.example.alldocument.library.fc.hssf.usermodel.HSSFCell xcell = (com.example.alldocument.library.fc.hssf.usermodel.HSSFCell)cell;
        ...
        if (_rows.size() > 0)
        {
            ...
            com.example.alldocument.library.fc.hssf.usermodel.HSSFRow removedRow = _rows.remove(key);
            if (removedRow != row)
            {
    ...
    private int findLastRow(int lastrow)
    {
        ...
        com.example.alldocument.library.fc.hssf.usermodel.HSSFRow r = getRow(rownum);
    ...
    private void addRow(com.example.alldocument.library.fc.hssf.usermodel.HSSFRow row, boolean addLow)
    {
     ...
     */
    public com.example.alldocument.library.fc.hssf.usermodel.HSSFRow getRow(int rowIndex)
    {
   ...
   public void setColumnPixelWidth(int columnIndex, int width)
   {
     ...
     */
    public int addMergedRegion(com.example.alldocument.library.fc.ss.util.Region region)
    {
    ...
    private void validateArrayFormulas(HSSFCellRangeAddress region)
    {
        ...
        for (int rowIn = firstRow; rowIn <= lastRow; rowIn++)
        {
            ...
            {
                com.example.alldocument.library.fc.hssf.usermodel.HSSFRow row = getRow(rowIn);
                if (row == null)
                    continue;

                com.example.alldocument.library.fc.hssf.usermodel.HSSFCell cell = row.getCell(colIn);
                if (cell == null)
                    continue;
     ...
     *
     *  <p>
     *  Calculating the formula values with {@link com.example.alldocument.library.fc.ss.usermodel.com.example.alldocument.library.fc.ss.usermodel.FormulaEvaluator} is the
     ...
     *  {@link com.example.alldocument.library.ss.model.baseModel.com.example.alldocument.library.fc.ss.usermodel.Workbook#setForceFormulaRecalculation(boolean)}
     ...
     *
     * @see com.example.alldocument.library.ss.model.baseModel.com.example.alldocument.library.fc.ss.usermodel.Workbook#setForceFormulaRecalculation(boolean)
     */
        ...
        boolean resetOriginalRowHeight, boolean moveComments)
    {
        ...
        {
            com.example.alldocument.library.fc.hssf.usermodel.HSSFRow row = getRow(rowNum);
            ...
            com.example.alldocument.library.fc.hssf.usermodel.HSSFRow row2Replace = getRow(rowNum + n);
            if (row2Replace == null)
            ...
            {
                com.example.alldocument.library.fc.hssf.usermodel.HSSFCell cell = (com.example.alldocument.library.fc.hssf.usermodel.HSSFCell)cells.next();
                row.removeCell(cell);
    ...
    private void notifyRowShifting(com.example.alldocument.library.fc.hssf.usermodel.HSSFRow row)
    {
        ...
        for (ICell cell : row)
        {
            com.example.alldocument.library.fc.hssf.usermodel.HSSFCell hcell = (com.example.alldocument.library.fc.hssf.usermodel.HSSFCell)cell;
    ...
    public HSSFComment getCellComment(int row, int column)
    {
        ...
        com.example.alldocument.library.fc.hssf.usermodel.HSSFRow r = getRow(row);
        if (r != null)
        {
            com.example.alldocument.library.fc.hssf.usermodel.HSSFCell c = r.getCell(column);
            if (c != null)
            {
            ...
            return com.example.alldocument.library.fc.hssf.usermodel.HSSFCell.findCellComment(_sheet, row, column);
        }
        return null;
    }
     ...
     */
    private CellRange<com.example.alldocument.library.fc.hssf.usermodel.HSSFCell> getCellRange(HSSFCellRangeAddress range)
    {
        ...
        List<com.example.alldocument.library.fc.hssf.usermodel.HSSFCell> temp = new ArrayList<com.example.alldocument.library.fc.hssf.usermodel.HSSFCell>(height * width);
        for (int rowIn = firstRow; rowIn <= lastRow; rowIn++)
        {
            for (int colIn = firstColumn; colIn <= lastColumn; colIn++)
            {
        ...
        return SSCellRange.create(firstRow, firstColumn, height, width, temp, com.example.alldocument.library.fc.hssf.usermodel.HSSFCell.class);
    }

    public CellRange<com.example.alldocument.library.fc.hssf.usermodel.HSSFCell> setArrayFormula(String formula, HSSFCellRangeAddress range)
    {
...
//        return cells;
    ...
    public CellRange<com.example.alldocument.library.fc.hssf.usermodel.HSSFCell> removeArrayFormula(ICell cell)
    {
        if (cell.getSheet() != this)
        {
            throw new IllegalArgumentException("Specified cell does not belong to this sheet.");
        }
        CellValueRecordInterface rec = ((com.example.alldocument.library.fc.hssf.usermodel.HSSFCell)cell).getCellValueRecord();
        ...
        CellRange<com.example.alldocument.library.fc.hssf.usermodel.HSSFCell> result = getCellRange(range);
