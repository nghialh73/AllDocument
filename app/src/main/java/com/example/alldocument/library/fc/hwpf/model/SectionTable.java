...
import com.example.alldocument.library.fc.hwpf.model.SectionDescriptor;
...
public class SectionTable
{
    ...
    protected ArrayList<com.example.alldocument.library.fc.hwpf.model.SEPX> _sections = new ArrayList<com.example.alldocument.library.fc.hwpf.model.SEPX>();
    ...
    {
        com.example.alldocument.library.fc.hwpf.model.PlexOfCps sedPlex = new com.example.alldocument.library.fc.hwpf.model.PlexOfCps(tableStream, offset, size, SED_SIZE);
        this.tpt = tpt;
        ...
        for (int x = 0; x < length; x++)
        {
            ...
            {
                _sections.add(new com.example.alldocument.library.fc.hwpf.model.SEPX(sed, startAt, endAt, new byte[0]));
            }
            else
            {
                ...
                _sections.add(new com.example.alldocument.library.fc.hwpf.model.SEPX(sed, startAt, endAt, buf));
            }
        }
        ...
        {
            com.example.alldocument.library.fc.hwpf.model.SEPX s = _sections.get(i);
    ...
    public void adjustForInsert(int listIndex, int length)
    {
        ...
        com.example.alldocument.library.fc.hwpf.model.SEPX sepx = _sections.get(listIndex);
    ...
    public ArrayList<com.example.alldocument.library.fc.hwpf.model.SEPX> getSections()
    {
        return _sections;
    }
        ...
        throws IOException
    {
        ...
        com.example.alldocument.library.fc.hwpf.model.PlexOfCps plex = new PlexOfCps(SED_SIZE);
