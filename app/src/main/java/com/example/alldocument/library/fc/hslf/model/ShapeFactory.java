...
import com.example.alldocument.library.fc.hslf.model.AutoShape;
import com.example.alldocument.library.fc.hslf.model.Freeform;
import com.example.alldocument.library.fc.hslf.model.Line;
import com.example.alldocument.library.fc.hslf.model.OLEShape;
import com.example.alldocument.library.fc.hslf.model.Picture;
...
public final class ShapeFactory
{
     ...
     */
    public static com.example.alldocument.library.fc.hslf.model.Shape createShape(EscherContainerRecord spContainer, com.example.alldocument.library.fc.hslf.model.Shape parent)
    {
    ...
    public static com.example.alldocument.library.fc.hslf.model.ShapeGroup createShapeGroup(EscherContainerRecord spContainer, com.example.alldocument.library.fc.hslf.model.Shape parent)
    {
        com.example.alldocument.library.fc.hslf.model.ShapeGroup group = null;
        ...
        if (opt != null)
        {
            try
            {
                ...
                {
                    group = new com.example.alldocument.library.fc.hslf.model.ShapeGroup(spContainer, parent);
                }
            }
            catch(Exception e)
            {
    ...
    public static com.example.alldocument.library.fc.hslf.model.Shape createSimpeShape(EscherContainerRecord spContainer, com.example.alldocument.library.fc.hslf.model.Shape parent)
    {
        Shape shape = null;
