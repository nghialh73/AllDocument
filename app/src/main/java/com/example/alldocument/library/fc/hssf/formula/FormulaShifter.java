...
import com.example.alldocument.library.fc.hssf.formula.ptg.Area2DPtgBase;
...
import com.example.alldocument.library.fc.hssf.formula.ptg.RefPtgBase;
...
public final class FormulaShifter {
     ...
     *
     * For example, this will be called on {@link com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet#shiftRows(int, int, int)} }
     */
     ...
     *
     * For example, this will be called on {@link com.example.alldocument.library.fc.hssf.usermodel.HSSFWorkbook#setSheetOrder(String, int)}
     */
