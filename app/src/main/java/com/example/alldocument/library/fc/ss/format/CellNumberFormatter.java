...
==================================================================== */
package com.example.alldocument.library.fc.ss.format;
...
import com.example.alldocument.library.fc.ss.format.CellFormatPart;
import com.example.alldocument.library.fc.ss.format.CellFormatPart.PartHandler;
import com.example.alldocument.library.fc.ss.format.CellFormatType;
import com.example.alldocument.library.fc.ss.format.CellFormatter;
import com.example.alldocument.library.fc.ss.format.CellTextFormatter;
 ...
 */
public class CellNumberFormatter extends com.example.alldocument.library.fc.ss.format.CellFormatter {
    ...
    static final com.example.alldocument.library.fc.ss.format.CellFormatter SIMPLE_NUMBER = new com.example.alldocument.library.fc.ss.format.CellFormatter("General") {
    ...
    private static final com.example.alldocument.library.fc.ss.format.CellFormatter SIMPLE_INT = new CellNumberFormatter(
            "#");
    ...
    private class NumPartHandler implements PartHandler {
        ...
        public String handlePart(Matcher m, String part, com.example.alldocument.library.fc.ss.format.CellFormatType type,
                StringBuffer desc) {
            int pos = desc.length();
