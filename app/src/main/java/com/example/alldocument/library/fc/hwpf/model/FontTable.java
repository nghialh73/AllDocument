...
public final class FontTable
{
    ...
    private com.example.alldocument.library.fc.hwpf.model.Ffn[] _fontNames = null;
    ...
    public FontTable(byte[] buf, int offset, int lcbSttbfffn)
    {
        ...
        _fontNames = new com.example.alldocument.library.fc.hwpf.model.Ffn[_stringCount]; //Ffn corresponds to a Pascal style String in STTBF.

        for (int i = 0; i < _stringCount; i++)
        {
            _fontNames[i] = new com.example.alldocument.library.fc.hwpf.model.Ffn(buf, offset);
    ...
    public com.example.alldocument.library.fc.hwpf.model.Ffn[] getFontNames()
    {
        return _fontNames;
    }
