...
==================================================================== */
package com.example.alldocument.library.fc.hssf.record.crypto;
...
import com.example.alldocument.library.fc.hssf.record.crypto.RC4;
...
public final class Biff8EncryptionKey {
	...
	public boolean validate(byte[] saltData, byte[] saltHash) {
		...
		com.example.alldocument.library.fc.hssf.record.crypto.RC4 rc4 = createRC4(0);
	...
	/**
	 * The {@link com.example.alldocument.library.fc.hssf.record.crypto.RC4} instance needs to be changed every 1024 bytes.
	 * @param keyBlockNo used to seed the newly created {@link com.example.alldocument.library.fc.hssf.record.crypto.RC4}
	 */
	com.example.alldocument.library.fc.hssf.record.crypto.RC4 createRC4(int keyBlockNo) {
		MessageDigest md5;
		try {
			md5 = MessageDigest.getInstance("MD5");
		} catch (NoSuchAlgorithmException e) {
		...
		return new com.example.alldocument.library.fc.hssf.record.crypto.RC4(digest);
	}
