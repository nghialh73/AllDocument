 ...
 * 时间:              上午9:08:14
 */
package com.example.alldocument.library.common.pictureefftect;
...
public class PictureEffectInfoFactory
{
	 ...
	 * @return
	 */
    public static com.example.alldocument.library.common.pictureefftect.PictureEffectInfo getPictureEffectInfor(Element blipFill)
    {
        if(blipFill == null)
        {
            return null;
        ...
        com.example.alldocument.library.common.pictureefftect.PictureEffectInfo effectInfor = new com.example.alldocument.library.common.pictureefftect.PictureEffectInfo();
        ...
        if(e != null)
        {
            ...
            {
                com.example.alldocument.library.common.pictureefftect.PictureCroppedInfo croppedInfor = new com.example.alldocument.library.common.pictureefftect.PictureCroppedInfo(left, top, right, bottom);
     ...
     * @return
     */
    public static com.example.alldocument.library.common.pictureefftect.PictureEffectInfo getPictureEffectInfor_ImageData(Element imagedata)
    {
    	if(imagedata != null)
    	{
    		com.example.alldocument.library.common.pictureefftect.PictureEffectInfo effectInfor = new com.example.alldocument.library.common.pictureefftect.PictureEffectInfo();
    ...
    public static com.example.alldocument.library.common.pictureefftect.PictureEffectInfo getPictureEffectInfor(com.example.alldocument.library.fc.hwpf.usermodel.Picture pic)
    {
    	if(pic == null)
        {
            return null;
    ...
    public static com.example.alldocument.library.common.pictureefftect.PictureEffectInfo getPictureEffectInfor(EscherOptRecord opt)
    {
        if(opt == null)
        {
            return null;
        ...
        com.example.alldocument.library.common.pictureefftect.PictureEffectInfo effectInfor = new PictureEffectInfo();
        boolean validateInfor = false;
        //crop information
        String value = null;        
        //left
        ...
        if(left != 0 || top != 0 || right != 0 || bottom != 0)
        {
            com.example.alldocument.library.common.pictureefftect.PictureCroppedInfo croppedInfor = new PictureCroppedInfo(left, top, right, bottom);
