...
final class Order3 extends com.example.alldocument.library.java.awt.geom.Curve {
    private double x0;
    private double y0;
    private double cx0;
    private double cy0;
    ...
    public double TforY(double y) {
        ...
        if (ycoeff3 == 0.0) {
            ...
            return com.example.alldocument.library.java.awt.geom.Order2.TforY(y, ycoeff0, ycoeff1, ycoeff2);
        }
    ...
    public com.example.alldocument.library.java.awt.geom.Curve getSubCurve(double ystart, double yend, int dir) {
