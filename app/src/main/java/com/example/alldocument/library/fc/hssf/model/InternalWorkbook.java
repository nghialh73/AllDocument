...
package com.example.alldocument.library.fc.hssf.model;
...
import com.example.alldocument.library.fc.hssf.formula.EvaluationWorkbook.ExternalName;
import com.example.alldocument.library.fc.hssf.formula.EvaluationWorkbook.ExternalSheet;
...
import com.example.alldocument.library.fc.hssf.model.LinkTable;
import com.example.alldocument.library.fc.hssf.model.WorkbookRecordList;
...
import com.example.alldocument.library.fc.hssf.record.BookBoolRecord;
import com.example.alldocument.library.fc.hssf.record.BoundSheetRecord;
import com.example.alldocument.library.fc.hssf.record.CodepageRecord;
...
import com.example.alldocument.library.fc.hssf.record.DateWindow1904Record;
...
import com.example.alldocument.library.fc.hssf.record.ExternSheetRecord;
import com.example.alldocument.library.fc.hssf.record.FileSharingRecord;
import com.example.alldocument.library.fc.hssf.record.FnGroupCountRecord;
...
import com.example.alldocument.library.fc.hssf.record.HyperlinkRecord;
import com.example.alldocument.library.fc.hssf.record.InterfaceEndRecord;
import com.example.alldocument.library.fc.hssf.record.InterfaceHdrRecord;
import com.example.alldocument.library.fc.hssf.record.MMSRecord;
import com.example.alldocument.library.fc.hssf.record.NameCommentRecord;
...
import com.example.alldocument.library.fc.hssf.record.PasswordRecord;
import com.example.alldocument.library.fc.hssf.record.PasswordRev4Record;
import com.example.alldocument.library.fc.hssf.record.PrecisionRecord;
import com.example.alldocument.library.fc.hssf.record.ProtectRecord;
import com.example.alldocument.library.fc.hssf.record.ProtectionRev4Record;
...
import com.example.alldocument.library.fc.hssf.record.RefreshAllRecord;
...
import com.example.alldocument.library.fc.hssf.record.SupBookRecord;
import com.example.alldocument.library.fc.hssf.record.TabIdRecord;
import com.example.alldocument.library.fc.hssf.record.UseSelFSRecord;
import com.example.alldocument.library.fc.hssf.record.WindowOneRecord;
import com.example.alldocument.library.fc.hssf.record.WindowProtectRecord;
import com.example.alldocument.library.fc.hssf.record.WriteAccessRecord;
import com.example.alldocument.library.fc.hssf.record.WriteProtectRecord;
import com.example.alldocument.library.fc.hssf.record.common.UnicodeString;
import com.example.alldocument.library.fc.hssf.util.HSSFColor;
import com.example.alldocument.library.fc.ss.usermodel.BuiltinFormats;
 ...
 * @see com.example.alldocument.library.fc.hssf.usermodel.HSSFWorkbook
 */
@ Internal
public final class InternalWorkbook
{
    ...
    private com.example.alldocument.library.fc.hssf.model.LinkTable linkTable; // optionally occurs if there are  references in the document. (4.10.3)
    ...
    private com.example.alldocument.library.fc.hssf.model.DrawingManager2 drawingManager;
        ...
        for (k = 0; k < recs.size(); k++)
        {
            ...
            switch (rec.getSid())
            {
                ...
                case SupBookRecord.sid:
                    ...
                    retval.linkTable = new com.example.alldocument.library.fc.hssf.model.LinkTable(recs, k, retval.records, retval.commentRecords);
     ...
     */
    private com.example.alldocument.library.fc.hssf.model.LinkTable getOrCreateLinkTable()
    {
        if (linkTable == null)
        {
            linkTable = new com.example.alldocument.library.fc.hssf.model.LinkTable((short)getNumSheets(), records);
        }
        return linkTable;
    }
    ...
    public NameRecord addName(NameRecord name)
    {
        ...
        com.example.alldocument.library.fc.hssf.model.LinkTable linkTable = getOrCreateLinkTable();
    ...
    */
     ...
     */
    public com.example.alldocument.library.fc.hssf.model.DrawingManager2 findDrawingGroup()
    {
        ...
        for (Record r : records)
        {
            if (r instanceof DrawingGroupRecord)
            {
                ...
                if (dgg != null)
                {
                    drawingManager = new com.example.alldocument.library.fc.hssf.model.DrawingManager2(dgg);
                    if (bStore != null)
                    {
    ...
    {
        com.example.alldocument.library.fc.hssf.model.LinkTable lnk = getOrCreateLinkTable();
     ...
     *
     * @see com.example.alldocument.library.fc.hssf.usermodel.HSSFWorkbook#setForceFormulaRecalculation(boolean)
     */
