 ...
 * com.example.alldocument.library.fc.hssf.formula.WorkbookEvaluator}).<br/>
 * <br/>
 * <b>General guidelines</b>:
 * <ul>
 * <li>a plain value cell can be marked as 'final' if it will not be changed after the first call
 * to {@link com.example.alldocument.library.fc.hssf.formula.WorkbookEvaluator#evaluate(com.example.alldocument.library.fc.hssf.formula.EvaluationCell)}.
 * </li>
 ...
 * example in {@link com.example.alldocument.library.fc.ss.usermodel.com.example.alldocument.library.fc.ss.usermodel.FormulaEvaluator#evaluateFormulaCell(org.apache.poi.ss.usermodel.Cell)})
