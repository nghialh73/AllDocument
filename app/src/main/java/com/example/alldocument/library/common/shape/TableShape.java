...
public class TableShape extends AbstractShape
{
    ...
    public TableShape(int numrows, int numcols)
    {
        ...
        cells = new com.example.alldocument.library.common.shape.TableCell[numrows * numcols];
    }
     ...
     * @return
     */
    public com.example.alldocument.library.common.shape.TableCell getCell(int index)
    {
     ...
     * @param tableCell
     */
    public void addCell(int index, com.example.alldocument.library.common.shape.TableCell tableCell)
    {
    ...
    public void dispose()
    {
        if (cells != null)
        {
            ...
            {
                com.example.alldocument.library.common.shape.TableCell cell = cells[i];
                if (cell != null)
                {
                    cell.dispose();
                }
