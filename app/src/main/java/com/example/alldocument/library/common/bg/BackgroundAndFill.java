 ...
 * 时间:              上午10:34:21
 */
package com.example.alldocument.library.common.bg;
...
public class BackgroundAndFill
{
    ...
    public com.example.alldocument.library.common.bg.AShader getShader()
    {
		return shader;
	}

	public void setShader(com.example.alldocument.library.common.bg.AShader shader)
	{
		this.shader = shader;
	}
