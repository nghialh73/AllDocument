...
package com.example.alldocument.library.fc.fs.filesystem;
...
import com.example.alldocument.library.fc.fs.filesystem.BlockSize;
import com.example.alldocument.library.fc.fs.filesystem.CFBConstants;
import com.example.alldocument.library.fc.fs.filesystem.Property;
import com.example.alldocument.library.fc.fs.storage.BlockAllocationTableReader;
import com.example.alldocument.library.fc.fs.storage.BlockList;
import com.example.alldocument.library.fc.fs.storage.HeaderBlock;
import com.example.alldocument.library.fc.fs.storage.RawDataBlock;
...
public class CFBFileSystem
{
     ...
     */
    private BlockSize bigBlockSize = com.example.alldocument.library.fc.fs.filesystem.CFBConstants.SMALLER_BIG_BLOCK_SIZE_DETAILS;
    ...
    {        
        ...
        List<com.example.alldocument.library.fc.fs.filesystem.Property> properties = new ArrayList<com.example.alldocument.library.fc.fs.filesystem.Property>();
     ...
     * 
     */
    private void createPropertyTree(com.example.alldocument.library.fc.fs.filesystem.Property directory, List<com.example.alldocument.library.fc.fs.filesystem.Property> properties)
    {
        ...
        com.example.alldocument.library.fc.fs.filesystem.Property property;
        Stack<com.example.alldocument.library.fc.fs.filesystem.Property> children = new Stack<com.example.alldocument.library.fc.fs.filesystem.Property>();
     ...
     */
    private void readProperties(RawDataBlock[] propertyBlocks, BlockList rawBlockList, List<com.example.alldocument.library.fc.fs.filesystem.Property> properties) throws IOException
    {
        for (int j = 0; j < propertyBlocks.length; j++)
        {
            byte[] data = propertyBlocks[j].getData();
            int property_count = data.length / com.example.alldocument.library.fc.fs.filesystem.CFBConstants.PROPERTY_SIZE;
            int offset = 0;

            for (int k = 0; k < property_count; k++)
            {
                switch (data[offset + com.example.alldocument.library.fc.fs.filesystem.Property.PROPERTY_TYPE_OFFSET])
                {
                    case com.example.alldocument.library.fc.fs.filesystem.Property.DIRECTORY_TYPE:
                        properties.add(new com.example.alldocument.library.fc.fs.filesystem.Property(properties.size(), data, offset));
                        break;

                    case com.example.alldocument.library.fc.fs.filesystem.Property.DOCUMENT_TYPE:
                        properties.add(new com.example.alldocument.library.fc.fs.filesystem.Property(properties.size(), data, offset));
                        break;

                    case com.example.alldocument.library.fc.fs.filesystem.Property.ROOT_TYPE:
                        root = new com.example.alldocument.library.fc.fs.filesystem.Property(properties.size(), data, offset);
                        properties.add(root);
                        break;
                }
     ...
     * @param rawBlockList
     */
    private void readPrepertiesRawData(BlockList smallBlockList, BlockList rawBlockList, com.example.alldocument.library.fc.fs.filesystem.Property directory) throws IOException
    {
        Iterator<com.example.alldocument.library.fc.fs.filesystem.Property> ite = directory.properties.values().iterator();
        while(ite.hasNext())
        {
            com.example.alldocument.library.fc.fs.filesystem.Property property = ite.next();
     ...
     * @param rawBlockList
     */
    private void getPropertyRawData(com.example.alldocument.library.fc.fs.filesystem.Property property, BlockList smallBlockList, BlockList rawBlockList) throws IOException
    {
    ...
    {
        com.example.alldocument.library.fc.fs.filesystem.Property p = getProperty(propertyName);
        if  (p != null)
        {
     ...
     * 
     */
    public com.example.alldocument.library.fc.fs.filesystem.Property getProperty(String propertyName)
    {
