...
public class LineShape extends AutoShape
{
    ...
    public void createStartArrow(byte type, int width, int length)
    {
        if(startArrow == null)
        {
            startArrow = new com.example.alldocument.library.common.shape.Arrow(type, width, length);
        }
        else
        {
    ...
    public void createEndArrow(byte type, int width, int length)
    {
        if(endArrow == null)
        {
            endArrow = new com.example.alldocument.library.common.shape.Arrow(type, width, length);
        }
        else
        {
    ...
    public byte getStartArrowType()
    {
        ...
        return com.example.alldocument.library.common.shape.Arrow.Arrow_None;
    }
    ...
    public com.example.alldocument.library.common.shape.Arrow getStartArrow()
    {
        return startArrow;
    }
    
    public com.example.alldocument.library.common.shape.Arrow getEndArrow()
    {
        return endArrow;
    }
    ...
    // start arror or not
    private com.example.alldocument.library.common.shape.Arrow startArrow;
    // end arror or not
