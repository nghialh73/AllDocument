...
package com.example.alldocument.library.ss.control;
...
import com.example.alldocument.library.ss.control.ExcelView;
import com.example.alldocument.library.ss.control.SSEditor;
import com.example.alldocument.library.ss.control.SSEventManage;
...
import com.example.alldocument.library.system.beans.AEventManage;
...
{  
     ...
     * @param context
     */
    public Spreadsheet(Context context, String filepath, Workbook book, IControl control, com.example.alldocument.library.ss.control.ExcelView parent)
    {
        super(context);
        this.parent = parent;
        ...
        this.editor = new com.example.alldocument.library.ss.control.SSEditor(this);
