...
import com.example.alldocument.library.pg.animate.Animation;
import com.example.alldocument.library.pg.animate.AnimationManager;
import com.example.alldocument.library.pg.animate.EmphanceAnimation;
...
{   
    ...
    public void drawSlide(Canvas canvas, float zoom, CalloutView callouts)
    {
        ...
        com.example.alldocument.library.pg.view.SlideDrawKit.instance().drawSlide(canvas, presentation.getPGModel(), presentation.getEditor(), slide, zoom, shapeVisible);
