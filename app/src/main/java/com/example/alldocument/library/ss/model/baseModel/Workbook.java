...
import com.example.alldocument.library.ss.model.table.TableFormatManager;
...
{  
    ...
    {
        sheets = new HashMap<Integer, com.example.alldocument.library.ss.model.baseModel.Sheet>(5);
     ...
     * @param sheet
     */
    public void addSheet(int index, com.example.alldocument.library.ss.model.baseModel.Sheet sheet)
    {
     ...
     */
    public com.example.alldocument.library.ss.model.baseModel.Sheet getSheet(String sheetName)
    {
        Collection<com.example.alldocument.library.ss.model.baseModel.Sheet> sheetCol = sheets.values();
        for(com.example.alldocument.library.ss.model.baseModel.Sheet sheet : sheetCol)
        {
     ...
     * get sheet for sheet name
     */
    public int getSheetIndex(com.example.alldocument.library.ss.model.baseModel.Sheet sheet)
    {
     ...
     */
    public com.example.alldocument.library.ss.model.baseModel.Sheet getSheet(int index)
    {
...
//        else
    ...
    public void destroy()
    {
        ...
        if(sheets != null)
        {  
            Collection<com.example.alldocument.library.ss.model.baseModel.Sheet> sheetCollection = sheets.values();
            for(com.example.alldocument.library.ss.model.baseModel.Sheet sheet: sheetCollection)
            {
                sheet.dispose();
            }
            sheets.clear();
