...
public final class RowBlocksReader {
	 ...
	 * mergedCellsTable
	 */
	public RowBlocksReader(com.example.alldocument.library.fc.hssf.model.RecordStream rs) {
		...
		Record prevRec = null;
		while(!com.example.alldocument.library.fc.hssf.model.RecordOrderer.isEndOfRowBlock(rs.peekNextSid())) {
	...
	/**
	 * @return a {@link com.example.alldocument.library.fc.hssf.model.RecordStream} containing all the non-{@link SharedFormulaRecord}
	 * non-{@link ArrayRecord} and non-{@link TableRecord} Records.
	 */
	public com.example.alldocument.library.fc.hssf.model.RecordStream getPlainRecordStream() {
