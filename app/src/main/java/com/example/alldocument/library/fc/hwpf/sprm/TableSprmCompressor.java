...
public final class TableSprmCompressor
{
    ...
    public static byte[] compressTableProperty(TableProperties newTAP)
    {
        ...
        if (newTAP.getJc() != 0)
        {
            size += com.example.alldocument.library.fc.hwpf.sprm.SprmUtils.addSprm((short)0x5400, newTAP.getJc(), null, sprmList);
        }
        if (newTAP.getFCantSplit())
        {
            size += com.example.alldocument.library.fc.hwpf.sprm.SprmUtils.addSprm((short)0x3403, 1, null, sprmList);
        }
        if (newTAP.getFTableHeader())
        {
            size += com.example.alldocument.library.fc.hwpf.sprm.SprmUtils.addSprm((short)0x3404, 1, null, sprmList);
        }
        ...
        {
            size += com.example.alldocument.library.fc.hwpf.sprm.SprmUtils.addSprm((short)0xD605, 0, brcBuf, sprmList);
        }
        if (newTAP.getDyaRowHeight() != 0)
        {
            size += com.example.alldocument.library.fc.hwpf.sprm.SprmUtils.addSprm((short)0x9407, newTAP.getDyaRowHeight(), null, sprmList);
        }
        if (newTAP.getItcMac() > 0)
        {
            ...
            size += com.example.alldocument.library.fc.hwpf.sprm.SprmUtils.addSpecialSprm((short)0xD608, buf, sprmList);
        ...
        if (newTAP.getTlp() != null && !newTAP.getTlp().isEmpty())
        {
            ...
            size += com.example.alldocument.library.fc.hwpf.sprm.SprmUtils.addSprm((short)0x740a, 0, buf, sprmList);
        }
