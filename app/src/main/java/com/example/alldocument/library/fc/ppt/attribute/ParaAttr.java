 ...
 * 时间:               下午1:52:05
 */
package com.example.alldocument.library.fc.ppt.attribute;
...
public class ParaAttr
{
        ...
        SectionElement secElem, Element styleElement, Element txBody, String type, int idx)
    {
        ...
        {   
            ...
            if (lstStyle != null)
            {
                ...
                if (txStyle != null)
                {
                    ...
                    com.example.alldocument.library.fc.ppt.attribute.RunAttr.instance().setRunAttribute(master, defRPr, attrLayout, null, 100, -1, false);
            ...
            offset = com.example.alldocument.library.fc.ppt.attribute.RunAttr.instance().processRun(master, paraElem, p, attrLayout, offset, fontScale, masterStyle);
        ...
        com.example.alldocument.library.fc.ppt.attribute.RunAttr.instance().setMaxFontSize(0);
        return offset;
    }
