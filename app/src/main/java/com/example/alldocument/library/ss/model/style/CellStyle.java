...
package com.example.alldocument.library.ss.model.style;

import com.example.alldocument.library.common.bg.BackgroundAndFill;
import com.example.alldocument.library.ss.model.style.Alignment;
...
public class CellStyle
{
    ...
    private void checkAlignmeng()
    {
        if(alignment == null)
        {
            alignment = new com.example.alldocument.library.ss.model.style.Alignment();
        }
    }
