 ...
 * 时间:               下午4:26:09
 */
package com.example.alldocument.library.common.autoshape;

import java.util.List;

import com.example.alldocument.library.common.BackgroundDrawer;
import com.example.alldocument.library.common.PaintKit;
import com.example.alldocument.library.common.autoshape.ExtendPath;
import com.example.alldocument.library.common.autoshape.pathbuilder.actionButton.ActionButtonPathBuilder;
import com.example.alldocument.library.common.autoshape.pathbuilder.arrow.ArrowPathBuilder;
import com.example.alldocument.library.common.autoshape.pathbuilder.baseshape.BaseShapePathBuilder;
import com.example.alldocument.library.common.autoshape.pathbuilder.flowChart.FlowChartDrawing;
import com.example.alldocument.library.common.autoshape.pathbuilder.line.LinePathBuilder;
import com.example.alldocument.library.common.autoshape.pathbuilder.math.MathPathBuilder;
import com.example.alldocument.library.common.autoshape.pathbuilder.rect.RectPathBuilder;
import com.example.alldocument.library.common.autoshape.pathbuilder.smartArt.SmartArtPathBuilder;
import com.example.alldocument.library.common.autoshape.pathbuilder.starAndBanner.BannerPathBuilder;
import com.example.alldocument.library.common.autoshape.pathbuilder.starAndBanner.star.StarPathBuilder;
import com.example.alldocument.library.common.autoshape.pathbuilder.wedgecallout.WedgeCalloutDrawing;
    ...
    public void drawAutoShape(Canvas canvas, IControl control, int viewIndex, AutoShape shape, Rect rect, float zoom)
    {
        ...
        switch(type)
        {
            ...
            case ShapeTypes.CurvedConnector5:                               // 曲线连接符，曲线箭头连接符，曲线双箭头连接符
            {
            	...
            	{
            		List<com.example.alldocument.library.common.autoshape.ExtendPath> pathList = LinePathBuilder.getLinePath((LineShape)shape, rect, zoom);
                    for(int i = 0; i < pathList.size(); i++)
                    {
                        com.example.alldocument.library.common.autoshape.ExtendPath extendPath = new com.example.alldocument.library.common.autoshape.ExtendPath(pathList.get(i));
            ...
            case ShapeTypes.ArbitraryPolygon:
            {
                ...
                List<com.example.alldocument.library.common.autoshape.ExtendPath> pathList = ((ArbitraryPolygonShape)shape).getPaths();
                for(int i = 0; i < pathList.size(); i++)
                {
                    com.example.alldocument.library.common.autoshape.ExtendPath extendPath = new com.example.alldocument.library.common.autoshape.ExtendPath(pathList.get(i));
            ...
            case ShapeTypes.DirectPolygon:
            {
            	m.reset();
                m.postScale(zoom, zoom);
                List<com.example.alldocument.library.common.autoshape.ExtendPath> pathList = ((WPAutoShape)shape).getPaths();
            ...
            case ShapeTypes.RightBrace:                                     // 右大括号
            {
                ...
                else
                {
                    ...
                    List<com.example.alldocument.library.common.autoshape.ExtendPath> pathList = (List<com.example.alldocument.library.common.autoshape.ExtendPath>)obj;
                    for(int i = 0; i < pathList.size(); i++)
                    {
                        com.example.alldocument.library.common.autoshape.ExtendPath extendPath = new com.example.alldocument.library.common.autoshape.ExtendPath(pathList.get(i));
                        drawShape(canvas, control, viewIndex, shape, extendPath, rect, animation, zoom);
            ...
            case ShapeTypes.AccentBorderCallout4:
                ...
                {
                    @ SuppressWarnings("unchecked")
                    List<com.example.alldocument.library.common.autoshape.ExtendPath> list = (List<com.example.alldocument.library.common.autoshape.ExtendPath>)obj;
                    int cnt = list.size();
                    for(int i = 0; i < cnt; i++)
                    {
                        drawShape(canvas, control, viewIndex, shape, list.get(i), rect, animation, zoom);
            ...
            case ShapeTypes.ActionButtonBlank:
                List<com.example.alldocument.library.common.autoshape.ExtendPath> pathList = ActionButtonPathBuilder.getActionButtonExtendPath(shape, rect);
                if(pathList == null)
                {
                    return;
                }
