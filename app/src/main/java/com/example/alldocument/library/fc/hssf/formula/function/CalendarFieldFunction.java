...
public final class CalendarFieldFunction extends Fixed1ArgFunction {
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function YEAR = new CalendarFieldFunction(Calendar.YEAR);
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function MONTH = new CalendarFieldFunction(Calendar.MONTH);
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function WEEKDAY = new CalendarFieldFunction(Calendar.DAY_OF_WEEK);
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function DAY = new CalendarFieldFunction(Calendar.DAY_OF_MONTH);
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function HOUR = new CalendarFieldFunction(Calendar.HOUR_OF_DAY);
   public static final com.example.alldocument.library.fc.hssf.formula.function.Function MINUTE = new CalendarFieldFunction(Calendar.MINUTE);
