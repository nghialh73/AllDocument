...
import com.example.alldocument.library.fc.poifs.storage.BigBlock;
 ...
 */
public final class PropertyBlock extends com.example.alldocument.library.fc.poifs.storage.BigBlock {
    ...
    public static com.example.alldocument.library.fc.poifs.storage.BlockWritable[] createPropertyBlockArray(
            final POIFSBigBlockSize bigBlockSize, final List<Property> properties)
    {
        ...
        com.example.alldocument.library.fc.poifs.storage.BlockWritable[] rvalue = new BlockWritable[ block_count ];
