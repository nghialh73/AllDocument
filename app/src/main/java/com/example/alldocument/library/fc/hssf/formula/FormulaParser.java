...
import com.example.alldocument.library.constant.fc.ErrorConstant;
import com.example.alldocument.library.fc.hssf.formula.EvaluationName;
import com.example.alldocument.library.fc.hssf.formula.ExternSheetReferenceToken;
import com.example.alldocument.library.fc.hssf.formula.FormulaParseException;
import com.example.alldocument.library.fc.hssf.formula.FormulaParsingWorkbook;
import com.example.alldocument.library.fc.hssf.formula.FormulaType;
import com.example.alldocument.library.fc.hssf.formula.OperandClassTransformer;
import com.example.alldocument.library.fc.hssf.formula.ParseNode;
import com.example.alldocument.library.fc.hssf.formula.SheetNameFormatter;
import com.example.alldocument.library.fc.hssf.formula.function.FunctionMetadata;
import com.example.alldocument.library.fc.hssf.formula.function.FunctionMetadataRegistry;
import com.example.alldocument.library.fc.hssf.formula.ptg.AbstractFunctionPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.AddPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.Area3DPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.AreaPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.ArrayPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.AttrPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.BoolPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.ConcatPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.DividePtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.EqualPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.ErrPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.FuncPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.FuncVarPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.GreaterEqualPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.GreaterThanPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.IntPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.LessEqualPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.LessThanPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.MemAreaPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.MemFuncPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.MissingArgPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.MultiplyPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.NamePtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.NameXPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.NotEqualPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.NumberPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.OperandPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.OperationPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.ParenthesisPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.PercentPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.PowerPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.Ptg;
import com.example.alldocument.library.fc.hssf.formula.ptg.RangePtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.Ref3DPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.RefPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.StringPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.SubtractPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.UnaryMinusPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.UnaryPlusPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.UnionPtg;
import com.example.alldocument.library.fc.hssf.formula.ptg.ValueOperatorPtg;
import com.example.alldocument.library.fc.ss.SpreadsheetVersion;
import com.example.alldocument.library.fc.ss.usermodel.ErrorConstants;
import com.example.alldocument.library.fc.ss.util.AreaReference;
import com.example.alldocument.library.fc.ss.util.CellReference;
import com.example.alldocument.library.fc.ss.util.CellReference.NameType;
...
public final class FormulaParser {
	...
	private com.example.alldocument.library.fc.hssf.formula.ParseNode _rootNode;
	...
	private com.example.alldocument.library.fc.hssf.formula.ParseNode parseRangeExpression() {
		com.example.alldocument.library.fc.hssf.formula.ParseNode result = parseRangeable();
		boolean hasRange = false;
		while (look == ':') {
			int pos = _pointer;
			GetChar();
			com.example.alldocument.library.fc.hssf.formula.ParseNode nextPart = parseRangeable();
			...
			com.example.alldocument.library.fc.hssf.formula.ParseNode[] children = { result, nextPart, };
			result = new com.example.alldocument.library.fc.hssf.formula.ParseNode(RangePtg.instance, children);
			hasRange = true;
		}
		if (hasRange) {
	...
	private static com.example.alldocument.library.fc.hssf.formula.ParseNode augmentWithMemPtg(com.example.alldocument.library.fc.hssf.formula.ParseNode root) {
		Ptg memPtg;
		...
		return new com.example.alldocument.library.fc.hssf.formula.ParseNode(memPtg, root);
	}
	/**
	 ...
	 *
	 */
	private static boolean needsMemFunc(com.example.alldocument.library.fc.hssf.formula.ParseNode root) {
		...
		if (token instanceof OperationPtg || token instanceof ParenthesisPtg) {
			...
			for(com.example.alldocument.library.fc.hssf.formula.ParseNode child : root.getChildren()) {
	 ...
	 */
	private static void checkValidRangeOperand(String sideName, int currentParsePosition, com.example.alldocument.library.fc.hssf.formula.ParseNode pn) {
	 ...
	 */
	private static boolean isValidRangeOperand(com.example.alldocument.library.fc.hssf.formula.ParseNode a) {
		Ptg tkn = a.getToken();
	 ...
	 *
	 */
	private com.example.alldocument.library.fc.hssf.formula.ParseNode parseRangeable() {
		SkipWhite();
		...
		if (part1 == null) {
			if (sheetIden != null) {
                if(look == '#'){  // error ref like MySheet!#REF!
                    return new com.example.alldocument.library.fc.hssf.formula.ParseNode(ErrPtg.valueOf(parseErrorLiteral()));
                } else {
	 ...
	 * </pre>
	 */
	private com.example.alldocument.library.fc.hssf.formula.ParseNode parseNonRange(int savePointer) {
		resetPointer(savePointer);

		if (Character.isDigit(look)) {
			return new com.example.alldocument.library.fc.hssf.formula.ParseNode(parseNumber());
		}
		if (look == '"') {
			return new com.example.alldocument.library.fc.hssf.formula.ParseNode(new StringPtg(parseStringLiteral()));
		}
		...
		if (name.equalsIgnoreCase("TRUE") || name.equalsIgnoreCase("FALSE")) {
			return  new com.example.alldocument.library.fc.hssf.formula.ParseNode(BoolPtg.valueOf(name.equalsIgnoreCase("TRUE")));
		}
		if (_book == null) {
		...
		if (evalName.isRange()) {
			return new com.example.alldocument.library.fc.hssf.formula.ParseNode(evalName.createPtg());
		}
	 ...
	 */
	private com.example.alldocument.library.fc.hssf.formula.ParseNode createAreaRefParseNode(SheetIdentifier sheetIden, SimpleRangePart part1,
		...
		return new com.example.alldocument.library.fc.hssf.formula.ParseNode(ptg);
	}
	 ...
	 */
	private com.example.alldocument.library.fc.hssf.formula.ParseNode function(String name) {
		Ptg nameToken = null;
		...
		Match('(');
		com.example.alldocument.library.fc.hssf.formula.ParseNode[] args = Arguments();
		Match(')');
	 ...
	 */
	private com.example.alldocument.library.fc.hssf.formula.ParseNode getFunction(String name, Ptg namePtg, com.example.alldocument.library.fc.hssf.formula.ParseNode[] args) {
		...
		if(fm == null) {
			...
			com.example.alldocument.library.fc.hssf.formula.ParseNode[] allArgs = new com.example.alldocument.library.fc.hssf.formula.ParseNode[numArgs+1];
			allArgs[0] = new com.example.alldocument.library.fc.hssf.formula.ParseNode(namePtg);
			System.arraycopy(args, 0, allArgs, 1, numArgs);
			return new com.example.alldocument.library.fc.hssf.formula.ParseNode(FuncVarPtg.create(name, numArgs+1), allArgs);
		}
		...
		if (funcIx == FunctionMetadataRegistry.FUNCTION_INDEX_SUM && args.length == 1) {
			...
			return new com.example.alldocument.library.fc.hssf.formula.ParseNode(AttrPtg.getSumSingle(), args);
		...
		return new com.example.alldocument.library.fc.hssf.formula.ParseNode(retval, args);
	}
	...
	private com.example.alldocument.library.fc.hssf.formula.ParseNode[] Arguments() {
		//average 2 args per function
		List<com.example.alldocument.library.fc.hssf.formula.ParseNode> temp = new ArrayList<com.example.alldocument.library.fc.hssf.formula.ParseNode>(2);
		SkipWhite();
		if(look == ')') {
			return com.example.alldocument.library.fc.hssf.formula.ParseNode.EMPTY_ARRAY;
		}
		...
		while (true) {
			...
			if (isArgumentDelimiter(look)) {
				if (missedPrevArg) {
					temp.add(new com.example.alldocument.library.fc.hssf.formula.ParseNode(MissingArgPtg.instance));
					numArgs++;
				}
				if (look == ')') {
					break;
		...
		com.example.alldocument.library.fc.hssf.formula.ParseNode[] result = new com.example.alldocument.library.fc.hssf.formula.ParseNode[temp.size()];
		temp.toArray(result);
		return result;
	}

   /** Parse and Translate a Math Factor  */
	private com.example.alldocument.library.fc.hssf.formula.ParseNode powerFactor() {
		com.example.alldocument.library.fc.hssf.formula.ParseNode result = percentFactor();
		while(true) {
			SkipWhite();
			if(look != '^') {
				return result;
			...
			Match('^');
			com.example.alldocument.library.fc.hssf.formula.ParseNode other = percentFactor();
			result = new com.example.alldocument.library.fc.hssf.formula.ParseNode(PowerPtg.instance, result, other);
		}
	}

	private com.example.alldocument.library.fc.hssf.formula.ParseNode percentFactor() {
		com.example.alldocument.library.fc.hssf.formula.ParseNode result = parseSimpleFactor();
		while(true) {
			SkipWhite();
			if(look != '%') {
				return result;
			...
			Match('%');
			result = new com.example.alldocument.library.fc.hssf.formula.ParseNode(PercentPtg.instance, result);
		}
	}
	 ...
	 * factors (without ^ or % )
	 */
	private com.example.alldocument.library.fc.hssf.formula.ParseNode parseSimpleFactor() {
		SkipWhite();
		switch(look) {
			case '#':
				return new com.example.alldocument.library.fc.hssf.formula.ParseNode(ErrPtg.valueOf(parseErrorLiteral()));
			...
			case '(':
				Match('(');
				com.example.alldocument.library.fc.hssf.formula.ParseNode inside = comparisonExpression();
				Match(')');
				return new com.example.alldocument.library.fc.hssf.formula.ParseNode(ParenthesisPtg.instance, inside);
			case '"':
				return new com.example.alldocument.library.fc.hssf.formula.ParseNode(new StringPtg(parseStringLiteral()));
			case '{':
				Match('{');
				com.example.alldocument.library.fc.hssf.formula.ParseNode arrayNode = parseArray();
				Match('}');
				return arrayNode;
		}
	...
	private com.example.alldocument.library.fc.hssf.formula.ParseNode parseUnary(boolean isPlus) {

		boolean numberFollows = IsDigit(look) || look=='.';
		com.example.alldocument.library.fc.hssf.formula.ParseNode factor = powerFactor();
		...
		if (numberFollows) {
			...
			if (token instanceof NumberPtg) {
				...
				return new com.example.alldocument.library.fc.hssf.formula.ParseNode(token);
			}
		...
		return new com.example.alldocument.library.fc.hssf.formula.ParseNode(isPlus ? UnaryPlusPtg.instance : UnaryMinusPtg.instance, factor);
	}

	private com.example.alldocument.library.fc.hssf.formula.ParseNode parseArray() {
		...
		return new com.example.alldocument.library.fc.hssf.formula.ParseNode(new ArrayPtg(values2d));
	}
	...
	private com.example.alldocument.library.fc.hssf.formula.ParseNode Term() {
		com.example.alldocument.library.fc.hssf.formula.ParseNode result = powerFactor();
		while(true) {
			SkipWhite();
			Ptg operator;
			switch(look) {
			...
			com.example.alldocument.library.fc.hssf.formula.ParseNode other = powerFactor();
			result = new com.example.alldocument.library.fc.hssf.formula.ParseNode(operator, result, other);
		}
	}
	private com.example.alldocument.library.fc.hssf.formula.ParseNode unionExpression() {
		com.example.alldocument.library.fc.hssf.formula.ParseNode result = comparisonExpression();
		...
		while (true) {
			...
			switch(look) {
				case ',':
					GetChar();
					hasUnions = true;
					com.example.alldocument.library.fc.hssf.formula.ParseNode other = comparisonExpression();
					result = new com.example.alldocument.library.fc.hssf.formula.ParseNode(UnionPtg.instance, result, other);
					continue;
			}
			if (hasUnions) {
				return augmentWithMemPtg(result);
	...
	private com.example.alldocument.library.fc.hssf.formula.ParseNode comparisonExpression() {
		com.example.alldocument.library.fc.hssf.formula.ParseNode result = concatExpression();
		while (true) {
			SkipWhite();
			switch(look) {
				case '=':
				...
				case '<':
					...
					com.example.alldocument.library.fc.hssf.formula.ParseNode other = concatExpression();
					result = new com.example.alldocument.library.fc.hssf.formula.ParseNode(comparisonToken, result, other);
					continue;
			}
	...
	private com.example.alldocument.library.fc.hssf.formula.ParseNode concatExpression() {
		com.example.alldocument.library.fc.hssf.formula.ParseNode result = additiveExpression();
		while (true) {
			SkipWhite();
			if(look != '&') {
			...
			Match('&');
			com.example.alldocument.library.fc.hssf.formula.ParseNode other = additiveExpression();
			result = new com.example.alldocument.library.fc.hssf.formula.ParseNode(ConcatPtg.instance, result, other);
		}
		return result;
	}
	...
	private com.example.alldocument.library.fc.hssf.formula.ParseNode additiveExpression() {
		com.example.alldocument.library.fc.hssf.formula.ParseNode result = Term();
		while (true) {
			SkipWhite();
			Ptg operator;
			switch(look) {
			...
			com.example.alldocument.library.fc.hssf.formula.ParseNode other = Term();
			result = new com.example.alldocument.library.fc.hssf.formula.ParseNode(operator, result, other);
		}
	}
...
begin
   ...
   Expression;
	...
	private Ptg[] getRPNPtg(int formulaType) {
		...
		return com.example.alldocument.library.fc.hssf.formula.ParseNode.toTokenArray(_rootNode);
	}
}
