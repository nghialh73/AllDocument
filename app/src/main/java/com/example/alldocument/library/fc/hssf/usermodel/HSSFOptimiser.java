...
public class HSSFOptimiser {
	 ...
	 * For now, only works on fonts used in {@link com.example.alldocument.library.fc.hssf.usermodel.HSSFCellStyle}
	 ...
	 */
	public static void optimiseFonts(com.example.alldocument.library.fc.hssf.usermodel.HSSFWorkbook workbook) {
		...
		for(int sheetNum=0; sheetNum<workbook.getNumberOfSheets(); sheetNum++) {
			com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet s = workbook.getSheetAt(sheetNum);
			Iterator rIt = s.rowIterator();
			while(rIt.hasNext()) {
				com.example.alldocument.library.fc.hssf.usermodel.HSSFRow row = (com.example.alldocument.library.fc.hssf.usermodel.HSSFRow)rIt.next();
				Iterator cIt = row.cellIterator();
				while(cIt.hasNext()) {
					com.example.alldocument.library.fc.hssf.usermodel.HSSFCell cell = (com.example.alldocument.library.fc.hssf.usermodel.HSSFCell)cIt.next();
					if(cell.getCellType() == com.example.alldocument.library.fc.hssf.usermodel.HSSFCell.CELL_TYPE_STRING) {
	 ...
	 *  {@link #optimiseFonts(com.example.alldocument.library.fc.hssf.usermodel.HSSFWorkbook)} first.
	...
	public static void optimiseCellStyles(HSSFWorkbook workbook) {
		...
		for(int sheetNum=0; sheetNum<workbook.getNumberOfSheets(); sheetNum++) {
			...
			Iterator rIt = s.rowIterator();
			while(rIt.hasNext()) {
				com.example.alldocument.library.fc.hssf.usermodel.HSSFRow row = (HSSFRow)rIt.next();
				Iterator cIt = row.cellIterator();
				while(cIt.hasNext()) {
					com.example.alldocument.library.fc.hssf.usermodel.HSSFCell cell = (HSSFCell)cIt.next();
