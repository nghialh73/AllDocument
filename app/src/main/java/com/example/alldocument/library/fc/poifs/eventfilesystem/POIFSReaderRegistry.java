...
import com.example.alldocument.library.fc.poifs.filesystem.DocumentDescriptor;
...
class POIFSReaderRegistry
{
    ...
    void registerListener(final com.example.alldocument.library.fc.poifs.eventfilesystem.POIFSReaderListener listener,
    ...
    private void removeSelectiveListener(final com.example.alldocument.library.fc.poifs.eventfilesystem.POIFSReaderListener listener)
    {
