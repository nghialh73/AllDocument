...
public abstract class Crossings {
    ...
    public boolean accumulateQuad(double x0, double y0, double coords[]) {
        ...
        com.example.alldocument.library.java.awt.geom.Curve.insertQuad(tmp, x0, y0, coords);
    ...
    public boolean accumulateCubic(double x0, double y0, double coords[]) {
        ...
        com.example.alldocument.library.java.awt.geom.Curve.insertCubic(tmp, x0, y0, coords);
        Enumeration enum_ = tmp.elements();
        while (enum_.hasMoreElements()) {
            com.example.alldocument.library.java.awt.geom.Curve c = (Curve) enum_.nextElement();
            if (c.accumulateCrossings(this)) {
                return true;
            }
        }
