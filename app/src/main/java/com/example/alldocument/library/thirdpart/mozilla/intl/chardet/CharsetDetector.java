...
import com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsDetector;
...
public class CharsetDetector
{
    ...
    public static String detect(BufferedInputStream imp) throws Exception
    {
        ...
        com.example.alldocument.library.thirdpart.mozilla.intl.chardet.nsDetector det = new nsDetector(nsPSMDetector.ALL);
