...
public class WPPictureShape extends WPAutoShape
{
    ...
    public void setPictureShape(com.example.alldocument.library.common.shape.PictureShape pictureShape)
    {
    ...
    public com.example.alldocument.library.common.shape.PictureShape getPictureShape()
    {
        return pictureShape;
    }
