...
public class RoutedInputStream extends DecodingInputStream {
	...
	public int read() throws IOException {
		...
		NEWSTATE: while (true) {
			...
			case ROUTEINFORM:
				...
				// state ROUTED.
				((com.example.alldocument.library.thirdpart.emf.io.RouteListener) listeners.get(start)).routeFound(route);
	 ...
	 */
	public void addRoute(String start, String end, com.example.alldocument.library.thirdpart.emf.io.RouteListener listener) {
