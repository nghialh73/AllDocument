...
import com.example.alldocument.library.fc.hwpf.model.types.CHPAbstractType;
  ...
  extends CHPAbstractType implements Cloneable
{
  ...
  public void setHighlighted(byte color)
  {
    ...
    public Object clone() throws CloneNotSupportedException
    {
        ...
        cp.setDttmRMark( (com.example.alldocument.library.fc.hwpf.usermodel.DateAndTime) getDttmRMark().clone() );
        cp.setDttmRMarkDel( (com.example.alldocument.library.fc.hwpf.usermodel.DateAndTime) getDttmRMarkDel().clone() );
        cp.setDttmPropRMark( (com.example.alldocument.library.fc.hwpf.usermodel.DateAndTime) getDttmPropRMark().clone() );
