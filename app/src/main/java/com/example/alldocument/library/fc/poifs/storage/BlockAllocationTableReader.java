...
package com.example.alldocument.library.fc.poifs.storage;
...
import com.example.alldocument.library.fc.poifs.storage.ListManagedBlock;
import com.example.alldocument.library.fc.poifs.storage.RawDataBlock;
import com.example.alldocument.library.fc.util.IntList;
...
public final class BlockAllocationTableReader {
    ...
    public BlockAllocationTableReader(POIFSBigBlockSize bigBlockSize, int block_count, int [] block_array,
            int xbat_count, int xbat_index, com.example.alldocument.library.fc.poifs.storage.BlockList raw_block_list) throws IOException {
        this(bigBlockSize);
        ...
        com.example.alldocument.library.fc.poifs.storage.RawDataBlock blocks[] = new com.example.alldocument.library.fc.poifs.storage.RawDataBlock[ block_count ];
        ...
        for (block_index = 0; block_index < limit; block_index++)
        {
            ...
            blocks[ block_index ] =
                (com.example.alldocument.library.fc.poifs.storage.RawDataBlock) raw_block_list.remove(nextOffset);
        }
     ...
     */
    BlockAllocationTableReader(POIFSBigBlockSize bigBlockSize, com.example.alldocument.library.fc.poifs.storage.ListManagedBlock[] blocks, com.example.alldocument.library.fc.poifs.storage.BlockList raw_block_list)
            throws IOException {
        this(bigBlockSize);
        setEntries(blocks, raw_block_list);
    }
     ...
     */
    com.example.alldocument.library.fc.poifs.storage.ListManagedBlock[] fetchBlocks(int startBlock, int headerPropertiesStartBlock,
                                                                      com.example.alldocument.library.fc.poifs.storage.BlockList blockList) throws IOException {
        List<com.example.alldocument.library.fc.poifs.storage.ListManagedBlock> blocks = new ArrayList<com.example.alldocument.library.fc.poifs.storage.ListManagedBlock>();
        int  currentBlock = startBlock;
        boolean firstPass = true;
        com.example.alldocument.library.fc.poifs.storage.ListManagedBlock dataBlock = null;
        ...
        return blocks.toArray(new com.example.alldocument.library.fc.poifs.storage.ListManagedBlock[blocks.size()]);
    }
