...
public class Section
{
     ...
     */
    protected com.example.alldocument.library.fc.hpsf.ClassID formatID;
     ...
     */
    public com.example.alldocument.library.fc.hpsf.ClassID getFormatID()
    {
        return formatID;
    }
    ...
    throws UnsupportedEncodingException
    {
         ...
         * Read the format ID.
         */
        formatID = new com.example.alldocument.library.fc.hpsf.ClassID(src, o1);
        o1 += ClassID.LENGTH;
