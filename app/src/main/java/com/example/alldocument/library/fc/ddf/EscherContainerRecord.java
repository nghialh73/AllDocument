 ...
 */
public final class EscherContainerRecord extends com.example.alldocument.library.fc.ddf.EscherRecord
{
    ...
    private final List<com.example.alldocument.library.fc.ddf.EscherRecord> _childRecords = new ArrayList<com.example.alldocument.library.fc.ddf.EscherRecord>();
    ...
    public int fillFields(byte[] data, int pOffset, EscherRecordFactory recordFactory)
    {
        ...
        {
            com.example.alldocument.library.fc.ddf.EscherRecord child = recordFactory.createRecord(data, offset);
...
//                    + " bytes remaining but no space left");
    ...
    public int serialize(int offset, byte[] data, EscherSerializationListener listener)
    {
        ...
        Iterator<com.example.alldocument.library.fc.ddf.EscherRecord> iterator = _childRecords.iterator();
        while (iterator.hasNext())
        {
            com.example.alldocument.library.fc.ddf.EscherRecord r = iterator.next();
    ...
    public com.example.alldocument.library.fc.ddf.EscherRecord getChild(int index)
    {
     ...
     */
    public List<com.example.alldocument.library.fc.ddf.EscherRecord> getChildRecords()
    {
        return new ArrayList<com.example.alldocument.library.fc.ddf.EscherRecord>(_childRecords);
    }

    public Iterator<com.example.alldocument.library.fc.ddf.EscherRecord> getChildIterator()
    {
        return new ReadOnlyIterator(_childRecords);
    }

    private static final class ReadOnlyIterator implements Iterator<com.example.alldocument.library.fc.ddf.EscherRecord>
    {
        private final List<com.example.alldocument.library.fc.ddf.EscherRecord> _list;
        private int _index;

        public ReadOnlyIterator(List<com.example.alldocument.library.fc.ddf.EscherRecord> list)
        {
            _list = list;
            _index = 0;
        }
        ...
        public com.example.alldocument.library.fc.ddf.EscherRecord next()
        {
            if (!hasNext())
            {
     ...
     */
    public void setChildRecords(List<com.example.alldocument.library.fc.ddf.EscherRecord> childRecords)
    {
    ...
    public boolean removeChildRecord(com.example.alldocument.library.fc.ddf.EscherRecord toBeRemoved)
    {
    ...
    public void display(PrintWriter w, int indent)
    {
        ...
        for (Iterator<com.example.alldocument.library.fc.ddf.EscherRecord> iterator = _childRecords.iterator(); iterator.hasNext();)
        {
            com.example.alldocument.library.fc.ddf.EscherRecord escherRecord = iterator.next();
            escherRecord.display(w, indent + 1);
        }
    }

    public void addChildRecord(com.example.alldocument.library.fc.ddf.EscherRecord record)
    {
        _childRecords.add(record);
    }

    public void addChildBefore(com.example.alldocument.library.fc.ddf.EscherRecord record, int insertBeforeRecordId)
    {
        for (int i = 0; i < _childRecords.size(); i++)
        {
            com.example.alldocument.library.fc.ddf.EscherRecord rec = _childRecords.get(i);
    ...
    public String toString()
    {
        ...
        if (_childRecords.size() > 0)
        {
            ...
            for (Iterator<com.example.alldocument.library.fc.ddf.EscherRecord> iterator = _childRecords.iterator(); iterator.hasNext();)
            {
                com.example.alldocument.library.fc.ddf.EscherRecord record = iterator.next();
    ...
    public <T extends com.example.alldocument.library.fc.ddf.EscherRecord>T getChildById(short recordId)
    {
        for (com.example.alldocument.library.fc.ddf.EscherRecord childRecord : _childRecords)
        {
     ...
     */
    public void getRecordsById(short recordId, List<com.example.alldocument.library.fc.ddf.EscherRecord> out)
    {
        Iterator<com.example.alldocument.library.fc.ddf.EscherRecord> iterator = _childRecords.iterator();
        while (iterator.hasNext())
        {
