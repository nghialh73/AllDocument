...
import com.example.alldocument.library.fc.POIDocument;
import com.example.alldocument.library.fc.codec.DigestUtils;
...
import com.example.alldocument.library.fc.hssf.OldExcelFormatException;
...
import com.example.alldocument.library.fc.hssf.formula.udf.AggregatingUDFFinder;
import com.example.alldocument.library.fc.hssf.formula.udf.UDFFinder;
import com.example.alldocument.library.fc.hssf.model.DrawingManager2;
import com.example.alldocument.library.fc.hssf.model.HSSFFormulaParser;
...
import com.example.alldocument.library.fc.hssf.record.EmbeddedObjectRefSubRecord;
...
import com.example.alldocument.library.fc.hssf.record.LabelSSTRecord;
...
import com.example.alldocument.library.fc.hssf.record.RecalcIdRecord;
...
import com.example.alldocument.library.fc.hssf.record.SubRecord;
import com.example.alldocument.library.fc.hssf.record.UnknownRecord;
import com.example.alldocument.library.fc.hssf.record.aggregates.RecordAggregate.RecordVisitor;
import com.example.alldocument.library.fc.hssf.record.common.UnicodeString;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFCellStyle;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFCreationHelper;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFDataFormat;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFFont;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFName;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFObjectData;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFPalette;
import com.example.alldocument.library.fc.hssf.usermodel.HSSFPictureData;
...
import com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet;
import com.example.alldocument.library.fc.hssf.util.CellReference;
import com.example.alldocument.library.fc.poifs.filesystem.DirectoryNode;
import com.example.alldocument.library.fc.poifs.filesystem.POIFSFileSystem;
import com.example.alldocument.library.fc.ss.usermodel.IRow.MissingCellPolicy;
import com.example.alldocument.library.fc.ss.util.WorkbookUtil;
 ...
 * @see com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet
 * @author  Andrew C. Oliver (acoliver at apache dot org)
 * @author  Glen Stampoultzis (glens at apache.org)
 * @author  Shawn Laubach (slaubach at apache dot org)
 */
public final class HSSFWorkbook extends POIDocument implements com.example.alldocument.library.fc.ss.usermodel.Workbook
{
    ...
    protected List<com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet> _sheets;

    /**
     * this holds the HSSFName objects attached to this workbook
     */

    private ArrayList<com.example.alldocument.library.fc.hssf.usermodel.HSSFName> names;
     ...
     */
    private MissingCellPolicy missingCellPolicy = com.example.alldocument.library.fc.hssf.usermodel.HSSFRow.RETURN_NULL_AND_BLANK;
    ...
    // SS中配色方案
    private com.example.alldocument.library.fc.hssf.usermodel.HSSFPalette palette;
    ...
    private HSSFWorkbook(InternalWorkbook book)
    {
        ...
        workbook = book;
        _sheets = new ArrayList<com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet>(INITIAL_CAPACITY);
        names = new ArrayList<com.example.alldocument.library.fc.hssf.usermodel.HSSFName>(INITIAL_CAPACITY);
    }
    ...
    public HSSFWorkbook(DirectoryNode directory, boolean preserveNodes) throws IOException
    {
        ...
        while (rs.hasNext())
        {
            ...
            _sheets.add(new com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet(this, sheet));
        }
...
//            names.add(name);
    ...
    public void setSheetOrder(String sheetname, int pos)
    {
        ...
        for (com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet sheet : _sheets)
        {
     ...
     * @see com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet#setSelected(boolean)
     */
     ...
     */
    public int getSheetIndex(com.example.alldocument.library.fc.ss.usermodel.Sheet sheet)
    {
    ...
    public com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet createSheet()
    {
        com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet sheet = new com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet(this);
    ...
    public com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet cloneSheet(int sheetIndex)
    {
        validateSheetIndex(sheetIndex);
        com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet srcSheet = _sheets.get(sheetIndex);
        String srcName = workbook.getSheetName(sheetIndex);
        com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet clonedSheet = srcSheet.cloneSheet(this);
...
//            names.add(newName);
     ...
     *      for a safe way to create valid names
     */
    public com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet createSheet(String sheetname)
    {
        if (sheetname == null)
        {
            throw new IllegalArgumentException("sheetName must not be null");
    ...
    private com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet[] getSheets()
    {
        com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet[] result = new com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet[_sheets.size()];
    ...
    public com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet getSheetAt(int index)
    {
        validateSheetIndex(index);
        return (com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet)_sheets.get(index);
    }
    ...
    public com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet getSheet(String name)
    {
        com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet retval = null;
        ...
        for (int k = 0; k < _sheets.size(); k++)
        {
            ...
            {
                retval = (com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet)_sheets.get(k);
            }
        }
        return retval;
    }
        ...
        int startRow, int endRow)
    {
        ...
        com.example.alldocument.library.fc.hssf.usermodel.HSSFSheet sheet = getSheetAt(sheetIndex);
...
//            names.add(newName);
    ...
    public com.example.alldocument.library.fc.hssf.usermodel.HSSFFont createFont()
    {
     ...
     */
    public com.example.alldocument.library.fc.hssf.usermodel.HSSFFont findFont(short boldWeight, short color, short fontHeight, String name,
                                                                 boolean italic, boolean strikeout, short typeOffset, byte underline)
    {
        for (short i = 0; i <= getNumberOfFonts(); i++)
        {
            ...
            com.example.alldocument.library.fc.hssf.usermodel.HSSFFont hssfFont = getFontAt(i);
     ...
     */
    public com.example.alldocument.library.fc.hssf.usermodel.HSSFFont getFontAt(short idx)
    {
        if (fonts == null)
            fonts = new Hashtable();
        ...
        {
            return (com.example.alldocument.library.fc.hssf.usermodel.HSSFFont)fonts.get(sIdx);
        }

        FontRecord font = workbook.getFontRecordAt(idx);
        com.example.alldocument.library.fc.hssf.usermodel.HSSFFont retval = new HSSFFont(idx, font);
    ...
    public com.example.alldocument.library.fc.hssf.usermodel.HSSFName getName(String name)
    {
        ...
        return (com.example.alldocument.library.fc.hssf.usermodel.HSSFName)names.get(nameIndex);
    }

    public com.example.alldocument.library.fc.hssf.usermodel.HSSFName getNameAt(int nameIndex)
    {
...
//        return newName;
     ...
     * @see com.example.alldocument.library.fc.hssf.record.FormatRecord
     * @see Record
     */
    ...
    public com.example.alldocument.library.fc.hssf.usermodel.HSSFPalette getCustomPalette()
    {
        if (palette == null)
        {
