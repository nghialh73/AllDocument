...
public interface CFBConstants
{
    ...
    public static final com.example.alldocument.library.fc.fs.filesystem.BlockSize SMALLER_BIG_BLOCK_SIZE_DETAILS = new com.example.alldocument.library.fc.fs.filesystem.BlockSize(SMALLER_BIG_BLOCK_SIZE, (short)9);
    /** Some use 4096 bytes */
    public static final int LARGER_BIG_BLOCK_SIZE = 0x1000;
    public static final com.example.alldocument.library.fc.fs.filesystem.BlockSize LARGER_BIG_BLOCK_SIZE_DETAILS = new BlockSize(LARGER_BIG_BLOCK_SIZE, (short)12);
