...
import com.example.alldocument.library.fc.hwpf.sprm.TableSprmCompressor;
...
public class Paragraph extends com.example.alldocument.library.fc.hwpf.usermodel.Range implements Cloneable
{
  ...
  protected Paragraph(PAPX papx, com.example.alldocument.library.fc.hwpf.usermodel.Range parent)
  {
