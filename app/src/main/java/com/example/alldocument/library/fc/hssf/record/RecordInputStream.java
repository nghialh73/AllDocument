...
import com.example.alldocument.library.fc.hssf.record.crypto.Biff8DecryptingStream;
...
public final class RecordInputStream implements LittleEndianInput {
	...
	private final com.example.alldocument.library.fc.hssf.record.BiffHeaderInput _bhi;
  ...
  public byte[] readAllContinuedRemainder() {
	...
	/**
	 *
	 * @return <code>true</code> when a {@link com.example.alldocument.library.fc.hssf.record.ContinueRecord} is next.
	 */
