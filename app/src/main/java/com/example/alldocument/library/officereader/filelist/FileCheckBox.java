...
public class FileCheckBox extends CheckBox
{
     ...
     * @param context
     */
    public FileCheckBox(Context context, IControl control, com.example.alldocument.library.officereader.filelist.FileItem fileItem)
    {
        super(context);
     ...
     * 
     */
    public void setFileItem(com.example.alldocument.library.officereader.filelist.FileItem fileItem)
    {
        this.fileItem = fileItem;
