...
import com.example.alldocument.library.fc.hpsf.MutablePropertySet;
 ...
 * com.example.alldocument.library.fc.hpsf.PropertySet}. Creating a special subclass should be as easy as
 * calling the special subclass' constructor and pass the general
 * {@link com.example.alldocument.library.fc.hpsf.PropertySet} in. To make things easy internally, the special
 * class just holds a reference to the general {@link com.example.alldocument.library.fc.hpsf.PropertySet} and
 ...
 * general {@link com.example.alldocument.library.fc.hpsf.PropertySet}.  However, the current implementation
 ...
 */
public abstract class SpecialPropertySet extends com.example.alldocument.library.fc.hpsf.MutablePropertySet
{
	/**
     ...
     * delegates to.</p>
     */
    private com.example.alldocument.library.fc.hpsf.MutablePropertySet delegate;
     ...
     */
    public SpecialPropertySet(final com.example.alldocument.library.fc.hpsf.PropertySet ps)
    {
        delegate = new com.example.alldocument.library.fc.hpsf.MutablePropertySet(ps);
    }
    ...
    /**
     * @see com.example.alldocument.library.fc.hpsf.PropertySet#getByteOrder
     */
    ...
    /**
     * @see com.example.alldocument.library.fc.hpsf.PropertySet#getFormat
     */
    ...
    /**
     * @see com.example.alldocument.library.fc.hpsf.PropertySet#getOSVersion
     */
    ...
    /**
     * @see com.example.alldocument.library.fc.hpsf.PropertySet#getClassID
     */
    ...
    /**
     * @see com.example.alldocument.library.fc.hpsf.PropertySet#getSectionCount
     */
    ...
    /**
     * @see com.example.alldocument.library.fc.hpsf.PropertySet#getSections
     */
    ...
    /**
     * @see com.example.alldocument.library.fc.hpsf.PropertySet#isSummaryInformation
     */
    ...
    /**
     * @see com.example.alldocument.library.fc.hpsf.PropertySet#isDocumentSummaryInformation
     */
    ...
    /**
     * @see MutablePropertySet#addSection(com.example.alldocument.library.fc.hpsf.Section)
     */
    ...
    /**
     * @see MutablePropertySet#setClassID(com.example.alldocument.library.fc.hpsf.ClassID)
     */
