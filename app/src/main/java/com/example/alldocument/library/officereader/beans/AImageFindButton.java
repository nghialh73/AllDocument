 ...
 * 时间:              下午1:48:27
 */
package com.example.alldocument.library.officereader.beans;
...
public class AImageFindButton extends LinearLayout implements OnGestureListener, OnClickListener
{
        ...
        int btnWidth, int height, TextWatcher textWatcher)
    {
        ...
        //search button
        btn = new com.example.alldocument.library.officereader.beans.AImageButton(context, control,
    ...
    {
        if(!longPressed && v instanceof com.example.alldocument.library.officereader.beans.AImageButton)
        {
           ...
           imm.hideSoftInputFromInputMethod(editText.getWindowToken(),InputMethodManager.HIDE_NOT_ALWAYS);  
            ...
            control.actionEvent(((com.example.alldocument.library.officereader.beans.AImageButton)v).getActionID(), editText.getText().toString());
        }
