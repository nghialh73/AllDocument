...
public abstract class LogicalFunction extends Fixed1ArgFunction {
	...
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function ISLOGICAL = new LogicalFunction() {
		protected boolean evaluate(ValueEval arg) {
			return arg instanceof BoolEval;
		}
	};
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function ISNONTEXT = new LogicalFunction() {
		protected boolean evaluate(ValueEval arg) {
			return !(arg instanceof StringEval);
		}
	};
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function ISNUMBER = new LogicalFunction() {
		protected boolean evaluate(ValueEval arg) {
			return arg instanceof NumberEval;
		}
	};
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function ISTEXT = new LogicalFunction() {
		protected boolean evaluate(ValueEval arg) {
			return arg instanceof StringEval;
		}
	};

	public static final com.example.alldocument.library.fc.hssf.formula.function.Function ISBLANK = new LogicalFunction() {
	...
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function ISERROR = new LogicalFunction() {
	 ...
	 */
	public static final com.example.alldocument.library.fc.hssf.formula.function.Function ISNA = new LogicalFunction() {
