...
public final class PackageRelationship
{
     ...
     */
    private com.example.alldocument.library.fc.openxml4j.opc.PackagePart source;

    /**
     * Le mode de ciblage [Internal|External]
     */
    private com.example.alldocument.library.fc.openxml4j.opc.TargetMode targetMode;
     ...
     * @param id
     */
    public PackageRelationship(com.example.alldocument.library.fc.openxml4j.opc.ZipPackage pkg, com.example.alldocument.library.fc.openxml4j.opc.PackagePart sourcePart, URI targetUri,
    ...
    public URI getSourceURI()
    {
        if (source == null)
        {
            return com.example.alldocument.library.fc.openxml4j.opc.PackagingURIHelper.PACKAGE_ROOT_URI;
        }
     ...
     */
    public com.example.alldocument.library.fc.openxml4j.opc.TargetMode getTargetMode()
    {
        return targetMode;
    }
