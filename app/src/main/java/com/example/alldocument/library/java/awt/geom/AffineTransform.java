...
import com.example.alldocument.library.java.awt.geom.NoninvertibleTransformException;
import com.example.alldocument.library.java.awt.geom.Path2D;
...
public class AffineTransform implements Cloneable, java.io.Serializable
{
     ...
     * in <code>ptDst</code>.
     * If <code>ptDst</code> is <code>null</code>, a new {@link com.example.alldocument.library.java.awt.geom.Point2D}
     ...
     * @since 1.2
     */
    public com.example.alldocument.library.java.awt.geom.Point2D transform(com.example.alldocument.library.java.awt.geom.Point2D ptSrc, com.example.alldocument.library.java.awt.geom.Point2D ptDst)
    {
        if (ptDst == null)
        {
            if (ptSrc instanceof com.example.alldocument.library.java.awt.geom.Point2D.Double)
            {
                ptDst = new com.example.alldocument.library.java.awt.geom.Point2D.Double();
            }
            else
            {
                ptDst = new com.example.alldocument.library.java.awt.geom.Point2D.Float();
            }
        }
     ...
     * @since 1.2
     */
    public void transform(com.example.alldocument.library.java.awt.geom.Point2D[] ptSrc, int srcOff, com.example.alldocument.library.java.awt.geom.Point2D[] ptDst, int dstOff, int numPts)
    {
        int state = this.state;
        while (--numPts >= 0)
        {
            // Copy source coords into local variables in case src == dst
            com.example.alldocument.library.java.awt.geom.Point2D src = ptSrc[srcOff++];
            double x = src.getX();
            double y = src.getY();
            com.example.alldocument.library.java.awt.geom.Point2D dst = ptDst[dstOff++];
            if (dst == null)
            {
                if (src instanceof com.example.alldocument.library.java.awt.geom.Point2D.Double)
                {
                    dst = new com.example.alldocument.library.java.awt.geom.Point2D.Double();
                }
                else
                {
                    dst = new com.example.alldocument.library.java.awt.geom.Point2D.Float();
                }
                ptDst[dstOff - 1] = dst;
            }
            switch (state)
     ...
     * @since 1.2
     */
    public com.example.alldocument.library.java.awt.geom.Point2D inverseTransform(com.example.alldocument.library.java.awt.geom.Point2D ptSrc, com.example.alldocument.library.java.awt.geom.Point2D ptDst)
     ...
     * @since 1.2
     */
    public com.example.alldocument.library.java.awt.geom.Point2D deltaTransform(com.example.alldocument.library.java.awt.geom.Point2D ptSrc, com.example.alldocument.library.java.awt.geom.Point2D ptDst)
    {
        if (ptDst == null)
        {
            if (ptSrc instanceof com.example.alldocument.library.java.awt.geom.Point2D.Double)
