...
public final class ComplexFileTable
{
    ...
    protected com.example.alldocument.library.fc.hwpf.model.TextPieceTable _tpt;

    private SprmBuffer[] _grpprls;

    public ComplexFileTable()
    {
        _tpt = new com.example.alldocument.library.fc.hwpf.model.TextPieceTable();
    }
        ...
        throws IOException
    {
        ...
        _tpt = new com.example.alldocument.library.fc.hwpf.model.TextPieceTable(documentStream, tableStream, offset, pieceTableSize, fcMin);
    }
