...
import com.example.alldocument.library.fc.ss.util.NormalisedDecimal;

import static com.example.alldocument.library.fc.ss.util.IEEEDouble.*;
...
public final class NumberComparer {
	...
	public static int compare(double a, double b) {
		...
		com.example.alldocument.library.fc.ss.util.ExpandedDouble edA = com.example.alldocument.library.fc.ss.util.ExpandedDouble.fromRawBitsAndExponent(rawBitsA, biasedExponentA - EXPONENT_BIAS);
		com.example.alldocument.library.fc.ss.util.ExpandedDouble edB = com.example.alldocument.library.fc.ss.util.ExpandedDouble.fromRawBitsAndExponent(rawBitsB, biasedExponentB - EXPONENT_BIAS);
