...
public abstract class PackagePart implements RelationshipSource
{
     ...
     */
    protected com.example.alldocument.library.fc.openxml4j.opc.ZipPackage _container;
     ...
     */
    protected PackagePart(com.example.alldocument.library.fc.openxml4j.opc.ZipPackage pack, PackagePartName partName, ContentType contentType)
        throws InvalidFormatException
    {
     ...
     */
    public PackagePart(com.example.alldocument.library.fc.openxml4j.opc.ZipPackage pack, PackagePartName partName, String contentType)
        throws InvalidFormatException
    {
        ...
        String id)
    {
        ...
        return _relationships.addRelationship(targetURI, com.example.alldocument.library.fc.openxml4j.opc.TargetMode.EXTERNAL, relationshipType, id);
    }
     ...
     */
    public PackageRelationship addRelationship(PackagePartName targetPartName,
                                               com.example.alldocument.library.fc.openxml4j.opc.TargetMode targetMode, String relationshipType, String id)
    {
     ...
     *      org.apache.poi.openxml4j.opc.TargetMode, String)
     */
    public PackageRelationship addRelationship(URI targetURI, com.example.alldocument.library.fc.openxml4j.opc.TargetMode targetMode,
