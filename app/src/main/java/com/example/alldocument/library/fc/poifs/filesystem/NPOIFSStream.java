...
import com.example.alldocument.library.fc.poifs.filesystem.BlockStore.ChainLoopDetector;
...
{
	private com.example.alldocument.library.fc.poifs.filesystem.BlockStore blockStore;
	 ...
	 */
	public NPOIFSStream(com.example.alldocument.library.fc.poifs.filesystem.BlockStore blockStore, int startBlock) {
