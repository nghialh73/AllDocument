...
import com.example.alldocument.library.fc.poifs.storage.PropertyBlock;
...
public final class PropertyTable extends PropertyTableBase implements BlockWritable {
    ...
    {
        com.example.alldocument.library.fc.poifs.property.Property[] properties = _properties.toArray(new Property[_properties.size()]);
