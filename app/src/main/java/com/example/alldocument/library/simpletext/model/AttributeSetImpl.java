 ...
 * <p>
 */
public class AttributeSetImpl implements com.example.alldocument.library.simpletext.model.IAttributeSet
{
    // 数组扩容值
    ...
    {        
        ...
        //  
        com.example.alldocument.library.simpletext.model.Style style = null;
        ...
        if (attrID < 0x0fff)
        {
            ...
            if (index >= 0)
            {
                style = com.example.alldocument.library.simpletext.model.StyleManage.instance().getStyle(arrayValue[index]);
     ...
     * 合并属性
     */
    public void mergeAttribute(com.example.alldocument.library.simpletext.model.IAttributeSet attr)
    {   
