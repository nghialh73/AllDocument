...
public class PGPrintMode extends FrameLayout implements IPageListViewListener
{
     ...
     *
     */
    public PGPrintMode(Context context, IControl control, PGModel pgModel, com.example.alldocument.library.pg.control.PGEditor editor)
    {
        super(context);
    ...
    public void exportImage(final APageListItem pageItem, final Bitmap srcBitmap)
    {
        ...
        com.example.alldocument.library.pg.control.PGFind find = (PGFind)control.getFind();
