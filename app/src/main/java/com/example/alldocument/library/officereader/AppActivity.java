...
import com.example.alldocument.library.officereader.beans.AImageCheckButton;
import com.example.alldocument.library.officereader.beans.AToolsbar;
import com.example.alldocument.library.officereader.beans.CalloutToolsbar;
import com.example.alldocument.library.officereader.beans.PDFToolsbar;
import com.example.alldocument.library.officereader.beans.PGToolsbar;
import com.example.alldocument.library.officereader.beans.SSToolsbar;
import com.example.alldocument.library.officereader.beans.WPToolsbar;
import com.example.alldocument.library.officereader.database.DBService;
import com.example.alldocument.library.pg.control.Presentation;
import com.example.alldocument.library.res.ResKit;
import com.example.alldocument.library.ss.sheetbar.SheetBar;
import com.example.alldocument.library.system.FileKit;
import com.example.alldocument.library.system.IControl;
import com.example.alldocument.library.system.IMainFrame;
import com.example.alldocument.library.system.MainControl;
import com.example.alldocument.library.system.beans.pagelist.IPageListViewListener;
import com.example.alldocument.library.system.dialog.ColorPickerDialog;
...
public class AppActivity extends FragmentActivity implements IMainFrame {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        appFrame = new com.example.alldocument.library.officereader.AppFrame(getApplicationContext());
        ...
        setTheme(control.getSysKit().isVertical(this) ? R.style.Theme_AllDocument : R.style.Theme_AllDocument);
...
//                appFrame.addView(calloutBar, 0);
    ...
    public void fileShare() {
        ...
        startActivity(Intent
                .createChooser(intent, getResources().getText(com.example.alldocument.R.string.sys_share_title)));
    }
            ...
            switch (actionID) {
                ...
                case EventConstant.SYS_HELP_ID: //show help net
                    Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(getResources()
                            .getString(com.example.alldocument.R.string.sys_url_wxiwei)));
                    startActivity(intent);
                    break;
...
//                		control.getSysKit().getCalloutManager().setDrawingMode(MainConstant.DRAWMODE_CALLOUTDRAW);
    ...
    public void openFileFinish() {
        ...
        ViewGroup header_layout = (ViewGroup) LayoutInflater.from(this).inflate(R.layout.layout_header, null);
        appFrame.addView(header_layout);

        AppCompatTextView top_lable = header_layout.findViewById(R.id.top_lable);
        AppCompatImageView img_back = header_layout.findViewById(R.id.img_back);

        top_lable.setText(getIntent().getStringExtra(MainConstant.INTENT_FILED_FILE_NAME));
        ...
        gapView.setBackgroundColor(getResources().getColor(R.color.color_gray_E6E6E6));
...
//            control.se
    ...
    private void initFloatButton() {
        ...
        BitmapFactory.decodeResource(getResources(), com.example.alldocument.R.drawable.file_slideshow_left, opts);

        //load page up button
        Resources res = getResources();
        pageUp = new AImageButton(this, control, res.getString(com.example.alldocument.R.string.pg_slideshow_pageup), -1,
                -1, EventConstant.APP_PAGE_UP_ID);
        pageUp.setNormalBgResID(com.example.alldocument.R.drawable.file_slideshow_left);
        pageUp.setPushBgResID(com.example.alldocument.R.drawable.file_slideshow_left_push);
        pageUp.setLayoutParams(new LayoutParams(opts.outWidth, opts.outHeight));

        //load page down button
        pageDown = new AImageButton(this, control, res.getString(com.example.alldocument.R.string.pg_slideshow_pagedown),
                -1, -1, EventConstant.APP_PAGE_DOWN_ID);
        pageDown.setNormalBgResID(com.example.alldocument.R.drawable.file_slideshow_right);
        pageDown.setPushBgResID(com.example.alldocument.R.drawable.file_slideshow_right_push);
        pageDown.setLayoutParams(new LayoutParams(opts.outWidth, opts.outHeight));

        BitmapFactory.decodeResource(getResources(), com.example.alldocument.R.drawable.file_slideshow_pen_normal, opts);
        // load pen button
        penButton = new AImageCheckButton(this, control,
                res.getString(com.example.alldocument.R.string.app_toolsbar_pen_check), res.getString(com.example.alldocument.R.string.app_toolsbar_pen),
                com.example.alldocument.R.drawable.file_slideshow_pen_check, com.example.alldocument.R.drawable.file_slideshow_pen_normal,
                com.example.alldocument.R.drawable.file_slideshow_pen_normal, EventConstant.APP_PEN_ID);
        penButton.setNormalBgResID(com.example.alldocument.R.drawable.file_slideshow_pen_normal);
        penButton.setPushBgResID(com.example.alldocument.R.drawable.file_slideshow_pen_push);
        penButton.setLayoutParams(new LayoutParams(opts.outWidth, opts.outHeight));

        // load eraser button
        eraserButton = new AImageCheckButton(this, control,
                res.getString(com.example.alldocument.R.string.app_toolsbar_eraser_check), res.getString(com.example.alldocument.R.string.app_toolsbar_eraser),
                com.example.alldocument.R.drawable.file_slideshow_eraser_check, com.example.alldocument.R.drawable.file_slideshow_eraser_normal,
                com.example.alldocument.R.drawable.file_slideshow_eraser_normal, EventConstant.APP_ERASER_ID);
        eraserButton.setNormalBgResID(com.example.alldocument.R.drawable.file_slideshow_eraser_normal);
        eraserButton.setPushBgResID(com.example.alldocument.R.drawable.file_slideshow_eraser_push);
        eraserButton.setLayoutParams(new LayoutParams(opts.outWidth, opts.outHeight));

        // load settings button
        settingsButton = new AImageButton(this, control, res.getString(com.example.alldocument.R.string.app_toolsbar_color),
                -1, -1, EventConstant.APP_COLOR_ID);
        settingsButton.setNormalBgResID(com.example.alldocument.R.drawable.file_slideshow_settings_normal);
        settingsButton.setPushBgResID(com.example.alldocument.R.drawable.file_slideshow_settings_push);
    ...
    public Object getViewBackground() {
        return getResources().getColor(R.color.color_gray_E6E6E6);
    }
    ...
    public void addFragment(Fragment fragment, int frameId, String tag) {
    ...
    public void replaceFragment(Fragment fragment, int frameId) {
        getSupportFragmentManager().beginTransaction().replace(frameId, fragment).commit();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                mIntent.putExtra(PhotoEditorActivity.SELECT_IMAGE, resultUri.toString());
