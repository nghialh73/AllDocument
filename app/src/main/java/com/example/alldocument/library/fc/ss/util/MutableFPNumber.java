...
final class MutableFPNumber {
	...
	public com.example.alldocument.library.fc.ss.util.ExpandedDouble createExpandedDouble() {
		return new com.example.alldocument.library.fc.ss.util.ExpandedDouble(_significand, _binaryExponent);
	}
}
