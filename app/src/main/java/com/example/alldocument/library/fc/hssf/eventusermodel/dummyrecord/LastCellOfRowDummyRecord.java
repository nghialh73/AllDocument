...
package com.example.alldocument.library.fc.hssf.eventusermodel.dummyrecord;


import com.example.alldocument.library.fc.hssf.eventusermodel.dummyrecord.DummyRecordBase;

/**
 * A dummy record to indicate that we've now had the last
 *  cell record for this row.
 */
public final class LastCellOfRowDummyRecord extends com.example.alldocument.library.fc.hssf.eventusermodel.dummyrecord.DummyRecordBase {
	private int row;
