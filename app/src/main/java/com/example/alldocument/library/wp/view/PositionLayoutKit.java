...
public class PositionLayoutKit 
{
	 ...
	 public static PositionLayoutKit instance()
	 {
	    ...
	    public void processShapePosition(com.example.alldocument.library.wp.view.LeafView leafView, WPAutoShape wpShape, PageAttr pageAttr)
	    {
	    ...
	    private void processHorizontalPosition(com.example.alldocument.library.wp.view.LeafView leafView, WPAutoShape wpShape, PageAttr pageAttr)
	    {
	    	...
	    	if(posType == WPAutoShape.POSITIONTYPE_RELATIVE)
	    	{
	            ...
	            else if(horRelative == WPAutoShape.RELATIVE_OUTER)
	            {
		    		...
		    		{
		        		com.example.alldocument.library.wp.view.PageView pageView = (com.example.alldocument.library.wp.view.PageView)leafView.getParentView().getParentView().getParentView();
	    ...
	    private void processHorizontalPosition_Absolute(com.example.alldocument.library.wp.view.LeafView leafView, WPAutoShape wpShape, PageAttr pageAttr)
	    {
	    ...
	    private void processHorizontalPosition_Left(com.example.alldocument.library.wp.view.LeafView leafView, WPAutoShape wpShape, PageAttr pageAttr)
	    {
	    	Rectangle r = wpShape.getBounds();
	    ...
	    private void processHorizontalPosition_Center(com.example.alldocument.library.wp.view.LeafView leafView, WPAutoShape wpShape, PageAttr pageAttr)
	    {
	    	Rectangle r = wpShape.getBounds();
	    ...
	    private void processHorizontalPosition_Right(com.example.alldocument.library.wp.view.LeafView leafView, WPAutoShape wpShape, PageAttr pageAttr)
	    {
	    	Rectangle r = wpShape.getBounds();    	
	    	byte horRelative = wpShape.getHorizontalRelativeTo();
	    	if(horRelative == WPAutoShape.RELATIVE_PAGE 
	    ...
	    private void processHorizontalPosition_Inside(com.example.alldocument.library.wp.view.LeafView leafView, WPAutoShape wpShape, PageAttr pageAttr)
	    {
	    	if(leafView.getParentView() != null 
        			&& leafView.getParentView().getParentView() != null
        			&& leafView.getParentView().getParentView().getParentView() != null)
	    ...
	    private void processHorizontalPosition_Outside(com.example.alldocument.library.wp.view.LeafView leafView, WPAutoShape wpShape, PageAttr pageAttr)
	    {
	    	if(leafView.getParentView() != null 
        			&& leafView.getParentView().getParentView() != null
        			&& leafView.getParentView().getParentView().getParentView() != null)
	    ...
	    private void processVerticalPosition(com.example.alldocument.library.wp.view.LeafView leafView, WPAutoShape wpShape, PageAttr pageAttr)
	    {
	    ...
	    private void processVerticalPosition_Absolute(com.example.alldocument.library.wp.view.LeafView leafView, WPAutoShape wpShape, PageAttr pageAttr)
	    {
	    	Rectangle r = wpShape.getBounds();
	    	...
	    	{
	    		if(leafView.getParentView() != null 
	    				&& leafView.getParentView().getParentView() instanceof com.example.alldocument.library.wp.view.ParagraphView)
	    		{
	    			com.example.alldocument.library.wp.view.ParagraphView paraView = (com.example.alldocument.library.wp.view.ParagraphView)leafView.getParentView().getParentView();
	    ...
	    private void processVerticalPosition_Top(com.example.alldocument.library.wp.view.LeafView leafView, WPAutoShape wpShape, PageAttr pageAttr)
	    {
	    	Rectangle r = wpShape.getBounds();
	    	byte verRelativeTo = wpShape.getVerticalRelativeTo();
	    ...
	    private void processVerticalPosition_Center(com.example.alldocument.library.wp.view.LeafView leafView, WPAutoShape wpShape, PageAttr pageAttr)
	    {
	    	Rectangle r = wpShape.getBounds();
	    	byte verRelativeTo = wpShape.getVerticalRelativeTo();
	    ...
	    private void processVerticalPosition_Bottom(com.example.alldocument.library.wp.view.LeafView leafView, WPAutoShape wpShape, PageAttr pageAttr)
	    {
	    	Rectangle r = wpShape.getBounds();
	    	byte verRelativeTo = wpShape.getVerticalRelativeTo();
	    ...
	    private void processVerticalPosition_Inside(com.example.alldocument.library.wp.view.LeafView leafView, WPAutoShape wpShape, PageAttr pageAttr)
	    {
	    	Rectangle r = wpShape.getBounds();
	    	byte verRelativeTo = wpShape.getVerticalRelativeTo();
	    	if(leafView.getParentView() != null 
	    ...
	    private void processVerticalPosition_Outside(LeafView leafView, WPAutoShape wpShape, PageAttr pageAttr)
	    {
	    	...
	    	if(leafView.getParentView() != null 
	    			...
	    			&& leafView.getParentView().getParentView().getParentView() != null)
			{
	    		com.example.alldocument.library.wp.view.PageView pageView = (PageView)leafView.getParentView().getParentView().getParentView();
	    		if(pageView.getPageNumber() % 2 == 1)
	    		{
	    			//Odd page
	    			if(verRelativeTo == WPAutoShape.RELATIVE_PAGE)
	    		...
	    		else
	    		{
	    			...
	    			else if(verRelativeTo == WPAutoShape.RELATIVE_MARGIN)
	    			{
	    				leafView.setY(pageAttr.topMargin);
	    	    			...
	    	    			|| verRelativeTo == WPAutoShape.RELATIVE_LINE)
	    			{
	    				com.example.alldocument.library.wp.view.ParagraphView paraView = (ParagraphView)leafView.getParentView().getParentView();
	    				leafView.setY(paraView.getY());
	    			}
	    			else if(verRelativeTo == WPAutoShape.RELATIVE_TOP)
	    			{
