...
package com.example.alldocument.library.fc.fs.storage;
...
import com.example.alldocument.library.fc.fs.storage.IntList;
...
public final class BlockAllocationTableReader
{
     ...
     */
    private final com.example.alldocument.library.fc.fs.storage.IntList _entries;
    ...
    public BlockAllocationTableReader(BlockSize bigBlockSize, int block_count,
        int[] block_array, int xbat_count, int xbat_index, com.example.alldocument.library.fc.fs.storage.BlockList raw_block_list)
        throws IOException
    {
        this.bigBlockSize = bigBlockSize;
        _entries = new com.example.alldocument.library.fc.fs.storage.IntList();
        int limit = Math.min(block_count, block_array.length);
        int block_index;

        // This will hold all of the BAT blocks in order
        com.example.alldocument.library.fc.fs.storage.RawDataBlock blocks[] = new com.example.alldocument.library.fc.fs.storage.RawDataBlock[block_count];
        ...
        for (block_index = 0; block_index < limit; block_index++)
        {
            ...
            blocks[block_index] = (com.example.alldocument.library.fc.fs.storage.RawDataBlock)raw_block_list.remove(nextOffset);
        }
        ...
        if (block_index < block_count)
        {
            ...
            for (int j = 0; j < xbat_count; j++)
            {
                ...
                {
                    blocks[block_index++] = (com.example.alldocument.library.fc.fs.storage.RawDataBlock)raw_block_list.remove(com.example.alldocument.library.fc.fs.storage.LittleEndian.getInt(data, offset));
                    offset += com.example.alldocument.library.fc.fs.storage.LittleEndian.INT_SIZE;
                }
                chain_index = com.example.alldocument.library.fc.fs.storage.LittleEndian.getInt(data, chain_index_offset);
     ...
     */
    public BlockAllocationTableReader(BlockSize bigBlockSize, com.example.alldocument.library.fc.fs.storage.RawDataBlock[] blocks,
        com.example.alldocument.library.fc.fs.storage.BlockList raw_block_list) throws IOException
    {
        this.bigBlockSize = bigBlockSize;
     ...
     */
    public com.example.alldocument.library.fc.fs.storage.RawDataBlock[] fetchBlocks(int startBlock, int headerPropertiesStartBlock,
                                                                      com.example.alldocument.library.fc.fs.storage.BlockList blockList) throws IOException
    {
        List<com.example.alldocument.library.fc.fs.storage.RawDataBlock> blocks = new ArrayList<com.example.alldocument.library.fc.fs.storage.RawDataBlock>();
        int currentBlock = startBlock;
        boolean firstPass = true;
        com.example.alldocument.library.fc.fs.storage.RawDataBlock dataBlock = null;
        ...
        return blocks.toArray(new com.example.alldocument.library.fc.fs.storage.RawDataBlock[blocks.size()]);
    }
    ...
    private void setEntries(RawDataBlock[] blocks, BlockList raw_blocks) throws IOException
    {
        ...
        for (int block_index = 0; block_index < blocks.length; block_index++)
        {
            ...
            for (int k = 0; k < limit; k++)
            {
                int entry = com.example.alldocument.library.fc.fs.storage.LittleEndian.getInt(data, offset);
