...
import com.example.alldocument.library.fc.hwpf.model.FieldDescriptor;
import com.example.alldocument.library.fc.hwpf.model.FieldsDocumentPart;
import com.example.alldocument.library.fc.hwpf.model.FieldsTables;
...
import com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl;
import com.example.alldocument.library.fc.hwpf.usermodel.Fields;


/**
 * Default implementation of {@link com.example.alldocument.library.fc.hwpf.usermodel.Field}
 * 
...
public class FieldsImpl implements Fields
{
    ...
    private Map<FieldsDocumentPart, Map<Integer, com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl>> _fieldsByOffset;

    private PlexOfFieldComparator comparator = new PlexOfFieldComparator();

    public FieldsImpl( FieldsTables fieldsTables )
    {
        _fieldsByOffset = new HashMap<FieldsDocumentPart, Map<Integer, com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl>>(
    ...
    public Collection<com.example.alldocument.library.fc.hwpf.usermodel.Field> getFields(FieldsDocumentPart part )
    {
        Map<Integer, com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl> map = _fieldsByOffset.get( part );
    ...
    public com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl getFieldByStartOffset(FieldsDocumentPart documentPart,
                                                                               int offset )
    {
        Map<Integer, com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl> map = _fieldsByOffset.get( documentPart );
        if ( map == null || map.isEmpty() )
            return null;
    ...
    private Map<Integer, com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl> parseFieldStructure(
            List<PlexOfField> plexOfFields )
    {
        if ( plexOfFields == null || plexOfFields.isEmpty() )
            return new HashMap<Integer, com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl>();

        Collections.sort( plexOfFields, comparator );
        List<com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl> fields = new ArrayList<com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl>(
                plexOfFields.size() / 3 + 1 );
        parseFieldStructureImpl( plexOfFields, 0, plexOfFields.size(), fields );

        HashMap<Integer, com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl> result = new HashMap<Integer, com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl>(
                fields.size() );
        for ( com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl field : fields )
        {
    ...
    private void parseFieldStructureImpl( List<PlexOfField> plexOfFields,
            ...
            List<com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl> result )
    {
        ...
        while ( next < endOffsetExclusive )
        {
            ...
            case FieldDescriptor.FIELD_SEPARATOR_MARK:
            {
                ...
                com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl field = new com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl( startPlexOfField,
            ...
            case FieldDescriptor.FIELD_END_MARK:
            {
                ...
                com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl field = new com.example.alldocument.library.fc.hwpf.usermodel.FieldImpl( startPlexOfField, null,
                        nextPlexOfField );
                result.add( field );
