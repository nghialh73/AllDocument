...
import com.example.alldocument.library.simpletext.control.IWord;
 ...
 * <p>
 */
public abstract class AbstractView implements com.example.alldocument.library.simpletext.view.IView
{
    /**
     * 
     */
     ...
     */
    public com.example.alldocument.library.simpletext.view.IView getParentView()
    {
        return parent;
    }
     ...
     */
    public void setParentView(com.example.alldocument.library.simpletext.view.IView parent)
    {
        this.parent = parent;
    }
     ...
     */
    public com.example.alldocument.library.simpletext.view.IView getChildView()
    {
        return child;
    }
     ...
     */
    public void setChildView(com.example.alldocument.library.simpletext.view.IView child)
    {
        this.child = child;
    }
     ...
     */
    public com.example.alldocument.library.simpletext.view.IView getPreView()
    {
        return preView;
    }
     ...
     */
    public void setPreView(com.example.alldocument.library.simpletext.view.IView preView)
    {
     ...
     */
    public com.example.alldocument.library.simpletext.view.IView getNextView()
    {
        return nextView;
    }
     ...
     */
    public void setNextView(com.example.alldocument.library.simpletext.view.IView nextView)
    {
    ...
    {
        com.example.alldocument.library.simpletext.view.IView parent = getParentView();
        if (parent != null)
        {
     ...
     */
    public com.example.alldocument.library.simpletext.view.IView getLastView()
    {
        com.example.alldocument.library.simpletext.view.IView temp = getChildView();
        if (temp == null)
        {
            return null;
        }
     ...
     * 追加一个子视图
     */
    public void appendChlidView(com.example.alldocument.library.simpletext.view.IView view)
    {
        ...
        com.example.alldocument.library.simpletext.view.IView lastView = getLastView();
     ...
     */
    public void insertView(com.example.alldocument.library.simpletext.view.IView view, com.example.alldocument.library.simpletext.view.IView newView)
    {
     ...
     */
    public void deleteView(com.example.alldocument.library.simpletext.view.IView view, boolean isDeleteChild)
    {
        ...
        {
            com.example.alldocument.library.simpletext.view.IView pre = view.getPreView();
            com.example.alldocument.library.simpletext.view.IView next = view.getNextView();
    ...
    public void draw(Canvas canvas, int originX, int originY, float zoom)
    {
        ...
        com.example.alldocument.library.simpletext.view.IView view = getChildView();
     ...
     * @return
     */
    public com.example.alldocument.library.simpletext.view.IView getView(long offset, int type, boolean isBack)
    {
        com.example.alldocument.library.simpletext.view.IView view = child;
     ...
     * 得到包括x, y值的指定视图
     */
    public com.example.alldocument.library.simpletext.view.IView getView(int x, int y, int type, boolean isBack)
    {
        com.example.alldocument.library.simpletext.view.IView view = child;
    ...
    public void dispose()
    {
        this.parent = null;
        elem = null;
        com.example.alldocument.library.simpletext.view.IView temp = child;
        com.example.alldocument.library.simpletext.view.IView next;
        while (temp != null)
        {
    ...
    protected long end;
    // 父视图
    protected com.example.alldocument.library.simpletext.view.IView parent;
    // 子视图
    protected com.example.alldocument.library.simpletext.view.IView child;
    // 前一个视图
    protected com.example.alldocument.library.simpletext.view.IView preView;
    // 后一个视图
