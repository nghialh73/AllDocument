...
{
    public  VectorgraphConverterThread(com.example.alldocument.library.common.picture.PictureConverterMgr converterMgr, byte type , String srcPath, String dstPath, int width, int height)
    {
