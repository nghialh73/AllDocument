...
/**
 * <p>A property in a {@link com.example.alldocument.library.fc.hpsf.Section} of a {@link PropertySet}.</p>
 *
 * <p>The property's <strong>ID</strong> gives the property a meaning
 * in the context of its {@link com.example.alldocument.library.fc.hpsf.Section}. Each {@link com.example.alldocument.library.fc.hpsf.Section} spans
 ...
 * {@link com.example.alldocument.library.fc.hpsf.Variant#VT_LPSTR} (byte string), the value consists of a
 * DWord telling how many bytes the string contains. The bytes follow
 * immediately, including any null bytes that terminate the
 * string. The type {@link com.example.alldocument.library.fc.hpsf.Variant#VT_I4} denotes a four-byte integer
 * value, {@link com.example.alldocument.library.fc.hpsf.Variant#VT_FILETIME} some date and time (of a
 * file).</p>
 *
 * <p>Please note that not all {@link com.example.alldocument.library.fc.hpsf.Variant} types yet. This might change
...
public class Property
{
     ...
     * @param type the property's type, see {@link com.example.alldocument.library.fc.hpsf.Variant}.
     * @param value the property's value. Only certain types are allowed, see
     *        {@link com.example.alldocument.library.fc.hpsf.Variant}.
     */
    ...
    {
        if (t1 == t2 ||
            (t1 == com.example.alldocument.library.fc.hpsf.Variant.VT_LPSTR && t2 == com.example.alldocument.library.fc.hpsf.Variant.VT_LPWSTR) ||
            (t2 == com.example.alldocument.library.fc.hpsf.Variant.VT_LPSTR && t1 == Variant.VT_LPWSTR)) {
            return true;
        }
        return false;
    }
