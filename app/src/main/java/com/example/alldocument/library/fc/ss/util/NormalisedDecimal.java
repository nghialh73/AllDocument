...
import com.example.alldocument.library.fc.ss.util.ExpandedDouble;
import com.example.alldocument.library.fc.ss.util.MutableFPNumber;
...
final class NormalisedDecimal {
	...
	public static NormalisedDecimal create(BigInteger frac, int binaryExponent) {
		...
		com.example.alldocument.library.fc.ss.util.MutableFPNumber cc = new com.example.alldocument.library.fc.ss.util.MutableFPNumber(frac, binaryExponent);
		if (pow10 != 0) {
	...
	/**
	 * Convert to an equivalent {@link com.example.alldocument.library.fc.ss.util.ExpandedDouble} representation (binary frac and exponent).
	 ...
	 */
	public com.example.alldocument.library.fc.ss.util.ExpandedDouble normaliseBaseTwo() {
		com.example.alldocument.library.fc.ss.util.MutableFPNumber cc = new com.example.alldocument.library.fc.ss.util.MutableFPNumber(composeFrac(), 39);
