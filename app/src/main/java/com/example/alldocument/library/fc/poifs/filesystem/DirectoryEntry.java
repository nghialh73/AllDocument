...
public interface DirectoryEntry
    extends com.example.alldocument.library.fc.poifs.filesystem.Entry, Iterable<com.example.alldocument.library.fc.poifs.filesystem.Entry>
{
    ...
    public com.example.alldocument.library.fc.poifs.filesystem.DocumentEntry createDocument(final String name,
