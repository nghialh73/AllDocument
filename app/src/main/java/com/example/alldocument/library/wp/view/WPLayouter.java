...
import com.example.alldocument.library.constant.wp.AttrIDConstant;
...
import com.example.alldocument.library.wp.view.LeafView;
import com.example.alldocument.library.wp.view.ObjView;
...
import com.example.alldocument.library.wp.view.ShapeView;
import com.example.alldocument.library.wp.view.TableLayoutKit;
import com.example.alldocument.library.wp.view.TableView;
import com.example.alldocument.library.wp.view.TitleView;
import com.example.alldocument.library.wp.view.ViewFactory;
import com.example.alldocument.library.wp.view.WPViewKit;
...
public class WPLayouter
{
     ...
     * @param root
     */
    public WPLayouter(com.example.alldocument.library.wp.view.PageRoot root)
    {
        this.root = root;
        docAttr = new DocAttr();
    ...
    public void doLayout()
    {
        ...
        //
        com.example.alldocument.library.wp.view.PageView pv = (com.example.alldocument.library.wp.view.PageView) ViewFactory.createView(root.getControl(), section, null, WPViewConstant.PAGE_VIEW);
        root.appendChlidView(pv);
        layoutPage(pv);
        com.example.alldocument.library.wp.view.LayoutKit.instance().layoutAllPage(root, 1.0f);
    }
    
    /**
     * 
     */
    public int layoutPage(com.example.alldocument.library.wp.view.PageView pageView)
    {
        ...
        if (breakPara != null)
        {
            ...
            if (breakPara.getType() == WPViewConstant.TABLE_VIEW)
            {
                ...
                ((com.example.alldocument.library.wp.view.TableView)breakPara).setBreakPages(true);
            }
        }
            ...
            && breakType != WPViewConstant.BREAK_PAGE)
        {
            ...
            {             
                ...
                breakType = tableLayout.layoutTable(root.getControl(), doc, root, docAttr, pageAttr, paraAttr, 
                    (com.example.alldocument.library.wp.view.TableView)para, currentLayoutOffset, dx, dy, spanW, spanH, flag, breakPara != null);
            }
            else
            {
                tableLayout.clearBreakPages();
                AttrManage.instance().fillParaAttr(root.getControl(), paraAttr, elem.getAttribute());
                breakType = com.example.alldocument.library.wp.view.LayoutKit.instance().layoutPara(root.getControl(), doc, docAttr, pageAttr, paraAttr,
        ...
        if (para.getType() == WPViewConstant.TABLE_VIEW && tableLayout.isTableBreakPages())
        {
            ...
            pageView.setHasBreakTable(true);
            ((com.example.alldocument.library.wp.view.TableView)para).setBreakPages(true);
        }
        // 
     ...
     * 
     */
    private void layoutHeaderAndFooter(com.example.alldocument.library.wp.view.PageView pageView)
    {
        if (header == null)
        {
        ...
        {
            for (com.example.alldocument.library.wp.view.LeafView sv :shapeViews)
            {                
                if (com.example.alldocument.library.wp.view.WPViewKit.instance().getArea(sv.getStartOffset(null)) == WPModelConstant.HEADER)
                {
     ...
     * 
     */
    private com.example.alldocument.library.wp.view.TitleView layoutHFParagraph(com.example.alldocument.library.wp.view.PageView pageView, boolean isHeader)
    {
        ...
        com.example.alldocument.library.wp.view.TitleView titleView = (com.example.alldocument.library.wp.view.TitleView)ViewFactory.createView(root.getControl(), hfElem, null, WPViewConstant.TITLE_VIEW);
     ...
     * 
     */
    private void collectShapeView(com.example.alldocument.library.wp.view.PageView page, ParagraphView para, boolean isHF)
    {
    ...
    private void collectShapeViewForPara(PageView page, ParagraphView para, boolean isHF)
    {
        ...
        while (line != null)
        {
            ...
            {                    
                ...
                {
                    com.example.alldocument.library.wp.view.ShapeView shapeView = ((ShapeView)leaf);
                ...
                {
                    com.example.alldocument.library.wp.view.ObjView objView = ((ObjView)leaf);
                    if (!objView.isInline())
                    {
    ...
    // header
    private com.example.alldocument.library.wp.view.TitleView header;
    // footer
    ...
    //
    private List<com.example.alldocument.library.wp.view.LeafView> shapeViews = new ArrayList<LeafView>();
