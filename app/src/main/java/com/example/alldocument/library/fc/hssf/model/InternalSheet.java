...
import com.example.alldocument.library.fc.hssf.model.RecordOrderer;
import com.example.alldocument.library.fc.hssf.model.RecordStream;
import com.example.alldocument.library.fc.hssf.model.RowBlocksReader;
...
import com.example.alldocument.library.fc.hssf.record.CalcCountRecord;
import com.example.alldocument.library.fc.hssf.record.CalcModeRecord;
import com.example.alldocument.library.fc.hssf.record.CellValueRecordInterface;
import com.example.alldocument.library.fc.hssf.record.ColumnInfoRecord;
...
import com.example.alldocument.library.fc.hssf.record.DefaultColWidthRecord;
...
import com.example.alldocument.library.fc.hssf.record.IterationRecord;
import com.example.alldocument.library.fc.hssf.record.MergeCellsRecord;
...
import com.example.alldocument.library.fc.hssf.record.PrintGridlinesRecord;
import com.example.alldocument.library.fc.hssf.record.PrintHeadersRecord;
...
import com.example.alldocument.library.fc.hssf.record.RefModeRecord;
...
import com.example.alldocument.library.fc.hssf.record.SaveRecalcRecord;
import com.example.alldocument.library.fc.hssf.record.SelectionRecord;
import com.example.alldocument.library.fc.hssf.record.TextObjectRecord;
import com.example.alldocument.library.fc.hssf.record.UncalcedRecord;
...
import com.example.alldocument.library.fc.hssf.record.aggregates.ChartSubstreamRecordAggregate;
import com.example.alldocument.library.fc.hssf.record.aggregates.ColumnInfoRecordsAggregate;
import com.example.alldocument.library.fc.hssf.record.aggregates.ConditionalFormattingTable;
import com.example.alldocument.library.fc.hssf.record.aggregates.CustomViewSettingsRecordAggregate;
import com.example.alldocument.library.fc.hssf.record.aggregates.DataValidityTable;
import com.example.alldocument.library.fc.hssf.record.aggregates.MergedCellsTable;
...
import com.example.alldocument.library.fc.hssf.record.aggregates.RowRecordsAggregate;
import com.example.alldocument.library.fc.hssf.record.aggregates.WorksheetProtectionBlock;
import com.example.alldocument.library.fc.hssf.record.aggregates.RecordAggregate.PositionTrackingVisitor;
 ...
 *
 * @see com.example.alldocument.library.fc.hssf.model.InternalWorkbook
...
public final class InternalSheet
{
     ...
     * @see Record
     */
    public static InternalSheet createSheet(com.example.alldocument.library.fc.hssf.model.RecordStream rs)
    {
        return new InternalSheet(rs, null);
    }

    public static InternalSheet createSheet(com.example.alldocument.library.fc.hssf.model.RecordStream rs, AbstractReader iAbortListener)
    {
        return new InternalSheet(rs, iAbortListener);
    }
    
    private InternalSheet(com.example.alldocument.library.fc.hssf.model.RecordStream rs, AbstractReader iAbortListener)
    {
