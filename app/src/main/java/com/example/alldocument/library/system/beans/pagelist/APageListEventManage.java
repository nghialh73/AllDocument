    ...
    OnTouchListener, OnDoubleTapListener, OnClickListener
{
     ...
     * @param pdfListView
     */
    public APageListEventManage(com.example.alldocument.library.system.beans.pagelist.APageListView listView)
    {
    ...
    /**
     * 
     * @see com.example.alldocument.library.system.beans.AEventManage#zoom(MotionEvent)
     *
     */
    ...
    protected boolean processOnTouch(MotionEvent event)
    {
        ...
        if (event.getActionMasked() == MotionEvent.ACTION_UP)
        {
            ...
            com.example.alldocument.library.system.beans.pagelist.APageListItem pageView = listView.getCurrentPageView();
            if (pageView != null)
            {
    ...
    /**
     * 
     * @see com.example.alldocument.library.system.beans.AEventManage#onFling(MotionEvent, MotionEvent, float, float)
     *
     */
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY)
    {
        ...
        if (isProcessOnScroll && !isDoubleTap)
        {
            ...
            {
                com.example.alldocument.library.system.beans.pagelist.APageListItem item = listView.getCurrentPageView();
    ...
    public boolean onScale(ScaleGestureDetector detector)
    {
        ...
        if ((int)(zoom * MainConstant.ZOOM_ROUND) != (int)(previousScale * MainConstant.ZOOM_ROUND))
        {
            ...
            com.example.alldocument.library.system.beans.pagelist.APageListItem v = listView.getCurrentPageView();
            if (v != null)
            {
