...
public enum SubdocumentType {
    MAIN( com.example.alldocument.library.fc.hwpf.model.FIBLongHandler.CCPTEXT ),

    FOOTNOTE( com.example.alldocument.library.fc.hwpf.model.FIBLongHandler.CCPFTN ),

    HEADER( com.example.alldocument.library.fc.hwpf.model.FIBLongHandler.CCPHDD ),

    MACRO( com.example.alldocument.library.fc.hwpf.model.FIBLongHandler.CCPMCR ),

    ANNOTATION( com.example.alldocument.library.fc.hwpf.model.FIBLongHandler.CCPATN ),

    ENDNOTE( com.example.alldocument.library.fc.hwpf.model.FIBLongHandler.CCPEDN ),

    TEXTBOX( com.example.alldocument.library.fc.hwpf.model.FIBLongHandler.CCPTXBX ),
