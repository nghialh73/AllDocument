...
import com.example.alldocument.library.fc.hpsf.NoFormatIDException;
...
/**
 * <p>Adds writing support to the {@link com.example.alldocument.library.fc.hpsf.PropertySet} class.</p>
 *
 * <p>Please be aware that this class' functionality will be merged into the
 * {@link com.example.alldocument.library.fc.hpsf.PropertySet} class at a later time, so the API will change.</p>
 *
 * @author Rainer Klute <a
 * href="mailto:klute@rainer-klute.de">&lt;klute@rainer-klute.de&gt;</a>
 */
public class MutablePropertySet extends com.example.alldocument.library.fc.hpsf.PropertySet
{
    ...
    public MutablePropertySet()
    {
        ...
        classID = new com.example.alldocument.library.fc.hpsf.ClassID();

        /* Initialize the sections. Since property set must have at least
         * one section it is added right here. */
        sections = new LinkedList();
        sections.add(new com.example.alldocument.library.fc.hpsf.MutableSection());
    }
     ...
     */
    public MutablePropertySet(final com.example.alldocument.library.fc.hpsf.PropertySet ps)
    {
        ...
        {
            final com.example.alldocument.library.fc.hpsf.MutableSection s = new com.example.alldocument.library.fc.hpsf.MutableSection((com.example.alldocument.library.fc.hpsf.Section) (i.next()));
            addSection(s);
        }
    }
    ...
    private final int OFFSET_HEADER =
        ...
        com.example.alldocument.library.fc.hpsf.ClassID.LENGTH +              /* Class ID      */
     ...
     */
    public void setClassID(final com.example.alldocument.library.fc.hpsf.ClassID classID)
    {
     ...
     *
     * @param section The {@link com.example.alldocument.library.fc.hpsf.Section} to add. It will be appended
        ...
        throws WritingNotSupportedException, IOException
    {
        ...
        length += com.example.alldocument.library.fc.hpsf.TypeWriter.writeToStream(out, (short) getByteOrder());
        length += com.example.alldocument.library.fc.hpsf.TypeWriter.writeToStream(out, (short) getFormat());
        length += com.example.alldocument.library.fc.hpsf.TypeWriter.writeToStream(out, getOSVersion());
        length += com.example.alldocument.library.fc.hpsf.TypeWriter.writeToStream(out, getClassID());
        length += com.example.alldocument.library.fc.hpsf.TypeWriter.writeToStream(out, nrSections);
        ...
        offset += nrSections * (com.example.alldocument.library.fc.hpsf.ClassID.LENGTH + LittleEndian.INT_SIZE);
        final int sectionsBegin = offset;
        for (final ListIterator i = sections.listIterator(); i.hasNext();)
        {
            final com.example.alldocument.library.fc.hpsf.MutableSection s = (com.example.alldocument.library.fc.hpsf.MutableSection) i.next();
            final ClassID formatID = s.getFormatID();
            if (formatID == null)
                throw new NoFormatIDException();
            length += com.example.alldocument.library.fc.hpsf.TypeWriter.writeToStream(out, s.getFormatID());
        ...
        for (final ListIterator i = sections.listIterator(); i.hasNext();)
        {
            final com.example.alldocument.library.fc.hpsf.MutableSection s = (MutableSection) i.next();
            offset += s.write(out);
        }
    }
