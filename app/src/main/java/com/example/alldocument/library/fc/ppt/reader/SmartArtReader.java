 ...
 * 时间:              下午1:47:12
 */
package com.example.alldocument.library.fc.ppt.reader;
...
public class SmartArtReader
{
    ...
    {
        com.example.alldocument.library.fc.ppt.reader.ReaderKit.instance().processRotation(spPr, shape);
    }
        ...
        PGLayout pgLayout, PGSlide pgSlide, Element sp) throws Exception
    {
        ...
        rect = com.example.alldocument.library.fc.ppt.reader.ReaderKit.instance().getShapeAnchor(spPr.element("xfrm"), 1.f, 1.f);
...
//        if (spPr != null)
        {
            ...
            Float[] values = null;
            boolean border = true;
            String name = com.example.alldocument.library.fc.ppt.reader.ReaderKit.instance().getPlaceholderName(sp);
            String spName = sp.getName();
    ...
    private IShape getTextBoxData(IControl control, PGMaster pgMaster, PGLayout pgLayout,Element sp)
    {
        ...
        if (temp != null)
        {
            rect = com.example.alldocument.library.fc.ppt.reader.ReaderKit.instance().getShapeAnchor(temp, 1.f, 1.f);
        }        
