...
import com.example.alldocument.library.fc.hwpf.model.FormattedDiskPage;
import com.example.alldocument.library.fc.hwpf.model.PAPX;
import com.example.alldocument.library.fc.hwpf.model.ParagraphHeight;
...
public final class PAPFormattedDiskPage extends FormattedDiskPage {
    ...
    private ArrayList<com.example.alldocument.library.fc.hwpf.model.PAPX> _papxList = new ArrayList<com.example.alldocument.library.fc.hwpf.model.PAPX>();
    private ArrayList<com.example.alldocument.library.fc.hwpf.model.PAPX> _overFlow;
     ...
     * 
     * @deprecated Use
     *             {@link #PAPFormattedDiskPage(byte[],byte[],int,int, com.example.alldocument.library.fc.hwpf.model.TextPieceTable,boolean)}
     *             instead
     */
     ...
     */
    public PAPFormattedDiskPage( byte[] documentStream, byte[] dataStream,
            int offset, com.example.alldocument.library.fc.hwpf.model.CharIndexTranslator translator )
    {
        ...
        for ( int x = 0; x < _crun; x++ )
        {
            ...
            com.example.alldocument.library.fc.hwpf.model.PAPX papx = new com.example.alldocument.library.fc.hwpf.model.PAPX( charStartAt, charEndAt, getGrpprl( x ),
     ...
     */
    public void fill(List<com.example.alldocument.library.fc.hwpf.model.PAPX> filler)
    {
     ...
     */
    ArrayList<com.example.alldocument.library.fc.hwpf.model.PAPX> getOverflow()
    {
      return _overFlow;
    }
     ...
     */
    public com.example.alldocument.library.fc.hwpf.model.PAPX getPAPX(int index)
    {
      return _papxList.get(index);
    }

    public List<com.example.alldocument.library.fc.hwpf.model.PAPX> getPAPXs()
    {
            ...
            CharIndexTranslator translator ) throws IOException
    {
        ...
        if ( index != size )
        {
            _overFlow = new ArrayList<com.example.alldocument.library.fc.hwpf.model.PAPX>();
     ...
     */
    private com.example.alldocument.library.fc.hwpf.model.ParagraphHeight getParagraphHeight(int index)
    {
      int pheOffset = _offset + 1 + (((_crun + 1) * 4) + (index * 13));

      com.example.alldocument.library.fc.hwpf.model.ParagraphHeight phe = new ParagraphHeight(_fkp, pheOffset);
