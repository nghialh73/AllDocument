...
import com.example.alldocument.library.fc.poifs.property.PropertyFactory;
import com.example.alldocument.library.fc.poifs.property.PropertyTableBase;
...
public final class NPropertyTable extends PropertyTableBase {
     ...
     * @throws IOException
     */
    private static List<com.example.alldocument.library.fc.poifs.property.Property> buildProperties(final Iterator<ByteBuffer> dataSource,
                                                                                      final POIFSBigBlockSize bigBlockSize) throws IOException
    {
       List<com.example.alldocument.library.fc.poifs.property.Property> properties = new ArrayList<com.example.alldocument.library.fc.poifs.property.Property>();
