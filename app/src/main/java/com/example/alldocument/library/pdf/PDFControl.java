 ...
 * 时间:              下午5:45:18
 */
package com.example.alldocument.library.pdf;
...
import com.example.alldocument.library.pdf.PDFView;
...
public class PDFControl extends AbstractControl
{
    ...
    public PDFControl(IControl mainControl, PDFLib pdfLib, String filePath)
    {
        ...
        pdfView = new com.example.alldocument.library.pdf.PDFView(mainControl.getMainFrame().getActivity().getApplicationContext(), pdfLib, this);
    }
