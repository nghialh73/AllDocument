...
import com.example.alldocument.library.fc.hssf.formula.FormulaRenderingWorkbook;
...
import com.example.alldocument.library.fc.hssf.usermodel.HSSFEvaluationSheet;
...
public final class HSSFEvaluationWorkbook implements FormulaRenderingWorkbook, EvaluationWorkbook, FormulaParsingWorkbook {
	...
	public int getSheetIndex(EvaluationSheet evalSheet) {
		ASheet sheet = ((com.example.alldocument.library.fc.hssf.usermodel.HSSFEvaluationSheet)evalSheet).getASheet();
	...
	public EvaluationSheet getSheet(int sheetIndex) {
		return new com.example.alldocument.library.fc.hssf.usermodel.HSSFEvaluationSheet(_uBook.getSheetAt(sheetIndex));
	}
	...
	public Ptg[] getFormulaTokens(EvaluationCell evalCell) {
		ACell cell = ((com.example.alldocument.library.fc.hssf.usermodel.HSSFEvaluationCell)evalCell).getACell();
//		if (false) {
