 ...
 */
public class CellTextFormatter extends com.example.alldocument.library.fc.ss.format.CellFormatter {
    ...
    public CellTextFormatter(String format) {
        ...
        desc = CellFormatPart.parseFormat(format, com.example.alldocument.library.fc.ss.format.CellFormatType.TEXT,
                new PartHandler() {
