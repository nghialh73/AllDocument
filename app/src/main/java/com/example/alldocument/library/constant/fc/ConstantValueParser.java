...
package com.example.alldocument.library.constant.fc;
...
public final class ConstantValueParser {
	...
	private static Object readAConstantValue(LittleEndianInput in) {
		...
		switch(grbit) {
			...
			case TYPE_ERROR_CODE:
				...
				in.readUShort();
				in.readInt();
				return com.example.alldocument.library.constant.fc.ErrorConstant.valueOf(errCode);
		}
	...
	private static int getEncodedSize(Object object) {
		...
		if(cls == Boolean.class || cls == Double.class || cls == com.example.alldocument.library.constant.fc.ErrorConstant.class) {
			return 8;
		}
	...
	private static void encodeSingleValue(LittleEndianOutput out, Object value) {
		...
		if (value instanceof com.example.alldocument.library.constant.fc.ErrorConstant) {
			com.example.alldocument.library.constant.fc.ErrorConstant ecVal = (ErrorConstant) value;
