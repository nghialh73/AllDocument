...
import com.example.alldocument.library.java.awt.geom.QuadIterator;
...
public abstract class QuadCurve2D implements Shape, Cloneable {
	...
	/**
         ...
         * @since 1.2
	 */
	public com.example.alldocument.library.java.awt.geom.Point2D getCtrlPt() {
	    return new com.example.alldocument.library.java.awt.geom.Point2D.Float(ctrlx, ctrly);
	}
	 ...
	 */
	public com.example.alldocument.library.java.awt.geom.Point2D getCtrlPt() {
	    return new com.example.alldocument.library.java.awt.geom.Point2D.Double(ctrlx, ctrly);
	}
     ...
     * @since 1.2
     */
    public abstract com.example.alldocument.library.java.awt.geom.Point2D getCtrlPt();
     ...
     * @since 1.2
     */
    public void setCurve(com.example.alldocument.library.java.awt.geom.Point2D p1, com.example.alldocument.library.java.awt.geom.Point2D cp, com.example.alldocument.library.java.awt.geom.Point2D p2) {
    ...
    public static double getFlatnessSq(double x1, double y1,
				       double ctrlx, double ctrly,
				       double x2, double y2) {
	return com.example.alldocument.library.java.awt.geom.Line2D.ptSegDistSq(x1, y1, x2, y2, ctrlx, ctrly);
    }
    ...
    public static double getFlatness(double x1, double y1,
				     double ctrlx, double ctrly,
				     double x2, double y2) {
	return com.example.alldocument.library.java.awt.geom.Line2D.ptSegDist(x1, y1, x2, y2, ctrlx, ctrly);
    }
	...
	return com.example.alldocument.library.java.awt.geom.Line2D.ptSegDistSq(coords[offset + 0], coords[offset + 1],
				  coords[offset + 4], coords[offset + 5],
				  coords[offset + 2], coords[offset + 3]);
    }
	...
	return com.example.alldocument.library.java.awt.geom.Line2D.ptSegDist(coords[offset + 0], coords[offset + 1],
				coords[offset + 4], coords[offset + 5],
				coords[offset + 2], coords[offset + 3]);
    }
	...
	return com.example.alldocument.library.java.awt.geom.Line2D.ptSegDistSq(getX1(), getY1(),
				  getX2(), getY2(),
				  getCtrlX(), getCtrlY());
    }
