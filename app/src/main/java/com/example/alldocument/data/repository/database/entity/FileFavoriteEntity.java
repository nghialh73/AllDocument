...
@Entity(tableName = "file_favorite")
public class FileFavoriteEntity {
    @PrimaryKey(autoGenerate = true)private long id_file;
    @ColumnInfo(name = "file_name")private String file_name;
    @ColumnInfo(name = "file_path")private String file_path;
    @ColumnInfo(name = "type_file")private int type_file;
    @ColumnInfo(name = "time_added")private long time_added;
    @ColumnInfo(name = "time_modified")private long time_modified;
    @ColumnInfo(name = "time_last_open")private long time_last_open;
    @ColumnInfo(name = "favorite")private boolean favorite;

    public FileFavoriteEntity() {
    }
